...
final class PagoModel extends Db
{
    ...
    public function Save($empresa_id, $Campos, $Conex)
    {
        ...
        //Se separan los descuentos del '=', es decir de cada uno de los descuentos correspondientes para las facturas, retornará ['iddescuento_valor,-idfactura','']
        ...
        //Esto separará los descuentos de su valor para las facturas, retornará ['iddescuento_valor',idfactura]
        foreach ($descuentos_frac as $descu_frac) {
            $id_descu = explode('-', $descu_frac);
            if ($id_descu[1] != '' && $id_descu[0] != '') { //este if separará los datos en variables aparte.
        ...
        //Se separan los descuentos del '=', es decir de cada uno de los descuentos correspondientes para las Notas Débito, retornará ['iddescuento_valor,-idnotadebito','']
        ...
        //Esto separará los descuentos de su valor para las Notas Débito, retornará ['iddescuento_valor',idnotadebito]
        foreach ($descuentos_frac_nota as $descu_frac_nd) {
            $id_descu_nd = explode('-', $descu_frac_nd);
            if ($id_descu_nd[1] != '' && $id_descu_nd[0] != '') { //este if separará los datos en variables aparte.
        ...
        $result_clien = $this->DbFetchAll($select_clien, $Conex, true);//Traemos el nombre y/o razón social del cliente
        ...
        foreach ($nota_debito_id as $notas_debito) {
            if ($notas_debito > 0) {
                ...
                //INSERT de relación abono con nota debito
                $relacion_abono_id = $this->DbgetMaxConsecutive("relacion_abono", "relacion_abono_id", $Conex, true, 1);
