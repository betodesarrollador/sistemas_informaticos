...
//// GRID ////
  public function getQuerySolicFacturasGrid($cliente_id){
	...
	$Query = "(SELECT 
				CONCAT_WS('','<input type=\"checkbox\" onClick=\"checkRow(this);\" value=\"',o.orden_servicio_id,'\" />','<input type=\"hidden\" name=\"fuente_fac\"  value=\"OS\" />') AS link,
				'Orden de Servicio' AS fuente,
				o.orden_servicio_id AS  consecutivo,
			...
			UNION
			(SELECT 
					CONCAT_WS('','<input type=\"checkbox\" onClick=\"checkRow(this);\" value=\"',r.remesa_id,'\" />','<input type=\"hidden\" name=\"valor_facturar\"  value=\"',r.valor_facturar,'\" />','<input type=\"hidden\" name=\"valor_costo\"  value=\"',r.valor_costo,'\" />','<input type=\"hidden\" name=\"fuente_fac\"  value=\"RM\" />') AS link,
					'Remesa' AS fuente,	
			...
			UNION
			(SELECT 
					CONCAT_WS('','<input type=\"checkbox\" onClick=\"checkRow(this);\" value=\"',r.seguimiento_id,'\" />','<input type=\"hidden\" name=\"fuente_fac\"  value=\"ST\" />') AS link,
