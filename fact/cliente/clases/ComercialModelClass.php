...
final class ComercialModel extends Db{
  ...
  public function getComercial($Conex){
	  ...
	  $select  = " SELECT co.comercial_id AS value,(SELECT CONCAT_WS(' ',te.razon_social,te.primer_nombre,te.segundo_nombre,te.primer_apellido,te.segundo_apellido)) AS text FROM comercial co, tercero te WHERE  te.tercero_id=co.tercero_id AND co.estado_comercial='A' ORDER BY comercial_id DESC";
