...
function autocompleteCodigoContable(){
	...
	$("input[name=puc]").autocomplete("/spm/framework/clases/ListaInteligente.php?consulta=cuentas_movimiento", {
		width: 260,
		selectFirst: true,
		minChars: 4,
		scrollHeight: 220
...
function autocompleteTercero(){
	...
	$("input[name=tercero]").autocomplete("/spm/framework/clases/ListaInteligente.php?consulta=tercero", {
		width: 260,
		selectFirst: true
	});
...
function autocompleteCentroCosto(){
	...
	$("input[name=centro_de_costo]").autocomplete("/spm/framework/clases/ListaInteligente.php?consulta=centro_costo", {
		width: 260,
		selectFirst: true
	});
