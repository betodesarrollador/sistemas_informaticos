            					...
            					<tr>
           						  ...
           						  <td width="150" valign="top" align="right">
			  							<table cellspacing="0" cellpadding="0" align="right" width="100%">
                  							<tr >
                    							<td class="cellLeft borderTop tipoDocumento" width="180">{$DATOSENCABEZADO.tipo_documento}</td>
                  							    <td class="cellRight borderTop numeroDocumento" width="60">{$DATOSENCABEZADO.consecutivo}</td>
                  							</tr>
              							</table>
                               	  </td>
            					</tr>
  								...
  								<tr>
    								<td valign="top">
                                    	<table cellspacing="0" cellpadding="0" width="100%">
      										<tr>
                                                <td  class="cellLeft borderTop subtitulos" align="left">Fecha:</td>
                                                <td class="cellRight borderTop contenido" width="300">&nbsp;{$DATOSENCABEZADO.fecha}</td>
                                                <td class="cellRight borderTop subtitulos" width="100" align="left">Ciudad:</td>
                                                <td colspan="2" class="cellRight borderTop contenido" width="215">&nbsp;{$DATOSENCABEZADO.ciudad_ofi}</td>
                                          	</tr>
                                            
      										<tr>
                                                <td class="cellLeft subtitulos" align="left">{$DATOSENCABEZADO.texto_tercero}</td>
                                                ...
                                                <td class="cellRight subtitulos" align="left">{$DATOSENCABEZADO.tipo_identificacion} :</td>
                                            ...
                                            <tr>
                                                <td class="cellLeft subtitulos" align="left">Concepto : </td>
                                                <td class="cellRight contenido" colspan="4">&nbsp;{$DATOSENCABEZADO.concepto}</td>
                                            </tr>
      										<tr>
                                                <td class="cellLeft subtitulos" align="left">Forma de Pago : </td>
                                                ...
                                                <td class="cellRight subtitulos" width="15">{$DATOSENCABEZADO.texto_soporte}</td>
    	...
    	<tr>
      		<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr align="center" >
                        <td  width="90"  class="cellTitleLeft" >CODIGO</td>
                        <td  width="117" class="cellTitleRight">TERCERO</td>
                        <td  width="30" class="cellTitleRight">CC</td>
                        <td  width="227" class="cellTitleRight">DETALLE</td>
                    ...
                    <tr>    
                      ...
                      <td class="cellRight contenido">&nbsp;{$i.codigo_centro_costo}</td>
                        <td class="cellRight contenido">&nbsp;{$i.descripcion<span class="cellRight">|substr:0:20</span>}</td>
        	...
        	<td>
            	<table cellspacing="0" class="table_firmas" cellpadding="0" width="100%" border="0">
                	...
                	<tr>
                        ...
                        <td width="130" height="80" valign="bottom" class="cellRight" align="center">Huella</td>
