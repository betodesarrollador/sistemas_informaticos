<?php
	...
	final class DevolucionPruebaLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1 = new Form("DevolucionPruebaClass.php","DevolucionPruebaForm","DevolucionPruebaForm");
			...
			$this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/DevolucionPrueba.css");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/DevolucionPrueba.js");
			...
			$this -> assign("DEVOLUCIONID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[devolucion_id]));


			$this -> assign("FECHA",			$this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_dev]));
			...
			$this -> assign("OBSERVACIONES",	$this -> objectsHtml -> GetobjectHtml($this -> fields[obser_dev]));
		...
		public function setCausalesDevolucion($causales){
			$this -> fields[causal_devolucion_id]['options'] = $causales;
			$this -> assign("CAUSALDEVOLUCIONID",$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_devolucion_id]));
			$this -> fields[causal_devolucion_id1]['options'] = $causales;
			$this -> assign("CAUSALDEVOLUCION1ID",$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_devolucion_id1]));
		}

		//// GRID ////
		public function SetGridDevolucion($Attributes,$Titles,$Cols,$Query){
			require_once("../../../framework/clases/grid/JqGridClass.php");
			$TableGrid = new JqGrid();
			$TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
			$this -> assign("GRIDDEVOLUCION",$TableGrid -> RenderJqGrid());
			$this -> assign("TABLEGRIDCSS",$TableGrid -> GetJqGridCss());
			$this -> assign("TABLEGRIDJS",$TableGrid -> GetJqGridJs());
		}

		public function RenderMain(){
			$this ->RenderLayout('DevolucionPrueba.tpl');
		}
	}
?>