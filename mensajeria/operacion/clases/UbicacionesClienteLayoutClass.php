...
final class UbicacionesClienteLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("UbicacionesClienteClass.php","UbicacionesClienteForm","UbicacionesClienteForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/UbicacionesCliente.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('UbicacionesCliente.tpl');
