...
final class Imp_EntregaModel extends Db{
  
  public function getEntrega($oficina_id,$Conex,$usuario){
	...
	$select = "SELECT
				...
				(SELECT u.nombre FROM ubicacion u, oficina o WHERE r.oficina_id=o.oficina_id AND o.ubicacion_id=u.ubicacion_id) AS ciudad_entrega,
				r.usuario_registra,
				r.estado
			FROM 
				entrega r
			WHERE 
				r.entrega_id=$entrega_id";	
	// echo $select;
