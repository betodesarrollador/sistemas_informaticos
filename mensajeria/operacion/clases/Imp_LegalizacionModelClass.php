...
final class Imp_LegalizacionModel extends Db{
...
/*		(SELECT texto_soporte FROM tipo_de_Legalizacion WHERE tipo_Legalizacion_id=e.tipo_Legalizacion_id) AS Legalizacion_tipo,
		(SELECT texto_tercero FROM tipo_de_Legalizacion WHERE tipo_Legalizacion_id=e.tipo_Legalizacion_id) AS tercero_tipo,*/
		
		'' AS Legalizacion_tipo,
		'' AS tercero_tipo,
