<?php
	...
	final class EntregaOficinaLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1 = new Form("EntregaOficinaClass.php","EntregaOficinaForm","EntregaOficinaForm");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/EntregaOficina.js");
			...
			$this -> assign("ENTREGAID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[entrega_oficina_id]));
		...
		public function RenderMain(){
			$this ->RenderLayout('EntregaOficina.tpl');
		}
	}
?>