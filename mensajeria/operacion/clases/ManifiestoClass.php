...
final class Manifiesto extends Controler{
  ...
  public function Main(){
    ...
    $Titles = array('MANIFIESTO','FECHA','PROVEEDOR','ORIGEN','DESTINO','ESTADO','OBSERVACIONES','PLACA');	
...
protected function setSolicitud(){      
 ...
 protected function setLeerCodigobar() {
	...
	if($estado!='A' && $estado!='L' && $estadodis==0 && $estadodis1==0 && $estadodis2==0){
		...
		//Se leen guias en estado ALISTAMIENTO,BODEGA PUENTE,DEVUELTO
		...
		if($Data[0]['numero_guia']>0 || $Data1[0]['numero_guia']>0 || $Data2[0]['numero_guia']>0 || $Data[0]['numero_guia']!=NULL || $Data1[0]['numero_guia']!=NULL || $Data2[0]['numero_guia']!=NULL || $Data[0]['numero_guia']!='NULL' || $Data1[0]['numero_guia']!='NULL' || $Data2[0]['numero_guia']!='NULL'){
			...
			if(($Data[0]['numero_guia']>0 || $Data[0]['numero_guia']!=NULL || $Data[0]['numero_guia']!='NULL')  &&  ($Data[0]['estado_mensajeria_id']==1 || $Data[0]['estado_mensajeria_id']==9 || $Data[0]['estado_mensajeria_id']==7)){
			...
			}elseif(($Data2[0]['numero_guia']>0 || $Data2[0]['numero_guia']!=NULL || $Data2[0]['numero_guia']!='NULL')  &&  ($Data2[0]['estado_mensajeria_id']==1 || $Data2[0]['estado_mensajeria_id']==9 || $Data2[0]['estado_mensajeria_id']==9)){
...
//		tabindex=>'8',
	...
	//BUSQUEDA
   	$this -> Campos[busqueda] = array(
		...
		tabindex=>'1',
		suggest=>array(
			name	=>'busca_reexpedido_mensajeria',
			setId	=>'reexpedido_id',
