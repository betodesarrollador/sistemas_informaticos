      ...
      //$Layout -> RenderMain();
		if ($_REQUEST['formato']=='SI'){
			...
			for($i = 0; $i < count($guia); $i++){	
			 ...
			 $pdf->Cell(75,3,'DIRECCION.'.strtolower($guia[$i]['direccion1']).' NIT. $nit_empresa. Web: '.strtolower($guia[$i]['pagina_web']),0,0,'L');
			 $pdf->Ln(3);	 
			 $pdf->SetFont('Arial','B',6);	
			 $pdf->Cell(40,3,null,0,0,'R');
			 $pdf->Cell(90,3,'Resol. MINTIC No. '.$guia[$i]['resolucion_ministerio'].' de '.$guia[$i]['fecha_resolucion'].' Regimen Comun',0,0,'L');

			 
			 $pdf->SetFont('Arial','B',8);		 	 
			 $pdf->Cell(15,1,$guia[$i]['fecha_guia'],0,0,'C');		 	 
			 $pdf->Ln(3);	 
			 $pdf->SetFont('Arial','B',6);
			 $pdf->Cell(115,3,'Formulario DIAN '.$guia[$i]['resolucion_dian'].' de '.$guia[$i]['fecha_dian'],0,0,'L');	
			 $pdf->Ln(3);
			 $pdf->SetFont('Arial','B',6);	
			 $pdf->Cell(40,1,null,0,0,'R');
			 $pdf->Cell(100,2,,0,0,'L');
			 $pdf->SetFont('Arial','B',8);
			 //$pdf->Cell(22,3,$guia[$i]['solicitud_id'],1,0,'R');			 
			 $pdf->Cell(27,3,$guia[$i]['tipo_servicio'],0,0,'L');
			 ...
			 $pdf->Cell(65, 3, substr(utf8_decode($guia[$i]['origen']),0,34).' - '.$guia[$i]['pais_origen'], 0);
			 $pdf->Cell(20, 3, "Destino :", 0);
			 $pdf->Cell(50, 3, substr(utf8_decode($guia[$i]['destino']),0,34).' - '.$guia[$i]['pais_destino'] , 0);	 	 	 	 	 
			 ...
			 $pdf->Cell(55,3,"NIT. $nit_empresa. Web: ".strtolower($guia[$i]['pagina_web']).'     ',0,0,'R');		 
			 ...
			 $pdf->Ln(3);	 
			 $pdf->SetFont('Arial','B',7);	
			 $pdf->Cell(100,3,'Formulario DIAN '.$guia[$i]['resolucion_dian'].' de '.$guia[$i]['fecha_dian'],0,0,'R');		
			 $pdf->SetFont('Arial','B',7);	
			 $pdf->Cell(1,9,'Resol. MINTIC No. '.$guia[$i]['resolucion_ministerio'].' de '.$guia[$i]['fecha_resolucion'],0,0,'R');		
