...
final class UnidadesClienteModel extends Db{
...
//LISTA MENU
  ...
  public function saveDetalleUnidadesCliente($cliente_id,$camposArchivo,$Conex){
     ...
     $this -> Begin($Conex);
       ...
       for($i = 1; $i <= count($camposArchivo); $i++){
         ...
         PRINT $update = "UPDATE medida_cliente SET medida = '$medida',medida_id = $medida_id WHERE medida_cliente_id = $medida_cliente_id";
