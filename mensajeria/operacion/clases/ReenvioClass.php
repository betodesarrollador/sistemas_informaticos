...
final class Reenvio extends Controler{
  ...
  public function Main(){
	...
	require_once("ReenvioLayoutClass.php"); 
	require_once("ReenvioModelClass.php");
	
    $Layout   = new ReenvioLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new ReenvioModel();
	...
	$Layout -> SetGridReenvio($Attributes,$Titles,$Cols,$Model -> getQueryReenvioGrid());	
	$Layout -> RenderMain();    
  }
...
/////
  ...
  protected function onclickPrint(){  
    require_once("Imp_ReenvioClass.php");
    $print = new Imp_Reenvio($this -> getConex());
    $print -> printOut();  
  }  
...
//BUSQUEDA
  protected function onclickFind(){
    ...
    $Data =  $Model -> selectReenvio($reenvio_id,$this -> getConex());	
