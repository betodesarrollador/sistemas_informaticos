...
final class Imp_LiquidacionGuiasLayout extends View{
  ...
  private $fields;
   ...
   public function setEncabezado($encabezado){  
     ...
     $this -> assign("TOTALES", $this -> num2letras($encabezado[0]['valor']));       	 	 
   }
   ...
   public function RenderMain(){
     $this -> renderLayout('Imp_LiquidacionGuias.tpl','Documento Contable');	  	     	 
   }
