...
final class GuiaInterconexionLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("GuiaInterconexionClass.php","GuiaInterconexionForm","GuiaInterconexionForm");
     ...
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/guia_interconexion.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/GuiaInterconexion.js");
   ...
   public function RenderMain(){
        $this -> RenderLayout('GuiaInterconexion.tpl');
   }
}
?>