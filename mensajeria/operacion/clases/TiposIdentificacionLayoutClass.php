...
final class TiposIdentificacionLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("TiposIdentificacionClass.php","TiposIdentificacionForm","TiposIdentificacionForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/TiposIdentificacion.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('TiposIdentificacion.tpl');
