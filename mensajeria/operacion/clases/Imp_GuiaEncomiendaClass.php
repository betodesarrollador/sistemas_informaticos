  ...
  //    $Layout -> setOficinas($Model -> getOficinas($empresa_id,$this -> Conex));	            
      ...
      //$Layout -> RenderMain();
		if ($_REQUEST['formato']=='SI'){
			...
			$logo       = $guia[$i]['logo'];
			$supertrans = "../media/images/forms/supertrans.png";
			$codBar     = $guia[$i]['codbar'];
			 ...
			 $pdf->Image($supertrans,140,(8+$sumaY),21,9); 
			 $pdf->Image($codBar,165,(8+$sumaY),40,7); 	 
			 $pdf->Cell(40,3,null,0,0,'R');		 	 
			 $pdf->SetFont('Arial','B',6);	 
			 $pdf->Cell(89,3,'Ppal. Carerra 6 No 21-34 B/el Carmen. Ibague NIT. '.$nit_empresa.' Web: '.strtolower($guia[$i]['pagina_web']).'',0,0,'R');		 
			 ...
			 $pdf->SetFont('Arial','B',6);	
			 //$pdf->Cell(13,9,'Resol. MINTIC No. '.$guia[$i]['resolucion_ministerio'].' de '.$guia[$i]['fecha_resolucion'].'. regimen Común  Rpostal 404                     ',0,0,'R');		
			 $pdf->Ln(3);	 
			 $pdf->Cell(119,3,'',0,0,'R');		 	 
			 $pdf->SetFont('Arial','B',8);		 	 	 
			 //$pdf->Cell(22,3,$guia[$i]['solicitud_id'],0,0,'R');			 
			 $pdf->Cell(45,3,"",0,0,'L');
			 $pdf->Cell(15,3,$guia[$i]['tipo_guia'].'  GUIA No '.$guia[$i]['numero_guia_bar'],0,0,'C');		 	 	 
			 $pdf->Ln(3.5);	 
