...
final class ReenvioLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("ReenvioClass.php","ReenvioForm","ReenvioForm"); 	 
     ...
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Reenvio.css");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Reenvio.js");
...
//// GRID ////
   public function SetGridReenvio($Attributes,$Titles,$Cols,$Query){
