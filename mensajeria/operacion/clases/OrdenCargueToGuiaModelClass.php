...
final class OrdenCargueToGuiaModel extends Db{
...
//// GRID ////
  public function getQueryOrdenCargueToGuiaGrid($oficina_id){
    ...
    $Query = "SELECT CONCAT('<input type=\"checkbox\" onClick=\"checkRow(this);\" value=\"',o.orden_cargue_id,'\" />') 
			 ...
			 (SELECT nombre FROM ubicacion WHERE ubicacion_id = o.destino_id) AS destino_id,remitente,destinatario,producto,cantidad_cargue AS cantidad,peso,peso_volumen FROM 
			 orden_cargue o WHERE o.oficina_id = $oficina_id AND o.estado = 'E'";
