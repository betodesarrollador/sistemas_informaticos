...
final class UnidadesVolumenClienteLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/UnidadesVolumenCliente.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('UnidadesVolumenCliente.tpl');
