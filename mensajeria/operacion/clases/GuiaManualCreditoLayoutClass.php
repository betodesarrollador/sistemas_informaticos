...
final class GuiaManualCreditoLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("GuiaManualCreditoClass.php","GuiaManualCreditoForm","GuiaManualCreditoForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/GuiaManualCredito.js");
   ...
   public function RenderMain(){
        $this -> RenderLayout('GuiaManualCredito.tpl');
   }
}
?>