<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
	...
	{if $REPORTE eq 7}
		<body>
			<table width="90%" align="center" id="encabezado" border="0.1 solid">
				<tr><td align="center" colspan="9">INGRESOS Y ENVIOS MENSAJERIA EXPRESA</td></tr>
				<tr><td align="center" colspan="9">Rango Inicial : {$DESDE}&nbsp;&nbsp;&nbsp;&nbsp;Rango Final: {$HASTA}</td></tr>
			</table>
			...
			<table align="center" id="encabezado"  width="90%" border="0.1 solid">
				<tr>
					...
					<th class="borderTop borderRight borderLeft borderBottom" align="center">MES DEL TRIMESTRE</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">TIPO DE ENVIO</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">TIPO DE OBJETO</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">AMBITO</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">CODIGO MUNICIPIO ORIGEN</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">CODIGO MUNICIPIO DESTINO</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">CODIGO PAIS ORIGEN</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">RANGO PESO ENVIO</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">INGRESOS</th>
					<th class="borderTop borderRight borderLeft borderBottom" align="center">NUMERO TOTAL ENVIOS</th>
				...
				{foreach name=reporte from=$DETALLES item=r}
					...
					<tr>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.anio}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.trimestre}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.numero_mes}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.tipo_envio}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.tipo_objeto}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.ambito}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.codigo_municipio_origen}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.codigo_municipio_destino}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.codigo_pais}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.rango_peso}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.ingresos|number_format:0:",":"."}</td>
						<td class="borderTop borderRight borderLeft borderBottom" align="center">{$r.numero_total_envios|number_format:0:",":"."}</td>
					</tr>
				{/foreach}
			</table>
		</body>
