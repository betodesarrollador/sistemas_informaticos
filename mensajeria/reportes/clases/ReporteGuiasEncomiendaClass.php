<?php
	...
	final class ReporteGuiasEncomienda extends Controler{
	...
	public function Main(){
		...
		require_once("ReporteGuiasEncomiendaLayoutClass.php");
		require_once("ReporteGuiasEncomiendaModelClass.php");

		$Layout   = new ReporteGuiasEncomiendaLayout($this -> getTitleTab(),$this -> getTitleForm());
		$Model    = new ReporteGuiasEncomiendaModel();
		...
		protected function generateFile(){
			...
			$Model     = new ReporteGuiasEncomiendaModel();
			$Layout    = new ReporteGuiasEncomiendaLayout();
		...
		protected function setCampos(){
			...
			$this -> Campos[all_forma] = array(
				name	=>'all_forma',
				id		=>'all_forma',
				type	=>'checkbox',
				onclick =>'all_forma_pago();',
				value	=>'NO'
			);
	...
	$ReporteGuiasEncomienda = new ReporteGuiasEncomienda();
?>