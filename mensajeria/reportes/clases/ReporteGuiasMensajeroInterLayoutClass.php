...
final class ReporteGuiasMensajeroInterLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("ReporteGuiasMensajeroInterClass.php","ReporteGuiasMensajeroInterForm","ReporteGuiasMensajeroInterForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/reportes/js/ReporteGuiasMensajeroInter.js"); 
     ...
     $this -> assign("GUIAID",         $this -> objectsHtml -> GetobjectHtml($this -> fields[guia_interconexion_id]));
...
//LISTA MENU
	...
	public function RenderMain(){   
     $this -> RenderLayout('ReporteGuiasMensajeroInter.tpl');	 
   }
}
