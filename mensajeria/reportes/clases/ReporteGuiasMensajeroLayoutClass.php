...
final class ReporteGuiasMensajeroLayout extends View{
...
public function setCampos($campos){
   ...
   $Form1 = new Form("ReporteGuiasMensajeroClass.php","ReporteGuiasMensajeroForm","ReporteGuiasMensajeroForm");
   ...
   $this -> TplInclude -> IncludeJs("/velotax/mensajeria/reportes/js/ReporteGuiasMensajero.js"); 
   ...
   $this -> assign("ALLGUIAS",     $this -> objectsHtml -> GetobjectHtml($this -> fields[all_guia]));
   ...
   $this -> assign("GUIA",         	$this -> objectsHtml -> GetobjectHtml($this -> fields[guia]));
...
public function SetServicio($servicio){
    ...
    $this -> assign("SERVICIO",$this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_servicio_mensajeria_id])); 
}

public function RenderMain(){   
   $this -> RenderLayout('ReporteGuiasMensajero.tpl');	 
}
}
