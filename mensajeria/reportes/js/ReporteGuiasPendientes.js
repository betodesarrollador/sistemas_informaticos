...
function OnclickGenerar(formulario){
	...
	if(ValidaRequeridos(formulario)){
		 var QueryString = "DetallesReporteGuiasPendientesClass.php?"+FormSerialize(formulario);
...
function OnclickGenerarExcel(formulario){
     if(ValidaRequeridos(formulario)){
       ...
       var QueryString = "DetallesReporteGuiasPendientesClass.php?ACTIONCONTROLER=generateFile&"+FormSerialize(formulario)+"&download=SI&rand="+Math.random();
...
function OnclickGenerarExcelFormato(formulario){
     if(ValidaRequeridos(formulario)){
       ...
       var QueryString = "DetallesReporteGuiasPendientesClass.php?ACTIONCONTROLER=generateFileFormato&"+FormSerialize(formulario)+"&download=SI&rand="+Math.random();
...
function OnclickGenerarExcelFiltrado(formulario){
     if(ValidaRequeridos(formulario)){
       ...
       var QueryString = "DetallesReporteGuiasPendientesClass.php?ACTIONCONTROLER=generateFileFormato1&"+FormSerialize(formulario)+"&download=SI&rand="+Math.random();
...
function OnclickGenerarFotos(formulario){
     if(ValidaRequeridos(formulario)){
	   if($('#si_remitente').val()=='1'){
		   ...
		   var QueryString = "DetallesReporteGuiasPendientesClass.php?ACTIONCONTROLER=generateFotos&"+FormSerialize(formulario)+"&download=SI&rand="+Math.random();
