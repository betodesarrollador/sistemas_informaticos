       ...
       $.ajax({
		 ...
		 success    : function(resp){
			...
			if(validacion != 'true'){
			  ...
			  if(validacion == 'mayor'){
			   alertJquery("El año al que fue repotenciado el vehiculo no puede ser mayor al año actual","Validacion Vehiculo");
			  }else if(validacion == 'menor'){
			     alertJquery("El año al que fue repotenciado No puede ser menor al modelo.","Validacion Vehiculo");				
			    }else if(validacion == 'igual'){
			       alertJquery("El año al que fue repotenciado No puede ser igual al modelo.","Validacion Vehiculo");									
				  }	
  ...
  $("#vencimiento_soat").blur(function(){
     ...
     $.ajax({
	   ...
	   success    : function(resp){
		   ...
		   if(validacion == 'true'){
			   alertJquery("La fecha del vencimiento del SOAT no puede ser un año mayor a la fecha actual","Validacion");
			   obj.value = '';
			   return false;
