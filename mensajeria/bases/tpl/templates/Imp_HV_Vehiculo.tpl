...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="42%" rowspan="4" align="center" class="cellLeft" style="border-top:1px solid">Documento confidencial propiedad de COMPAÑÍA<br>
          TRANSPORTADORA velotax / Elaborado por<br>SQHSE velotax /Bajo LA Norma BASC<br>Versión 4 de 2012 / Funza 2012</td>
        <td width="16%" rowspan="4" align="center" class="cellRight" style="border-top:1px solid">HOJA DE VIDA VEHÍCULO</td>
        <td width="27%" rowspan="4" align="center" class="cellRight" style="border-top:1px solid"><img src="{$DATOSVEHICULO.logo}" width="180" height="80" /></td>
  ...
  <tr>
    <td colspan="4"><table width="100%" border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
        <td class="cellLeft"><label>MODELO : </label><div>{$DATOSVEHICULO.modelo_remolque}</div></td>
        <td class="cellRight"><label>CONFIGURACION : </label><div>{$DATOSVEHICULO.configuracion}</div></td>
      ...
      <tr>
        ...
        <td class="cellRight"><label>VIGENCIA : </label><div>{$DATOSVEHICULO.vencimiento_soat}</div></td>
      </tr>
      <tr>
...
(si los documentos no son claros no ser&aacute;n admitidos)</td>
  ...
  <tr>
    <td colspan="4"><table width="100%" border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td width="50%" class="cellLeft"><label>APROBO :</label> <b>{$DATOSVEHICULO.aprobo}</b></td>
        <td width="50%" class="cellRight"><label>REVISO :</label> <b>{$DATOSVEHICULO.reviso}</b></td>
      </tr>
    </table></td>
  </tr>
</table>
