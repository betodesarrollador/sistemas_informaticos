...
final class Imp_HV_VehiculoLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/velotax/transporte/bases/css/Imp_HV_Vehiculo.css");
	 
	 $this -> TplInclude -> IncludeCss("/velotax/framework/css/reset.css","print");
     $this -> TplInclude -> IncludeCss("/velotax/transporte/bases/css/Imp_HV_Vehiculo.css","print");	 
