...
final class ParametrosLegalizacionParticularModel extends Db{
  ...
  public function getTiposDocumentoContable($Conex){
   ...
   public function selectParametrosLegalizacionParticular($parametros_legalizacion_id,$Conex){
   ...
   public function getQueryParametrosLegalizacionParticularGrid(){
