<?php
	...
	final class ParametrosGuiaEncomiendaLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1      = new Form("ParametrosGuiaEncomiendaClass.php","ParametrosGuiaEncomiendaForm","ParametrosGuiaEncomiendaForm");
			$this -> fields = $campos;
			...
			//	 $this -> TplInclude -> IncludeCss("/velotax/seguimiento/parametros_modulo/css/ParametrosGuiaEncomienda.css");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/parametros_modulo/js/ParametrosGuiaEncomienda.js");
			...
			$this -> assign("PARAMETROID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[rango_guia_encomienda_id]));
			...
			$this -> assign("INICIAL",		$this -> objectsHtml -> GetobjectHtml($this -> fields[rango_guia_encomienda_ini]));
			...
			$this -> assign("FINAL",		$this -> objectsHtml -> GetobjectHtml($this -> fields[rango_guia_encomienda_fin]));
			$this -> assign("UTILIZADO",	$this -> objectsHtml -> GetobjectHtml($this -> fields[utilizado_rango_guia_encomienda]));
		...
		public function SetGridRangoGuia($Attributes,$Titles,$Cols,$Query){
			...
			$this -> assign("GRIDRANGOGUIAENCOMIENDA",	$TableGrid -> RenderJqGrid());
			$this -> assign("TABLEGRIDCSS",		$TableGrid -> GetJqGridCss());
			$this -> assign("TABLEGRIDJS",		$TableGrid -> GetJqGridJs());
		}

		public function RenderMain(){
			$this -> RenderLayout('ParametrosGuiaEncomienda.tpl');
		}
	}
?>