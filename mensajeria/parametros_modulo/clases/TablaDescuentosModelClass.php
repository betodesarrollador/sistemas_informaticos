...
//// GRID ////
  public function getQueryTablaDescuentosGrid(){
     ...
     $Query = "SELECT descuento,p.codigo_puc AS  puc,t.naturaleza,o.nombre AS  agencia,t.calculo,t.porcentaje,IF(t.visible_en_impresion = 0,'NO','SI') AS visible_en_impresion,t.estado FROM tabla_descuentos t,puc p,oficina o  WHERE t.puc_id = p.puc_id AND t.oficina_id = o.oficina_id";
