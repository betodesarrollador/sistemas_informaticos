...
final class Imp_GuiaEncomiendaLayout extends View{    
   public function setGuia($Guia,$usuario){
     $this -> TplInclude -> IncludeCss("/velotax/framework/css/reset.css");
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Imp_GuiaEncomienda.css");      
     $this -> TplInclude -> IncludeCss("/velotax/framework/css/reset.css","print");
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Imp_GuiaEncomienda.css","print");	 
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Imp_GuiaEncomienda.js");	    	 
   ...
   public function RenderMain(){  
	  ...
	  if($formato == 'NO'){
        $this -> exportToPdf('Imp_GuiaEncomiendavelotax.tpl',rand());	  		
	  }else{
          $this -> renderLayout('Imp_GuiaEncomienda.tpl',rand());	  
	    }
    }
}
