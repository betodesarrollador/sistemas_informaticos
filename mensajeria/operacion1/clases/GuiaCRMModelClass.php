...
//////////////////////////////////////////
  ...
  public function getClientes($oficina_id,$Conex){
   ...
   public function GetTipoMedida($Conex){
	...
	$result = $this -> DbFetchAll("SELECT tipo_servicio_mensajeria_id AS value,nombre AS text FROM tipo_servicio_mensajeria WHERE guia=1 ORDER BY nombre ASC",$Conex,false);
    return $result;
  }  
/*
