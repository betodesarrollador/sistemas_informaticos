  ...
  public function setCamposArchivo($camposArchivo,$cliente_id,$Conex){
   ...
   $this -> Begin($Conex);
     ...
     foreach($camposArchivo[0] as $llave => $valor){
       ...
       $insert = "INSERT INTO campos_archivo_cliente (campos_archivo_cliente_id,cliente_id,nombre_campo,guia) 
	   VALUES ($campos_archivo_cliente_id,$cliente_id,TRIM('$valor'),1);";
