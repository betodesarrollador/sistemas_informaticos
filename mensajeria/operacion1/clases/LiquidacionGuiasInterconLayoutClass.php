<?php
	...
	final class LiquidacionGuiasInterconLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1	= new Form("LiquidacionGuiasInterconClass.php","LiquidacionGuiasInterconForm","LiquidacionGuiasInterconForm");
			...
			$this	->	TplInclude	->	IncludeJs("/velotax/mensajeria/operacion/js/LiquidacionGuiasIntercon.js");
			...
			$this	->	assign("LIQUIDACIONID",		$this	->	objectsHtml	->	GetobjectHtml($this -> fields[liquidacion_guias_interconexion_id]));			
			...
			$this	->	assign("GUIASID",			$this	->	objectsHtml	->	GetobjectHtml($this -> fields[guias_interconexion_id]));
	   ...
	   public function setOficinas($oficinas){
		...
		public function RenderMain(){
			$this ->RenderLayout('LiquidacionGuiasIntercon.tpl');
		}
	}
?>