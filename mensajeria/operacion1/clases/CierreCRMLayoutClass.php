<?php
	...
	final class CierreCRMLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1	= new Form("CierreCRMClass.php","CierreCRMForm","CierreCRMForm");
			...
			$this	->	TplInclude	->	IncludeCss("/velotax/mensajeria/operacion/css/liquidacion.css");
			...
			$this	->	TplInclude	->	IncludeJs("/velotax/mensajeria/operacion/js/CierreCRM.js");
			...
			$this	->	assign("LIQUIDACIONID",		$this	->	objectsHtml	->	GetobjectHtml($this -> fields[cierre_crm_id]));			
		...
		public function RenderMain(){
			$this ->RenderLayout('CierreCRM.tpl');
		}
	}
?>