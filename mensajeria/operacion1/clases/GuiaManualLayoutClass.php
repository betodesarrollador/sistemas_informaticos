...
final class GuiaManualLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("GuiaManualClass.php","GuiaManualForm","GuiaManualForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/GuiaManual.js");
   ...
   public function RenderMain(){
        $this -> RenderLayout('GuiaManual.tpl');
   }
}
?>