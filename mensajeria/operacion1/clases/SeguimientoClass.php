...
//BUSQUEDA
  ...
  protected function onclickPrint(){
    ...
    $print = new Imp_OrdenSeguimiento($this -> getConex());
  ...
  protected function calcularFlete(){
	 ...
	 for($i = 0; $i < count($impuestos); $i++){	 
	   ...
	   $dataImpuesto = $Model -> calcularImpuesto($valor_flete,$impuesto_id,$arrayResponse['impuestos'],$this -> getConex());
  ...
  protected function setCampos(){
    ...
    $this -> Campos[documento_cliente] = array(
    ...
    type        =>'select',
	disabled    =>'true',
	options     => array(array(value => 'P', text => 'PENDIENTE'),array(value => 'L', text => 'LIQUIDADO')),
	selected    =>'P',
    transaction =>array(
    table=>array('seguimiento'),
    type=>array('column'))
