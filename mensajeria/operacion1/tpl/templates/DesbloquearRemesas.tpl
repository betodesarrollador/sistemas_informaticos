  ...
  <body>
	...
	<div id="table_find">
        <table align="center" width="100%">
         <tr>
           <td><label>Busqueda :</label></td><td>{$BUSQUEDA}</td><td align="right">&nbsp;</td>
         </tr>
        </table>
    </div>
	...
	<fieldset class="section">
        ...
        <table align="center" width="85%">
          <tr>
            ...
            <td>{$TIPOREMESA}{$REMESAID}{$OFICINAID}{$OFICINADESBLOQUEAID}{$DESBLOQUEADA}</td>
          ...
          <tr>
            ...
            <td><label>Remesa de Control :</label></td>
            <td>{$CONTROL}</td>
          </tr>  
		  
          <tr >
            <td><label>Remesa Complemento :</label></td>
            <td>{$COMPLEMENTO}</td>
		...
		<fieldset class="section">
		 ...
		 <table width="85%" align="center" >
           <tr>
             <td width="18%"><label>Codigo  :</label></td>
             <td width="32%">{$CODIGO}{$PRODUCTOID}</td>
             <td width="21%"><label>Descripcion  :</label></td>
             <td>{$PRODUCTO}</td>
           </tr>
           <tr>
	...
	<div id="rangoImp">
      <div>
		...
		<p align="center">{$PRINTOUT}{$PRINTCANCEL}</p>
	  </div>
	</div>		
