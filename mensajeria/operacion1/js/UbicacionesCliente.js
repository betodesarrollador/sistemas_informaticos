...
$(document).ready(function(){
   ...
   getDetalleUbicacionesCliente();
   setDetalleUbicacionesCliente();
      
   document.getElementById('detalleUbicacionesCliente').src = "about:blank";
...
function getDetalleUbicacionesCliente(){
  ...
  $("#cliente_id").change(function(){
	  ...
	  if(this.value == 'NULL'){
        document.getElementById('detalleUbicacionesCliente').src = "about:blank";
          ...
          document.getElementById('detalleUbicacionesCliente').src = "DetalleUbicacionesClienteClass.php?cliente_id="+this.value;	
		}
...
function setDetalleUbicacionesCliente(){
  ...
  if(form && cliente_id != 'NULL'){
    ...
    var QueryString = "ACTIONCONTROLER=setDetalleUbicacionesCliente&cliente_id="+cliente_id+"&"+ubicaciones;
      
    $.ajax({
      url        : "UbicacionesClienteClass.php?rand="+Math.random(),
      type       : "POST",	   
      data       : QueryString,
      beforeSend : function(){
        showDivLoading();
