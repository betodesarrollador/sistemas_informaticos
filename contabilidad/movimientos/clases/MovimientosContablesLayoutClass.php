...
final class MovimientosContablesLayout extends View
{
    private $fields;
    ...
    public function setCampos($campos)
    {
        ...
        $Form1 = new Form("MovimientosContablesClass.php", "MovimientosContables", "MovimientosContables");
        ...
        $this->TplInclude->IncludeJs("../js/movimientoscontables.js");
        ...
        $this->assign("PUCID", $this->objectsHtml->GetobjectHtml($this->fields[puc_id]));
        $this->assign("MODULO", $this->objectsHtml->GetobjectHtml($this->fields[modulo]));
...
//LISTA MENU
    ...
    public function setTiposDocumento2($tipos_documento)
    {
        $this->fields[tipo_documento_id2]['options'] = $tipos_documento;
        $this->assign("TIPOSDOCUMENTOID2", $this->objectsHtml->GetobjectHtml($this->fields[tipo_documento_id2]));
    }
    ...
    public function RenderMain()
    {
        ...
        $this->RenderLayout('movimientoscontables.tpl');
