...
final class MovimientosContablesContabilizadosLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/rural/seguimiento/seguimiento_monitoreo/css/seguimiento_transito.css");
	 
     $this -> TplInclude -> IncludeJs("../../../framework/js/jquery.js");
     $this -> TplInclude -> IncludeJs("../../../framework/js/funciones.js");
     $this -> TplInclude -> IncludeJs("/rural/seguimiento/seguimiento_monitoreo/js/MovimientosContablesContabilizados.js");	 
