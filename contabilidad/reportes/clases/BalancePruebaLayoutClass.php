...
final class BalancePruebaLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("BalancePruebaClass.php","BalancePrueba","BalancePrueba");	 	 
	 $Form2 = new Form("ReporteBalancePruebaClass.php","ReporteBalancePrueba","ReporteBalancePrueba");	 	 	 
     ...
     $this -> TplInclude -> IncludeJs("../js/BalancePrueba.js");
     ...
     $this -> assign("OFICTODOS",     $this -> objectsHtml -> GetobjectHtml($this -> fields[opciones_oficinas]));	 	 	 
	 
     $this -> assign("CENTROSTODOS",   $this -> objectsHtml -> GetobjectHtml($this -> fields[opciones_centros]));
     $this -> assign("ALLSUBCUENTAS",   $this -> objectsHtml -> GetobjectHtml($this -> fields[all_subcuentas]));	 	 	 
     $this -> assign("ALLCUENTAS",     $this -> objectsHtml -> GetobjectHtml($this -> fields[all_cuentas]));	 	 	 
	   $this -> assign("CUENTASPUC",	   $this -> objectsHtml -> GetobjectHtml($this -> fields[cuentas]));
	   $this -> assign("SUBCUENTASPUC",	 $this -> objectsHtml -> GetobjectHtml($this -> fields[subcuentas]));
	   $this -> assign("NIVEL1",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[nivel1]));
	   $this -> assign("NIVEL2",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[nivel2]));
	   $this -> assign("NIVEL3",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[nivel3]));
	   $this -> assign("NIVEL4",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[nivel4]));
	   $this -> assign("NIVEL5",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[nivel5]));
	 ...
	 if($this -> Imprimir){
       $this -> assign("IMPRIMIR",   $this -> objectsHtml -> GetobjectHtml($this -> fields[imprimir]));	 
   	 	$this -> assign("EXCELF",	 	   $this -> objectsHtml -> GetobjectHtml($this -> fields[excelf]));
	 }
...
//LISTA MENU
   ...
   public function RenderMain(){  
     $this -> RenderLayout('BalancePrueba.tpl');	 
   }
