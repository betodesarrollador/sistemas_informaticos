...
final class reporteDescuadresLayout extends View{
   private $fields;
  ...
  $this -> Imprimir = $Permiso;
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reporteDescuadresClass.php","reporteDescuadres","reporteDescuadres");
     $Form2 = new Form("reporteDescuadresResultadoClass.php","reporteDescuadresResultado","reporteDescuadresResultado");
	 $this -> fields = $campos; 
     ...
     $this -> TplInclude -> IncludeJs("../js/ReporteDescuadres.js"); 
...
//LISTA MENU
    ...
    public function RenderMain(){   
     $this -> RenderLayout('ReporteDescuadres.tpl');	 
    }   
}
?>