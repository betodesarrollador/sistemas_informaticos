...
$(document).ready(function(){
  ...
  $("#export").click(function(){
   ...
   if(ValidaRequeridos(formulario)){
     ...
     var QueryString = "ControlDocumentalClass.php?ACTIONCONTROLER=onclickGenerarAuxiliar&exportar=true&"+FormSerialize(formulario);
...
function getEmpresas(reporte){
  ...
  $.ajax({
    url        : "ControlDocumentalClass.php",
	data       : QueryString,
	beforeSend : function(){
	},
...
try{
	   if(ValidaRequeridos(formulario)){
		 ...
		 var QueryString = "ControlDocumentalClass.php?ACTIONCONTROLER=onclickGenerarAuxiliar&"+FormSerialize(formulario);
		 $("#frameReporte").attr("src",QueryString);
		 showDivLoading();	 	   
