...
function getEmpresas(reporte){
  ...
  $.ajax({
    url        : "ComparativoBalanceGeneralClass.php",
	data       : QueryString,
	beforeSend : function(){
	},
...
function onclickGenerarBalance(formulario){
   if(ValidaRequeridos(formulario)){
     var QueryString = "ComparativoBalanceGeneralClass.php?ACTIONCONTROLER=onclickGenerarBalance&"+FormSerialize(formulario)+"&rand="+Math.random();
...
function descargarexcel(formulario){
 if(ValidaRequeridos(formulario)){
   var QueryString = "ComparativoBalanceGeneralClass.php?ACTIONCONTROLER=onclickGenerarBalance&download=true&"+FormSerialize(formulario);
   $("#frameReporte").attr("src",QueryString);
 }
}
...
function beforePrint(formulario){
   ...
   if(ValidaRequeridos(formulario)){
  var QueryString = "ComparativoBalanceGeneralClass.php?ACTIONCONTROLER=onclickGenerarBalance&"+FormSerialize(formulario);
