   ...
   $("#generar").click(function(){
	 ...
	 if(formato_exogena_id == 'NULL' || periodo_contable_id == 'NULL'){
		alertJquery("Debe seleccionar algun periodo o formato!!!","Validacion Generacion Exogena");
		     ...
		     var QueryString = "InformacionExogenaMunClass.php?ACTIONCONTROLER=generateFile&download=1&formato_exogena_id="+formato_exogena_id+"&periodo_contable_id="+periodo_contable_id+"&rand="+Math.random();			 
