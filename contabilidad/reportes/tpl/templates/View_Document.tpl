                        	...
                        	<table  border="0" cellpadding="0" cellspacing="0" width="100%">
            					<tr>
             						<td width="256" align="left" valign="top">
									    ...
									    <img src="{$DATOSENCABEZADO.logo}" width="160" height="42" />									
                                    </td>
    								...
    								<td valign="top">
                                    	<table cellspacing="0" cellpadding="0" width="100%">
      										...
      										<tr>
                                                ...
                                                <td class="cellRight contenido">&nbsp;{$DATOSENCABEZADO.razon_social}&nbsp;{$DATOSENCABEZADO.primer_nombre} &nbsp;{$DATOSENCABEZADO.segundo_nombre} &nbsp;{$DATOSENCABEZADO.primer_apellido} &nbsp;{$DATOSENCABEZADO.segundo_apellido} </td>
      		...
      		<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>    
                        ...
                        <td align="right" class="cellRight contenido">&nbsp;{$i.debito|number_format:2:',':'.'}</td>
                        <td align="right" class="cellRight contenido">&nbsp;{$i.credito|number_format:2:',':'.'}</td>                                                
                    </tr>
                    {/foreach}
					<tr><td colspan="4">&nbsp;</td></tr>
                    <tr>    
                        <td class="cellTitleLeft" colspan="4" align="center"><b>SUMAS IGUALES</b></td>
                        <td align="right" class="cellRight borderTop">&nbsp;<b>{$TOTAL.total_debito|number_format:2:',':'.'}</b></td>
                        <td align="right" class="cellRight borderTop">&nbsp;<b>{$TOTAL.total_credito|number_format:2:',':'.'}</b></td>                                                
                    </tr>
				</table>
			</td>                    
		</tr>
