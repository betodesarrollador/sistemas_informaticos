...
final class OperativaLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/roa/seguimiento/bases/css/operativa.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/roa/seguimiento/bases/js/operativa.js");
   ...
   public function RenderMain(){
        $this -> RenderLayout('operativa.tpl');
