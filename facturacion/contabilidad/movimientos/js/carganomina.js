function setDataFormWithResponse(){
	...
	var controlador = 'CargaNominaClass.php';
...
function CargaNominaOnSave(formulario,resp){
...
function CargaNominaOnUpdate(formulario,resp){
...
function CargaNominaOnDelete(formulario,resp){
	
   Reset(document.getElementById('CargaNominaForm'));
   CargaNominaOnReset();
   
   alertJquery(resp);  
	
}
function CargaNominaOnReset(){
...
function OnclickContabilizar(formulario){
	...
	Send(formulario,'onclickUpdate',null,CargaNominaOnUpdate);
}
