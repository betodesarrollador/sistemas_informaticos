...
final class FormaPago extends Controler{
  ...
  protected function showGrid(){
	...
	$Attributes = array(
	 ...
	 $html =  $Layout -> SetGridFormaPago($Attributes,$Titles,$Cols,$Model -> getQueryFormaPagoGrid());
  ...
  protected function onclickSave(){
    ...
    if($Model -> GetNumError() > 0){
	 exit('Ocurrio una inconsistencia');
	  ...
	  exit('Se ingreso correctamente la forma de pago');
	 }
  ...
  protected function onclickUpdate(){
	...
	if($Model -> GetNumError() > 0){
	  exit('Ocurrio una inconsistencia');
	    ...
	    exit('Se actualizo correctamente la forma de pago');
	  }
  ...
  protected function onclickDelete(){
	...
	if($Model -> GetNumError() > 0){
	  exit('Ocurrio una inconsistencia');
	    ...
	    exit('Se elimino correctamente la forma de pago');
	  }
  }
  ...
  protected function setCampos(){
	...
	//busqueda
   	$this -> Campos[busqueda] = array(
		...
		size	=>'85',
		Boostrap =>'si',
		placeholder=>'ESCRIBA EL C&Oacute;DIGO O NOMBRE DE LA FORMA DE PAGO',												
		//tabindex=>'1',
		suggest=>array(
			name	=>'forma_pago',
			setId	=>'forma_pago_id',
