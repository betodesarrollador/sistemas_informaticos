...
final class CentroCostoLayout extends View{
   private $fields;
   ...
   public function setCampos($campos){	 	
	 ...
	 $Form1 = new Form("CentrosCostoClass.php","CentroCostoForm","CentroCostoForm");	 	 
     ...
     $this -> TplInclude -> IncludeJs("../js/centroscosto.js");
   ...
   public function RenderMain(){ 
     ...
     $this -> RenderLayout('centrocosto.tpl');
