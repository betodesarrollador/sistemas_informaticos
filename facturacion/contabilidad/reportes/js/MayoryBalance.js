...
$(document).ready(function(){
  ...
  $("#export").click(function(){
   ...
   if(ValidaRequeridos(formulario)){
     var QueryString = "MayoryBalanceClass.php?ACTIONCONTROLER=onclickExport&"+FormSerialize(formulario);
...
function onclickGenerarMayoryBalance(formulario){
   if(ValidaRequeridos(formulario)){
     var QueryString = "MayoryBalanceClass.php?ACTIONCONTROLER=onclickGenerarMayoryBalance&"+FormSerialize(formulario);
     $("#frameReporte").attr("src",QueryString);
     showDivLoading();	 	   
...
function descargarexcel(formulario){
	if(ValidaRequeridos(formulario)){
		var QueryString = "MayoryBalanceClass.php?ACTIONCONTROLER=onclickGenerarMayoryBalance&download=true&"+FormSerialize(formulario);
		$("#frameReporte").attr("src",QueryString);
	}
}