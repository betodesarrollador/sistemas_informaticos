...
final class ControlDocumentalLayout extends View
{
    ...
    public function setCampos($campos)
    {
        ...
        $Form1 = new Form("ControlDocumentalClass.php", "ControlDocumental", "ControlDocumental");

        $Form2 = new Form("ReporteControlDocumentalClass.php", "ReporteControlDocumental", "ReporteControlDocumental");
        ...
        $this->TplInclude->IncludeCss("../css/Descuadres.css");
        ...
        $this->TplInclude->IncludeJs("../js/ControlDocumental.js");
...
//LISTA MENU
    ...
    public function RenderMain()
    {
        ...
        $this->RenderLayout('ControlDocumental.tpl');
