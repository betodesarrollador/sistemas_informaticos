...
final class ComparativoEstadoResultados extends Controler{
  ...
  public function Main(){
	...
	require_once("ComparativoEstadoResultadosLayoutClass.php");
	require_once("ComparativoEstadoResultadosModelClass.php");
	require_once("../../../framework/clases/UtilidadesContablesModelClass.php");		
	
	$Layout              = new ComparativoEstadoResultadosLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model               = new ComparativoEstadoResultadosModel();
  ...
  protected function getEstadoResultadosNivel1($desde,$hasta,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,$utilidadesContables,$Conex){
  
      $result1 = $Model->getSaldoCuentasBalance($desde,$hasta,$centro_de_costo_id,$opciones_centros,$empresa_id,$utilidadesContables,$Conex);	 	 	
      //$saldo_utilidad_perdida=$Model->getSaldoUtilidadPerdidaNivel1($desde,$hasta,$centro_de_costo_id,$opciones_centros,$empresa_id,$utilidadesContables,$Conex);  	  
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	switch($nivel){
	  case 1:	    		
	   ...
	   $arrayResult=$this->getEstadoResultadosNivel1($desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,$utilidadesContables,$Conex);   
       ...
       for($i = 0; $i < count($arrayResult); $i++){
		  ...
		  $arrayReporte[$contLineas]['tipo']   = 1;			  			  
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	   ...
	   $arrayResult1=$this->getEstadoResultadosNivel1($desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,$utilidadesContables,$Conex);   
       ...
       for($i = 0; $i < count($arrayResult1); $i++){
		  ...
		  $arrayReporte1[$contLineas1]['tipo']   = 1;
		  ...
		  for($j = 0; $j < count($sub_cuentas); $j++){
			...
			if($puc_id == $pucIdUtilidadPerdida){
			  $saldo_cuenta = $saldoUtilidadPerdida;
		        ...
		        $saldo_cuenta = $Model -> getSaldoCuenta($puc_id,$desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
			 ...
			 if(is_numeric($saldo_cuenta) && $saldo_cuenta != 0){
		      ...
		      $arrayReporte[$contLineas]['tipo']   = 2;					
			  						
			  if(/*$puc_id != $pucIdUtilidadPerdida && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc_id,$opciones_centros,$centro_de_costo_id,$desde1,$hasta1,$utilidadesContables
				,$Conex);
		  ...
		  for($j = 0; $j < count($sub_cuentas); $j++){
			...
			if($puc_id == $pucIdUtilidadPerdida){
			  $saldo_cuenta = $saldoUtilidadPerdida;
		        ...
		        $saldo_cuenta = $Model -> getSaldoCuenta($puc_id,$desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
			                                             $utilidadesContables,$Conex);
	           }
			 ...
			 if(is_numeric($saldo_cuenta) && $saldo_cuenta != 0){
		      ...
		      $arrayReporte1[$contLineas1]['tipo']   = 2;					
			  						
			  if(/*$puc_id != $pucIdUtilidadPerdida && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc_id,$opciones_centros,$centro_de_costo_id,$desde2,$hasta2,$utilidadesContables
				,$Conex);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  case 3:
		...
		$arrayResult = $this -> getEstadoResultadosNivel1($desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,$utilidadesContables,
		                                                $Conex);	
																												
       // $saldoUtilidadPerdida = $Model -> getSaldoUtilidadPerdidaNivel1($desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,    
		 //                                                               $utilidadesContables,$Conex);
			...
			for($k = 0; $k < count($sub_cuentas3); $k++){
			 ...
			 if($puc3_id == $pucIdUtilidadPerdida3){
			  $saldo_cuenta3 = $saldoUtilidadPerdida;
		        ...
		        $saldo_cuenta3 = $Model -> getSaldoCuenta($puc3_id,$desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
			                                             $utilidadesContables,$Conex);
	           }
			 ...
			 if(is_numeric($saldo_cuenta3) && $saldo_cuenta3 != 0){
		      ...
		      $arrayReporte[$contLineas]['tipo']   = 3;			
			
			  if(/* $puc3_id != $pucIdUtilidadPerdida3 && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc3_id,$opciones_centros,$centro_de_costo_id,$desde1,$hasta1,$utilidadesContables
				,$Conex);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$arrayResult1 = $this -> getEstadoResultadosNivel1($desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,$utilidadesContables,
		                                                $Conex);	
																												
       // $saldoUtilidadPerdida = $Model -> getSaldoUtilidadPerdidaNivel1($desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,    
		 //                                                               $utilidadesContables,$Conex);
        //$pucIdUtilidadPerdida2 = $Model -> getCodigoPucUtilidadPerdida(2,$saldoUtilidadPerdida,$utilidadesContables,$Conex);																		
        //$pucIdUtilidadPerdida3 = $Model -> getCodigoPucUtilidadPerdida(3,$saldoUtilidadPerdida,$utilidadesContables,$Conex);																																
			...
			for($k = 0; $k < count($sub_cuentas3); $k++){
			 ...
			 if($puc3_id == $pucIdUtilidadPerdida3){
			  $saldo_cuenta3 = $saldoUtilidadPerdida;
		        ...
		        $saldo_cuenta3 = $Model -> getSaldoCuenta($puc3_id,$desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
			                                             $utilidadesContables,$Conex);
	           }
			 ...
			 if(is_numeric($saldo_cuenta3) && $saldo_cuenta3 != 0){
		      ...
		      $arrayReporte1[$contLineas1]['tipo']   = 3;			
			
			  if(/* $puc3_id != $pucIdUtilidadPerdida3 && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc3_id,$opciones_centros,$centro_de_costo_id,$desde2,$hasta2,$utilidadesContables
				,$Conex);
			...
			$movimiento = $sub_cuentas4[$l]['movimiento'];			 
			 ...
			 if($puc4_id == $pucIdUtilidadPerdida4){
			  $saldo_cuenta4 = $saldoUtilidadPerdida;
		        ...
		        $saldo_cuenta4 = $Model -> getSaldoCuenta($puc4_id,$desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
			                                             $utilidadesContables,$Conex);
	           }
			 ...
			 if(is_numeric($saldo_cuenta4) && $saldo_cuenta4 != 0){
		      ...
		      $arrayReporte[$contLineas]['tipo']   = 4;								
			
			  if(/*$puc4_id != $pucIdUtilidadPerdida4 && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc4_id,$opciones_centros,$centro_de_costo_id,$desde1,$hasta1,$utilidadesContables
				,$Conex);
			...
			$movimiento = $sub_cuentas4[$l]['movimiento'];			 
			 ...
			 if($puc4_id == $pucIdUtilidadPerdida4){
			  $saldo_cuenta4 = $saldoUtilidadPerdida;
		        ...
		        $saldo_cuenta4 = $Model -> getSaldoCuenta($puc4_id,$desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
			                                             $utilidadesContables,$Conex);
	           }
			 ...
			 if(is_numeric($saldo_cuenta4) && $saldo_cuenta4 != 0){
		      ...
		      $arrayReporte1[$contLineas1]['tipo']   = 4;								
			
			  if(/*$puc4_id != $pucIdUtilidadPerdida4 && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc4_id,$opciones_centros,$centro_de_costo_id,$desde2,$hasta2,$utilidadesContables
				,$Conex);
			...
			$movimiento = $sub_cuentas5[$m]['movimiento'];				  
				  ...
				  if($puc5_id == $pucIdUtilidadPerdida5){
				   $saldo_cuenta5 = $saldoUtilidadPerdida;
					 ...
					 $saldo_cuenta5 = $Model -> getSaldoCuenta($puc5_id,$desde1,$hasta1,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
															 $utilidadesContables,$Conex);
					}
			 ...
			 if(is_numeric($saldo_cuenta5) && $saldo_cuenta5 != 0){
		      ...
		      $arrayReporte[$contLineas]['tipo']   = 5;								
			
			  if(/*$puc5_id != $pucIdUtilidadPerdida5 && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc5_id,$opciones_centros,$centro_de_costo_id,$desde1,$hasta1,$utilidadesContables
				,$Conex);
			...
			$movimiento = $sub_cuentas5[$m]['movimiento'];				  
				  ...
				  if($puc5_id == $pucIdUtilidadPerdida5){
				   $saldo_cuenta5 = $saldoUtilidadPerdida;
					 ...
					 $saldo_cuenta5 = $Model -> getSaldoCuenta($puc5_id,$desde2,$hasta2,$centro_de_costo_id,$opciones_centros,$empresa_id,$Model,
															 $utilidadesContables,$Conex);
					}
			 ...
			 if(is_numeric($saldo_cuenta5) && $saldo_cuenta5 != 0){
		      ...
		      $arrayReporte1[$contLineas1]['tipo']   = 5;								
			
			  if(/*$puc5_id != $pucIdUtilidadPerdida5 && */ $movimiento == '1' && $opciones_tercero == 'S'){
			  
			    $terceros=$Model->selectSaldoTercerosBalance($empresa_id,$puc5_id,$opciones_centros,$centro_de_costo_id,$desde2,$hasta2,$utilidadesContables
				,$Conex);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if($download == 'true'){
    	$Layout -> exportToExcel('comparativoestadoResultadosReporte.tpl');   
 	}else{   
   		$Layout -> RenderLayout('comparativoestadoResultadosReporte.tpl');
	}
  } 
...
$MovimientosContables = new ComparativoEstadoResultados();
?>