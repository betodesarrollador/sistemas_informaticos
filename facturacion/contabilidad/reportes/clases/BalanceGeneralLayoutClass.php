...
final class BalancegeneralLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("BalancegeneralClass.php","Balancegeneral","Balancegeneral");	 	 
	 ...
	 $this -> fields = $campos; 
      ...
      $this -> TplInclude -> IncludeJs("../js/balancegeneral.js");
...
//LISTA MENU
   ...
   public function RenderMain(){      
     $this -> RenderLayout('balancegeneral.tpl');	 
   }
