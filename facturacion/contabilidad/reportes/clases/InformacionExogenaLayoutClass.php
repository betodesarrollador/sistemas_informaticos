...
final class InformacionExogenaLayout extends View{
   private $fields;
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("InformacionExogenaClass.php","InformacionExogenaForm","InformacionExogenaForm");
     ...
     $this -> TplInclude -> IncludeJs("../js/InformacionExogena.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('InformacionExogena.tpl');
