...
final class InformacionExogenaMunLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("InformacionExogenaMunClass.php","InformacionExogenaMunForm","InformacionExogenaMunForm");
     ...
     $this -> TplInclude -> IncludeJs("../js/InformacionExogenaMun.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('InformacionExogenaMun.tpl');
