...
final class DeclaracionLayout extends View
{
    ...
    public function setCampos($campos)
    {
        ...
        $Form1 = new Form("DeclaracionClass.php", "Declaracion", "Declaracion");
        $Form2 = new Form("ReporteDeclaracionClass.php", "ReporteDeclaracion", "ReporteDeclaracion");
        ...
        $this->TplInclude->IncludeJs("../js/declaracion.js");
        ...
        $this->assign("TIPOIMP", $this->objectsHtml->GetobjectHtml($this->fields[tipo_impuesto]));

        if ($this->Imprimir) {
            $this->assign("IMPRIMIR", $this->objectsHtml->GetobjectHtml($this->fields[imprimir]));
            $this->assign("EXPORT", $this->objectsHtml->GetobjectHtml($this->fields[export]));
            $this->assign("EXPORTEXCEL", $this->objectsHtml->GetobjectHtml($this->fields[export_excel]));

            $this->assign("EXPORTEXCELFORM", $this->objectsHtml->GetobjectHtml($this->fields[export_excel_formato]));
        }
...
//LISTA MENU
    ...
    public function RenderMain()
    {
        ...
        $this->RenderLayout('declaracion.tpl');
