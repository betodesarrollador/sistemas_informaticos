...
final class ComparativoEstadoResultadosLayout extends View{
   private $fields;
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("ComparativoEstadoResultadosClass.php","ComparativoEstadoResultados","ComparativoEstadoResultados");	 	 
	 $Form2 = new Form("ComparativoReporteEstadoResultadosClass.php","ComparativoReporteEstadoResultados","ComparativoReporteEstadoResultados");	 	 	 
     ...
     $this -> TplInclude -> IncludeJs("../js/comparativoestadoresultados.js");
     ...
     $this -> assign("DESDE1",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[desde1]));
     $this -> assign("HASTA1",	       $this -> objectsHtml -> GetobjectHtml($this -> fields[hasta1]));	 
     $this -> assign("DESDE2",         $this -> objectsHtml -> GetobjectHtml($this -> fields[desde2]));
     $this -> assign("HASTA2",        $this -> objectsHtml -> GetobjectHtml($this -> fields[hasta2]));
...
//LISTA MENU
   ...
   public function RenderMain(){      
     $this -> RenderLayout('comparativoestadoResultados.tpl');	 
   }
