...
final class ComparativoBalancegeneralLayout extends View{
   private $fields;
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("ComparativoBalancegeneralClass.php","ComparativoBalancegeneral","ComparativoBalancegeneral");	 	 
	 $Form2 = new Form("ReporteBalancegeneralClass.php","ReporteBalancegeneral","ReporteBalancegeneral");	 	 	 
     ...
     $this -> TplInclude -> IncludeJs("../js/comparativobalancegeneral.js");
...
//LISTA MENU
   ...
   public function RenderMain(){      
     $this -> RenderLayout('comparativobalancegeneral.tpl');	 
   }
