...
final class EstadoResultadosLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("EstadoResultadosClass.php","EstadoResultados","EstadoResultados");	 	 
	 $Form2 = new Form("ReporteEstadoResultadosClass.php","ReporteEstadoResultados","ReporteEstadoResultados");	 	 	 
     ...
     $this -> TplInclude -> IncludeJs("../js/estadoresultados.js");
   ...
   $this -> assign("DESCARGAR",      $this -> objectsHtml -> GetobjectHtml($this -> fields[descargar]));
	  ...
	  $this -> assign("AGRUPAR",      $this -> objectsHtml -> GetobjectHtml($this -> fields[agrupar_por]));
...
//LISTA MENU
   ...
   public function RenderMain(){      
     $this -> RenderLayout('estadoResultados.tpl');	 
   }
}
?>