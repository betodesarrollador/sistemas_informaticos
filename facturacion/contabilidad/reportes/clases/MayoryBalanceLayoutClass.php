...
final class MayoryBalanceLayout extends View{
   private $fields;
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("MayoryBalanceClass.php","MayoryBalance","MayoryBalance");	 	 
	 $Form2 = new Form("MayoryBalanceClass.php","ReporteMayoryBalance","ReporteMayoryBalance");	 	 	 
     ...
     $this -> TplInclude -> IncludeJs("../js/MayoryBalance.js");
...
//LISTA MENU
   ...
   public function RenderMain(){  
     $this -> RenderLayout('MayoryBalance.tpl');	 
   }
