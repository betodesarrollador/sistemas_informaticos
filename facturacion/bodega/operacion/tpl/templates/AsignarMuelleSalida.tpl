<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
  ...
  <body>
	...
	<fieldset>
        ...
        <legend>&nbsp;</legend>
        <legend><img src="../media/images/forms/mando_trafico.png" height="40"></legend>
{$FORM1}        
       ...
       <table align="center" width="70%">
		...
		<fieldset>{$GRIDAsignarMuelleSalida}</fieldset>
        <fieldset>{$GRIDAsignarMuelleSalida1}</fieldset>
