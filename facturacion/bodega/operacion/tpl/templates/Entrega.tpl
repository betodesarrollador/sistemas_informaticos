        ...
        <div id="divEntrega">
            <fieldset class="section">
                <form onSubmit="return false">
                    <table>
                        <tr>
                            <td><label>Despacho :</label></td>
                            <td><label>{$DESPACHOID}{$FECHAACTUALIZA}</label></td>
                        </tr>
                        <tr>
                            <td><label>Fecha Entrega :</label></td>
                            <td><label>{$FECHAENTREGA}</label></td>

                        </tr>
                        <tr>
                            <td><label>Observacion Entrega :</label></td>
