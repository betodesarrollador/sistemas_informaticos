...
final class AsignarTurnoSalidaLayout extends View{
   ...
   $this -> Guardar = $Permiso;
	...
	$Form1      = new Form("AsignarTurnoSalidaClass.php","AsignarTurnoSalidaForm","AsignarTurnoSalidaForm");	 
     ...
     $this -> TplInclude -> IncludeCss("sistemas_informaticos/bodega/operacion/css/AsignarTurnoSalida.css");
	 ...
	 $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/AsignarTurnoSalida.js");
    ...
    $this -> assign("OBSERVACIONMUELLE",			  $this -> objectsHtml -> GetobjectHtml($this -> fields[observacion_muelle]));	
    $this -> assign("USUARIO",   $this -> objectsHtml -> GetobjectHtml($this -> fields[usuario_id]));	 
    $this -> assign("ALISTAMIENTOID",   $this -> objectsHtml -> GetobjectHtml($this -> fields[alistamiento_salida_id]));
    $this -> assign("ALISTAMIENTOID1",   $this -> objectsHtml -> GetobjectHtml($this -> fields[alistamiento_salida_id1]));	
    $this -> assign("FECHAACTUALIZA",   $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_actualiza])); 
    $this -> assign("TURNO",            $this -> objectsHtml -> GetobjectHtml($this -> fields[turno])); 
...
/*    public function setTurno($turno){
      $this -> fields[turno]['options'] = $turno;
      $this -> assign("TURNO",$this -> objectsHtml -> GetobjectHtml($this -> fields[turno])); 
   } */
...
//// GRID ////  
   public function SetGridAsignarTurnoSalida($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
	 $TableGrid = new JqGrid();
 	 $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDAsignarTurnoSalida",	$TableGrid -> RenderJqGrid());
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('AsignarTurnoSalida.tpl');
