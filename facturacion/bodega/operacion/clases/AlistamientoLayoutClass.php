...
final class AlistamientoLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("AlistamientoClass.php","AlistamientoForm","AlistamientoForm"); 
     ...
     $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/Alistamiento.js");
     ...
     $this -> assign("ALISTAMIENTO",      	$this -> objectsHtml -> GetobjectHtml($this -> fields[alistamiento_salida_id]));
  ...
  public function setMuelle($muelle_id){
   $this -> fields[muelle_id]['options'] = $muelle_id;
     $this -> assign("MUELLE",$this -> objectsHtml -> GetobjectHtml($this -> fields[muelle_id])); 
   }
...
//// GRID ////
   public function SetGridAlistamiento($Attributes,$Titles,$Cols,$Query){
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('Alistamiento.tpl');
