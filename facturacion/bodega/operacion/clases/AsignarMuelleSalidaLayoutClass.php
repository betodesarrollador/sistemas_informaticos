...
final class AsignarMuelleSalidaLayout extends View{
   ...
   $this -> Guardar = $Permiso;
	...
	$Form1      = new Form("AsignarMuelleSalidaClass.php","AsignarMuelleSalidaForm","AsignarMuelleSalidaForm");	 
	 ...
	 $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/AsignarMuelleSalida.js");
...
//// GRID ////  
   public function SetGridAsignarMuelleSalida($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
	 $TableGrid = new JqGrid();
 	 $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDAsignarMuelleSalida",	$TableGrid -> RenderJqGrid());
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('AsignarMuelleSalida.tpl');
