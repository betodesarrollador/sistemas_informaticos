...
final class detallesDespachoLayout extends View{
   ...
   public function setDetalles($detallesDespacho){
   
     $this -> assign("DETALLES",$detallesDespacho);	  
   
   }   

   public function setDetallesDespachados($detallesDespacho){
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/detallesDespacho.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('detallesDespacho.tpl');
