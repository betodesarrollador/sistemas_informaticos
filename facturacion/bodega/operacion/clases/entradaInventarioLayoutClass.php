...
final class entradaInventarioLayout extends View{
 ...
 private $Limpiar;
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("entradaInventarioClass.php","entradaInventarioForm","entradaInventarioForm"); 
     ...
     $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/entradaInventario.js");
     ...
     $this -> assign("ENTRADAID",	      $this -> objectsHtml -> GetobjectHtml($this -> fields[entrada_id ]));
     $this -> assign("ESTADO",	        $this -> objectsHtml -> GetobjectHtml($this -> fields[estado]));
     $this -> assign("FECHA",			      $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha]));
     $this -> assign("RECEPCION",       $this -> objectsHtml -> GetobjectHtml($this -> fields[recepcion]));
     ...
     $this -> assign("FECHAANULACION",   $this      -> objectsHtml -> GetobjectHtml($this -> fields[fecha_anula_entrada]));
...
//// GRID ////
   public function SetGridentradaInventario($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
    $TableGrid = new JqGrid();
    $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDENTRADA",	$TableGrid -> RenderJqGrid());
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('entradaInventario.tpl');
