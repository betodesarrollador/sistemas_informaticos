...
final class DespachoAlistamientoLayout extends View{
 ...
 public function setCampos($campos){
   ...
   $Form1      = new Form("DespachoAlistamientoClass.php","DespachoAlistamientoForm","DespachoAlistamientoForm");
   ...
   $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/DespachoAlistamiento.js");
  ...
  $this -> assign("MARCAID",   $this      -> objectsHtml -> GetobjectHtml($this -> fields[marca_id]));
   ...
   $this -> assign("FECHAANULACION",   $this      -> objectsHtml -> GetobjectHtml($this -> fields[fecha_anula_despacho]));
 ...
 public function setAlistamientoSalida($alistamiento_salida_id){

	 $this -> fields[alistamiento_salida_id]['value'] = $alistamiento_salida_id;

     $this -> assign("ALISTAMIENTOID",$this -> objectsHtml -> GetobjectHtml($this -> fields[alistamiento_salida_id]));	  	   

   }

 public function SetGridDespachoAlistamiento($Attributes,$Titles,$Cols,$Query){
  require_once("../../../framework/clases/grid/JqGridClass.php");
  $TableGrid = new JqGrid();
  $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
  $this -> assign("GRIDDESPACHO",$TableGrid -> RenderJqGrid());
...
public function RenderMain(){
 $this ->RenderLayout('DespachoAlistamiento.tpl');
}
