...
final class DespachoLayout extends View{
   ...
   $this -> Guardar = $Permiso;
	...
	$Form1      = new Form("DespachoClass.php","DespachoForm","DespachoForm");	 
	 ...
	 $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/operacion/js/Despacho.js");
...
//// GRID ////  
   public function SetGridDespacho($Attributes,$Titles,$Cols,$Query){
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('Despacho.tpl');
