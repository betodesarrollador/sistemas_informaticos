...
final class ClientesLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $this -> TplInclude -> IncludeCss("sistemas_informaticos/bodega/bases/css/cliente.css");	 
     ...
     $this -> TplInclude -> IncludeJs("sistemas_informaticos/framework/js/funciones.js");
	   $this -> TplInclude -> IncludeJs("sistemas_informaticos/framework/js/generalterceros.js");
     ...
     $this -> TplInclude -> IncludeJs("sistemas_informaticos/bodega/bases/js/clientes.js");
    ...
    $this -> assign("CONTACT",			    $this -> objectsHtml -> GetobjectHtml($this -> fields[contac_cliente_factura]));	 	 
	 ...
	 $this -> assign("CREE_SI",		    	$this -> objectsHtml -> GetobjectHtml($this -> fields[cree_cliente_si]));	 	 
	 $this -> assign("CREE_NO",		    	$this -> objectsHtml -> GetobjectHtml($this -> fields[cree_cliente_no]));	 	 
