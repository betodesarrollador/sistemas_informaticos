...
final class ProtocolosLayout extends View{
 ...
 public function setCampos($campos){
   ...
   $Form1      = new Form("ProtocolosClass.php","ProtocolosForm","ProtocolosForm");
   ...
   $this -> TplInclude -> IncludeJs("../js/Protocolos.js"); 
...
public function RenderMain(){
 $this ->RenderLayout('Protocolos.tpl');
}
