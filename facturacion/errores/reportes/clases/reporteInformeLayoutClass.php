...
final class reporteInformeLayout extends View{
	...
	public function setCampos($campos){
		...
		$Form1 = new Form("reporteInformeClass.php","reporteInformeForm","reporteInformeForm");
		...
		$this -> TplInclude -> IncludeJs("../js/reporteInforme.js"); 
...
//LISTA MENU
	...
	public function RenderMain(){   
		...
		$this -> RenderLayout('reporteInforme.tpl');	 
