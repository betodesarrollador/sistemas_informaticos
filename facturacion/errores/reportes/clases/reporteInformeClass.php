...
final class reporteInforme extends Controler{
  ...
  //DEFINICION CAMPOS DE FORMULARIO
	...
	public function Main(){
		...
		require_once("reporteInformeLayoutClass.php");
		require_once("reporteInformeModelClass.php");

		$Layout   = new reporteInformeLayout($this -> getTitleTab(),$this -> getTitleForm());
		$Model    = new reporteInformeModel();
	...
	protected function generateReport(){
		...
		$Layout -> setJsInclude("../js/reporteInforme.js");	 	 	 		
		...
		$consul_usuario_id	     = $usuario_id > 0         ? " AND i.usuario_id = $usuario_id"  : "";
		
		
		$data = $Model -> selectInformacion($fecha_inicio,$fecha_final,$consul_usuario_id,$this -> getConex());
		...
		$Layout	-> RenderLayout('reporteInformeResult.tpl');	
...
protected function generateFile(){
		...
		$Layout -> exportToExcel('reporteInforme.tpl');
