...
function Listar(formulario){
	...
	document.getElementById('frameResult').src = "reporteSQLClass.php?ACTIONCONTROLER=generateReport&"+Math.random()+FormSerialize(formulario);
...
function Generar(formulario){
	...
	document.location.href = "reporteSQLClass.php?ACTIONCONTROLER=generateFile&"+Math.random()+FormSerialize(formulario);	
}
