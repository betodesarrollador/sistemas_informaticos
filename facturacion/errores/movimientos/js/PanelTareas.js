...
function guardarCierre() {
    ...
    if (fecha_cierre_real != '') {
        ...
        var QueryString = "ACTIONCONTROLER=guardarCierre&actividad_id=" + actividad_id + "&observacion_cierre=" + encodeURIComponent(observacion_cierre) + "&fecha_cierre_real=" + fecha_cierre_real + "&commit=" + commit + "&justificacion_git=" + justificacion_git;
...
function pendienteSocializar() {
    ...
    if (fecha_cierre_real != '') {
        ...
        var QueryString = "ACTIONCONTROLER=pendienteSocializar&actividad_id=" + actividad_id + "&observacion_cierre=" + encodeURIComponent(observacion_cierre) + "&fecha_cierre_real=" + fecha_cierre_real + "&commit=" + commit + "&justificacion_git=" + justificacion_git;
