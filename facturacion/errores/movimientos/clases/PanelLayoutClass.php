...
final class PanelLayout extends View{
   ...
   private $fields;   
    ...
    public function SetCampos($campos){
     ...
     $Form1      = new Form("PanelClass.php","PanelForm","PanelForm");
     ...
     $this -> TplInclude -> IncludeCss("../../../errores/movimientos/css/Panel.css"); 
     ...
     $this -> TplInclude -> IncludeJs("../../../framework/js/ajax-dynamic-list.js");
	  $this -> TplInclude -> IncludeJs("../../../errores/movimientos/js/Panel.js");	 
