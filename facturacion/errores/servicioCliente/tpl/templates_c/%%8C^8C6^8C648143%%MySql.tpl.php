<?php /* Smarty version 2.6.26, created on 2021-01-04 17:34:49
         compiled from MySql.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'MySql.tpl', 39, false),array('modifier', 'count', 'MySql.tpl', 39, false),)), $this); ?>
        ...
        <div id="table_find" align="center">
            <table>
                <tr>
                    ...
                    <td><?php print $this->_tpl_vars['QUERY']; ?>
&emsp;&emsp;</td>
...
?>
       ...
       <?php if ($this->_tpl_vars['DATABASES'][$this->_tpl_vars['contador']]['logo'] != ''): ?>
          ...
          <td><img src="<?php print $this->_tpl_vars['DATABASES'][$this->_tpl_vars['contador']]['logo']; ?>
" width="10%" >&emsp;<input type="checkbox" name="procesar" value="<?php print $this->_tpl_vars['DATABASES'][$this->_tpl_vars['contador']]['db']; ?>
" />&emsp;<?php print $this->_tpl_vars['DATABASES'][$this->_tpl_vars['contador']]['db']; ?>
</td>
       ...
       <?php endfor; endif; ?> 
        ...
        <?php endfor; endif; ?> 
            ...
            <tr>
                <td align="center" colspan="6"><?php print $this->_tpl_vars['EJECUTAR']; ?>
</td>
                <td align="center"><span>Nota. Cantidad de empresas ACTIVAS : <?php print count($this->_tpl_vars['DATABASES']); ?>
</span></td>
            </tr>
        </table>
    </fieldset>  
