...
function autocompleteUbicacion(){
	...
	$("input[name=origen],input[name=destino]").autocomplete("/velotax/framework/clases/ListaInteligente.php?consulta=ubicacion", {
		width: 260,
		selectFirst: false
	});
...
function autocompleteRemesa(){
	...
	$("input[name=remesa]").autocomplete("/velotax/framework/clases/ListaInteligente.php?consulta=remesa", {
		width: 260,
		selectFirst: false
	});
