...
function getDetalleCamposArchivoCliente(){
  ...
  $("#cliente_id").change(function(){
      ...
      document.getElementById('detalleCamposArchivoCliente').src = "DetalleTiposIdentificacionClass.php?cliente_id="+this.value;
...
function setDetalleCamposArchivoCliente(){
  ...
  if(form){
    ...
    $.ajax({
      url        : "TiposIdentificacionClass.php?rand="+Math.random(),
      data       : QueryString,
      beforeSend : function(){
        showDivLoading();
      },
