            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td align="center">
                            <h3>
                                <font color="#FF0000"><b>MANIFIESTOS MENSAJERIA</b></font>
                            </h3>
                        </td>
                    </tr>
                </tbody>
        ...
        <tbody>
                    ...
                    <fieldset class="section">
                        ...
                        <table width="90%">
                            <tbody>
                                ...
                                <tr>
                                    <td><label>Mensajero:</label></td>
                                    <td>{$PROVEEDOR}{$PROVEEDORID}</td>
                                    <td><label>Observaciones :</label></td>
                                    <td>{$OBSERVACIONES}{$FECHAREG}</td>
                                </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    NOTA. Solo se podran ingresar guias en estado <b>ALISTAMIENTO,BODEGA PUENTE,DEVUELTO</b>
                    </div>
                </td>
            ...
            <tr>
                <td align="center">
                    <table width="100%" align="center">
                        <tr>
                            <td>
                                <div align="center">{$GUARDAR}&nbsp;{$ACTUALIZAR}&nbsp;{$IMPRIMIR}&nbsp;{$IMPRIMIR1}&nbsp;{$EXCEL}&nbsp;{$ANULAR}&nbsp;{$LIMPIAR}&nbsp;<span style="display:none">{$BORRAR}</span></div>
                            </td>
                        </tr>
                    </table>
                    </fieldset>
