	  ...
	  <tr>
	    <td colspan="4" align="center"><table width="97%" border="0" align="center">
          ...
          <tr>
           ...
           <tr>
           		<td><label>Total Guias</label></td>
            	<td align="left">{$DETALLES|@count}</td>
				<td><label>Total Guias Interconexi&oacute;n</label></td>
            	<td align="left">{$DETALLES1|@count}</td>                
           </tr>
         </table>
	   </td>
      </tr>
          ...
          *}
          ...
          {*<tr align="center">
            ...
            <td class="productocellrightbottom">{$i.direccion_destinatario}</td>            
             ...
             {/foreach}
            {*<tr>
                <td colspan="2"><label>&nbsp;&nbsp;&nbsp;TOTAL GUIAS</label></td>
                <td align="left">{$DETALLES|@count}</td>
            </tr>*}
