			...
			<div >
				<table id="tableGuia" width="98%">
					<tr>
						...
						<td width="350"><input type="hidden" name="item" id="item" value="1" /><input type="hidden" name="detalle_guia_id" id="detalle_guia_id" value=""/><input type="hidden" name="detalle_ss_id" id="detalle_ss_id" value=""/>{$PRODUCTO}</td>
           ...
           <td> <table align="center" width="90%">
			...
			<td valign="top">
				<table align="center" width="90%">
				  ...
				  <tr> <td><label>Descuento:</label>{$APLICADESC}</td><td>{$VDESC}</td> </tr>
