				...
				<table>
					<tbody>
						<tr>
							...
							<td>{$BUSQUEDA}</td>
							<td align="center">
								<h3><font color="#FF0000"><b>ENTREGAS EN OFICINA MENSAJERIA</b></font></h3>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<tbody>
				<tr>
					<td align="center">
						...
						<legend>ENTREGAS EN OFICINA MENSAJERIA</legend>
							<table width="50%" align="center">
								<tbody>
									<tr>
										<td><label>Fecha :</label></td><td>{$FECHA}{$HORA}{$FECHAREG}</td>
									</tr>
                                    <tr>
				...
				<td>
						...
						NOTA. Solo se podran ingresar guias en estado <b>TRANSITO,DEVUELTO</b>
						</div>
				</td>
									...
									<table  id="tableEntrega">
										<thead>
											<tr>
												...
												<th width="100">DESCRIPCION PRODUCTO</th>
												<th width="80">PESO</th>
										...
										<tbody>
											<tr class="rowGuias">
												...
												<td>
													<input type="text" name="destinatario"  id="destinatario" size="30" value="" class="required saltoscrolldetalle" readonly />
												</td>
												<td>
													<input type="text" name="descripcion_producto"  id="descripcion_producto" size="60" value="" class="required saltoscrolldetalle" readonly />
												</td>
												<td>
				...
				<tr>
					<td align="center">
						<table width="100%" align="center">
							<tr>
								<td>
									{*<div align="center" >{$GUARDAR}&nbsp;{$ACTUALIZAR}&nbsp;{$IMPRIMIR}&nbsp;{$ANULAR}&nbsp;{$LIMPIAR}</div>*}
								</td>
							</tr>
						</table>
					</td>
