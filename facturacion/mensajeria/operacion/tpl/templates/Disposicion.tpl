				...
				<table>
					<tbody>
						<tr>
							...
							<td>{$BUSQUEDA}</td>
							<td align="center">
								<h3><font color="#FF0000"><b>DISPOSICION MENSAJERIA</b></font></h3>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<tbody>
					<tr>
						<td align="center">
							...
							<legend>DISPOSICION MENSAJERIA</legend>
								<table width="50%" align="center">
									<tbody>
										<tr>
											<td><label>Fecha :</label></td><td>{$FECHA}{$DISPOSICIONID}</td>
										</tr>
                                        <tr>
