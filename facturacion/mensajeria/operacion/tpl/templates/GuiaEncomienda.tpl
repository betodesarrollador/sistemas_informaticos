    ...
    <fieldset>
        ...
        <fieldset class="section">
            ...
            <table align="center" width="95%">
                <tr>{$ID}{$CRM}{$FACTURADO}{$OFICINAID}{$USUARIOID}
                    ...
                    <td>{$FECHAGUIA}{$HORAGUIA}</td>
                </tr>
                <tr>
                    <td><label>Guia No.:</label></td>
                    <td>{$PREFIJO}-{$NUMEROGUIA}</td>
                    <td><label>Forma Pago:</label></td>
                    <td>{$FORMAPAGOID}</td>
                    <td><label>Estado:</label></td>
                    <td>{$ESTADOMENSAJERIAID}</td>
                </tr>
                <tr>
                <tr>
                ...
                <tr>
                    <td>
                        <table align="center" width="90%">
                            ...
                            <tr>
                                ...
                                <td>{$DOCUMENTOREMITENTE}{$TIPOIDENTIFICACIONREMITENTEID}<span style="display:none;">{$TIPOIDENTIFICACIONID}</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label>Nombre Remitente:</label></td>
                            ...
                            <tr> <td><label>Correo Electronico:</label></td> <td>{$CORREOREMITENTE}</td> </tr> {* CorreoRemitente *}
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                    ...
                    <td>
                        <table align="center" width="90%">
                            ...
                            <tr>
                                <td><label>Documento:</label></td>
                                <td>{$DOCUMENTODESTINATARIO}{$TIPOIDENTIFICACIONDESTINATARIOID}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                             ...
                             <tr> <td><label>Correo Electronico:</label></td> <td>{$CORREODESTINATARIO}</td> </tr> {* CorreoDestinatario *}
                            <tr>
                                <td><label>Nombre Quien Recibe:</label></td>
                                <td>{$RECIBE}</td>
                            </tr>
                        </table>
                    </td>
                    <td valign="top">
                        <table align="center" width="90%">
                            ...
                            <tr>
                                <td><label>Seguro (% Vr. Declarado):</label></td>
                                <td>{$VSEGURO}</td>
                            </tr>
                            {*<tr>
                                <td><label>Costo Manejo:</label></td>
                                <td>{$COSTOMANEJO}</td>
                            </tr>*}
                            <tr>
                            ...
                            <tr>
                                <td><label>Descuento:</label>{$APLICADESC}</td>
                                <td>{$VDESC}</td>
                            </tr>
                            <tr>
        ...
        <fieldset class="section">
            ...
            <table align="center" width="70%">
                <tr>
                    <td align="center" valign="top"><label>Observaciones:</label></td>
                    <td>{$OBSERVACIONES}</td>
                </tr>
                <tr>
                    <td align="center" valign="top"><label>Motivo Devolucion:</label></td>
                    <td>{$MOTIVODEVOLUCIONID}</td>
                </tr>
                <tr>
                    <td align="center" valign="top"><label>Fecha entrega:</label></td>
                    <td>{$FECHAENTREGA}</td>
                </tr>
            </table>
            </table>
    ...
    <div id="rangoImp">
        <div align="center">
            ...
            <fieldset class="section">
                <table id="tableGuia">
                    <tr>
                        <td> <b>Desde:&nbsp;</b>{$RANGODESDE} <b>&nbsp;&nbsp;&nbsp;Hasta:&nbsp;</b>{$RANGOHASTA}&nbsp;&nbsp;&nbsp;<b>Formato: </b>{$FORMATO} </td>
                    </tr>
                    <tr>
                        <td> <b>Orden Servicio:&nbsp;</b>{$ORDENSERVICIO} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Fecha Creaci&oacute;n Guias: </b>{$FECHAGUIACREA} </td>
                    </tr>
					<tr>
                        <td> <br></td>
                    </tr>
                    <tr>
                        <td> <b>Tipo guia</b> &emsp;{$TIPO_GUIA}</td>
                    </tr>
