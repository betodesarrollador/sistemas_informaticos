...
{/literal}
	...
	<body>
		{if $DATOSREENVIO[0].estado eq 'A'}
			<div class="anulado">ANULADO</div>
			<div class="anulado1">ANULADO</div>
		{/if}  
		{assign var="cont" value="0"}
		{foreach name=guias from=$DATOSREENVIO item=r}
				...
				<tr>
					<td colspan="4">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="47%" align="left"><div class="title" style="font-size:16px">FECHA REENVIO:&nbsp;&nbsp;{$r.fecha_ree}</div></td>
							</tr>
						</table>
					</td>
				</tr>
