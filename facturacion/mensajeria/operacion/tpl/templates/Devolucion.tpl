...
<table>
  <tbody>
    <tr>
      ...
      <td>{$BUSQUEDA}</td>
	  <td align="center"><h3><font color="#FF0000"><b>DEVOLUCION MENSAJERIA</b></font></h3></td>	  
    </tr>
  </tbody>
</table>
</div>
      ...
      <table width="90%" >
        <tbody>
          <tr>
            ...
            <td><label>Mensajero:</label></td><td>{$PROVEEDOR}{$PROVEEDORID}{$DEVOLUCIONID}</td>
          </tr>
          <tr>
            ...
            <fieldset class="section">
             ...
             <div align="center">            
                 ...
                 <div id="divProductos">
                     ...
                     <div id="texto">
                        Causal Anulaci&oacute;n: {$CAUSALDEVOLUCIONID}&nbsp;&nbsp;
                  ...
                  <table  id="tableDevolucion">
                   <thead>
                    ...
                    <tr class="rowGuias">
                     ...
                     <td><input type="text" name="descripcion_producto"  id="descripcion_producto" size="53" value="" class="required saltoscrolldetalle" readonly /></td>	 	 	 
