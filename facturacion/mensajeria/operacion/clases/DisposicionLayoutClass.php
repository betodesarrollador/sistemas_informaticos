<?php
	...
	final class DisposicionLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1 = new Form("DisposicionClass.php","DisposicionForm","DisposicionForm");
			...
			$this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Disposicion.css");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Disposicion.js");
			...
			$this -> assign("DISPOSICIONID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[disposicion_id]));
		...
		public function setCausalesDisposicion($causales){
			$this -> fields[causal_disposicion_id]['options'] = $causales;
			$this -> assign("CAUSALDISPOSICIONID",$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_disposicion_id]));
			$this -> fields[causal_disposicion_id1]['options'] = $causales;
			$this -> assign("CAUSALDISPOSICION1ID",$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_disposicion_id1]));
		}

		//// GRID ////
		public function SetGridDisposicion($Attributes,$Titles,$Cols,$Query){
			require_once("../../../framework/clases/grid/JqGridClass.php");
			$TableGrid = new JqGrid();
			$TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
			$this -> assign("GRIDDISPOSICION",$TableGrid -> RenderJqGrid());
			$this -> assign("TABLEGRIDCSS",$TableGrid -> GetJqGridCss());
			$this -> assign("TABLEGRIDJS",$TableGrid -> GetJqGridJs());
		}

		public function RenderMain(){
			$this ->RenderLayout('Disposicion.tpl');
		}
	}
?>