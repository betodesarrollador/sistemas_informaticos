...
final class GuiaToMCLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $this -> assign("DEPARTAMENTO",	$this -> objectsHtml -> GetobjectHtml($this -> fields[destino]));
	 $this -> assign("DEPARTAMENTOID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[destino_id]));	 
