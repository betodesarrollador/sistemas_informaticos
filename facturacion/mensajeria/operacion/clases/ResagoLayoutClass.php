<?php
	...
	final class ResagoLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1 = new Form("ResagoClass.php","ResagoForm","ResagoForm");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Resago.js");
			...
			$this -> assign("ENTREGAID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[resago_id]));
