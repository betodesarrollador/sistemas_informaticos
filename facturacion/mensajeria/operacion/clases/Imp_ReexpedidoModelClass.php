...
public function getDetalle2($oficina_id,$Conex,$usuario){
	...
	r.cantidad AS cantidad,
	r.descripcion_producto
	FROM detalle_despacho_guia dd, guia_encomienda r WHERE dd.reexpedido_id=$reexpedido_id AND r.guia_encomienda_id=dd.guia_encomienda_id ORDER BY r.numero_guia ASC";	
