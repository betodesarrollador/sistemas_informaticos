...
require_once("../../../framework/clases/PermisosFormClass.php");
	...
	final class SolicServToGuiaInterconModel extends Db{

		private $Permisos;
		private $guias_interconexion_id;
		private $detalle_guia_interconexion_id;

		//// GRID ////
		public function getQuerySolicServToGuiaInterconGrid($cliente_id,$desde,$hasta,$oficina_id){
			$oficina_id=$oficina_id>0 ? " AND s.oficina_id=".$oficina_id : $oficina_id="";
			//	$oficinaId = $_REQUEST['OFICINAID'];
			$Query = "SELECT 
				CONCAT('<input type=\"checkbox\" value=\"',s.guia_interconexion_id,'\" onClick=\"chequear(this);\" />') AS link,
