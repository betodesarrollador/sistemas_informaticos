<?php
	...
	final class NovedadLayout extends View{
		...
		public function setCampos($campos){
			...
			$this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Novedad.css");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Novedad.js");
		...
		public function setCausalesNovedad($causales){
			$this -> fields[causal_novedad_id]['options'] = $causales;
			$this -> assign("CAUSALNOVEDADID",$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_novedad_id]));
			$this -> fields[causal_novedad_id1]['options'] = $causales;
			$this -> assign("CAUSALNOVEDAD1ID",$this -> objectsHtml -> GetobjectHtml($this -> fields[causal_novedad_id1]));
		}
