<?php
	...
	final class SolicServToGuiaIntercon extends Controler{
		...
		public function Main(){
			...
			require_once("SolicServToGuiaInterconLayoutClass.php");
			require_once("SolicServToGuiaInterconModelClass.php");

			$Layout = new SolicServToGuiaInterconLayout($this -> getTitleTab(),$this -> getTitleForm());
			$Model  = new SolicServToGuiaInterconModel();
			...
			$Layout -> SetGridSolicServToGuiaIntercon($Attributes,$Titles,$Cols,$Model -> getQuerySolicServToGuiaInterconGrid($cliente_id,$desde,$hasta,$oficina_id));
			$Layout -> RenderMain();
		}
	...
	$SolicServToGuiaIntercon = new SolicServToGuiaIntercon();
