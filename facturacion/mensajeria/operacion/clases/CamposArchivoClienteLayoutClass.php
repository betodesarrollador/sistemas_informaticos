...
final class CamposArchivoClienteLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("CamposArchivoClienteClass.php","CamposArchivoClienteForm","CamposArchivoClienteForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/CamposArchivoCliente.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('CamposArchivoCliente.tpl');
