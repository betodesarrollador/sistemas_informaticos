...
final class GuiaManualCredito extends Controler{
  ...
  public function Main(){
    ...
    require_once("GuiaManualCreditoLayoutClass.php");
    require_once("GuiaManualCreditoModelClass.php");
	
    $Layout   = new GuiaManualCreditoLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new GuiaManualCreditoModel();
...
$GuiaManualCredito = new GuiaManualCredito();
