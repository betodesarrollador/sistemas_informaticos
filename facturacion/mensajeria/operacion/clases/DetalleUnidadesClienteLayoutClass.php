...
final class DetalleUnidadesClienteLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/velotax/transporte/operacion/css/DetalleUnidadesCliente.css");     
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/DetalleUnidadesCliente.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('DetalleUnidadesCliente.tpl');
