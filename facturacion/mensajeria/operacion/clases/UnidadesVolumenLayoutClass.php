...
final class UnidadesVolumenLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("UnidadesVolumenClass.php","UnidadesVolumenForm","UnidadesVolumenForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/UnidadesVolumen.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('UnidadesVolumen.tpl');
