...
final class Imp_DocumentoLegalizacionLayout extends View{
  ...
  private $fields;
   ...
   public function RenderMain(){
	  ...
	  if($view == 'window'){
         $this -> renderLayout('Imp_DocumentoLegalizacion.tpl','Documento');	  	  
	  }else{
            $this -> exportToPdf('Imp_DocumentoLegalizacion.tpl','Documento');	  
	    }
