...
final class GuiaLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("GuiaClass.php","GuiaForm","GuiaForm");	 
     ...
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Guia.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Guia.js");	 
     ...
     $this -> assign("CARTAPORTE",    	   	$this -> objectsHtml -> GetobjectHtml($this -> fields[cartaporte]));	 
   ...
   $this -> assign("GUIASIMP",        $this -> objectsHtml -> GetobjectHtml($this -> fields[guias]));    
