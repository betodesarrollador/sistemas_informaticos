<?php
	...
	final class GuiaCRMLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1 = new Form("GuiaCRMClass.php","GuiaCRMForm","GuiaCRMForm");
			...
			$this	->	TplInclude	->	IncludeCss("/velotax/mensajeria/operacion/css/GuiaCRM.css");
			...
			$this	->	TplInclude	->	IncludeJs("/velotax/mensajeria/operacion/js/GuiaCRM.js");
			...
			$this	->	assign("CORREOREMITENTE",					$this -> objectsHtml -> GetobjectHtml($this -> fields[correo_remitente])); //Correo Remitente
			// ----- DATOS DESTINATARIO ----- //
			...
			$this	->	assign("CORREODESTINATARIO",				$this -> objectsHtml -> GetobjectHtml($this -> fields[correo_destinatario])); //Correo Destinatario
			...
			$this	->	assign("VDESC",								$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_descuento]));
			$this	->	assign("VTOTAL",							$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_total]));
			// $this	->	assign("APLICADESC",						$this -> objectsHtml -> GetobjectHtml($this -> fields[aplica_descuento]));			
