...
final class InicialMensajeria extends Controler{
	...
	public function Main(){
		...
		$Cols = array(
			array(name=>'mensajeria',      	index=>'mensajeria',      		sorttype=>'text', width=>'135', align=>'center'),
		...
		$Titles = array('TIPO','NO. GUIA','FECHA','REMITENTE','ORIGEN','DESTINATARIO','DESTINO','OFICINA','ESTADO');
