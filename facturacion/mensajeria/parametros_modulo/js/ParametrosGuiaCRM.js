...
function setDataFormWithResponse(){
	...
	var parametros  = new Array({campos:"rango_guia_crm_id",valores:$('#rango_guia_crm_id').val()});
	var forma       = document.forms[0];
	var controlador = 'ParametrosGuiaCRMClass.php';
...
// 		$.ajax({
// 			url     : "ParametrosGuiaCRMClass.php?rand="+Math.random(),
// 			data    : QueryString,
	...
	$("#empresa_id").change(function(){
		if( $(this).val() !== 'NULL'){
			if($("#rango_guia_id").val().length < 1){
				...
				$.ajax({
					url     : "ParametrosGuiaCRMClass.php",
					data    : QueryString,
					success : function(response){
