...
var params     = new Array({campos:"parametros_anticipo_id",valores:$('#parametros_anticipo_id').val()});
var formulario = document.forms[0];
var url        = 'ParametrosAnticipoClass.php';
...
function parametrosAnticipoOnSaveOnUpdateonDelete(formulario,resp){
   ...
   $("#refresh_QUERYGRID_parametros_anticipo").click();
