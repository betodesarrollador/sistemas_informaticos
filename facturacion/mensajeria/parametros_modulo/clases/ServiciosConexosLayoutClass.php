...
final class ServiciosConexosLayout extends View{
   ...
   public function setCampos($campos){
     ...
     //$this -> TplInclude -> IncludeCss("/velotax/transporte/parametros_modulo/css/ServiciosConexos.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/parametros_modulo/js/ServiciosConexos.js");
