...
//	$Layout -> setBases($Model -> getBases($this -> getUsuarioId(),$this -> getConex()));	
	...
	$Cols = array(
	  array(name=>'descuento',	     index=>'descuento',sorttype=>'text',	width=>'100',	align=>'center'),
...
//	  array(name=>'porciento',	     index=>'porciento',	sorttype=>'text',	width=>'100',	align=>'center'),
	  ...
	  array(name=>'naturaleza',		 index=>'naturaleza',sorttype=>'text',	width=>'200',	align=>'center'),	  
	//  array(name=>'tipo',		     index=>'tipo',		sorttype=>'text',	width=>'100',	align=>'center'),
	  ...
	  array(name=>'calculo',		 index=>'calculo',  sorttype=>'text',	width=>'200',	align=>'center'),
	  array(name=>'porcentaje',		 index=>'porcentaje',sorttype=>'text',	width=>'200',	align=>'center'),	  	  	  
