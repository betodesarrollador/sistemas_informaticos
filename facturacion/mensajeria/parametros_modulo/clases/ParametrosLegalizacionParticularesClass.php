...
final class ParametrosLegalizacionParticular extends Controler{
  ...
  public function Main(){
	...
	require_once("ParametrosLegalizacionParticularLayoutClass.php");
	require_once("ParametrosLegalizacionParticularModelClass.php");
	
	$Layout   = new ParametrosLegalizacionParticularLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new ParametrosLegalizacionParticularModel();
	...
	$Layout -> SetGridParametrosLegalizacionParticular($Attributes,$Titles,$Cols,$Model -> getQueryParametrosLegalizacionParticularGrid());
	$Layout -> RenderMain();
  ...
  protected function onclickValidateRow(){
	 ...
	 $Data = new ValidateRow($this -> getConex(),"ParametrosLegalizacionParticular",$this ->Campos);	 
...
//BUSQUEDA
  protected function onclickFind(){
	...
	$Data  = $Model -> selectParametrosLegalizacionParticular($parametros_legalizacion_id,$this -> getConex());
	...
	$this -> Campos[guardar] = array(
 	...
 	$this -> Campos[actualizar] = array(
  	...
  	$this -> Campos[borrar] = array(
		...
		property=>array(
			name	=>'delete_ajax',
			onsuccess=>'ParametrosLegalizacionParticularOnSaveOnUpdateonDelete')
	);
   	...
   	$this -> Campos[limpiar] = array(
		...
		type	=>'reset',
		value	=>'Limpiar',
		onclick	=>'ParametrosLegalizacionParticularOnReset(this.form)'
	);
...
$ParametrosLegalizacionParticular = new ParametrosLegalizacionParticular();
