...
final class RemitenteDestinatario extends Controler{
  ...
  public function Main(){
	...
	$Cols = array(
	  ...
	  array(name=>'telefono',	        index=>'telefono',				sorttype=>'text',	width=>'250',	align=>'left'),	      array(name=>'ubicacion',	            index=>'ubicacion',				sorttype=>'left',	width=>'250',	align=>'center'),	  	  array(name=>'estado',					index=>'estado',				sorttype=>'text',	width=>'100',	align=>'center')
  ...
  protected function sendRemitenteDestinatarioMintransporte(){
	...
	$data = array(	  
		...
		nombre_sede               => $this -> requestData('nombre').' '.$this -> requestData('primer_apellido').' '.$this -> requestData('segundo_apellido').' '.$this -> requestData('razon_social'),		
