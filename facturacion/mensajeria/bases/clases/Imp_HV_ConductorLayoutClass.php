...
final class Imp_HV_ConductorLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/velotax/transporte/bases/css/Imp_HV_Conductor.css");
	 
	 $this -> TplInclude -> IncludeCss("/velotax/framework/css/reset.css","print");
     $this -> TplInclude -> IncludeCss("/velotax/transporte/bases/css/Imp_HV_Conductor.css","print");	 
