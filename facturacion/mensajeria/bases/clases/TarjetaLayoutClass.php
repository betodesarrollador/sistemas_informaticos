...
final class TarjetaLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("TarjetaClass.php","TarjetaForm","TarjetaForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/bases/js/Tarjeta.js");
