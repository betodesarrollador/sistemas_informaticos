...
final class RemitenteDestinatarioLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("RemitenteDestinatarioClass.php","RemitenteDestinatarioForm","RemitenteDestinatarioForm");
	 ...
	 $this -> TplInclude -> IncludeJs("/velotax/transporte/bases/js/remitente_destinatario.js");
   ...
   public function SetGridRemitenteDestinatario($Attributes,$Titles,$Cols,$Query){
   ...
   public function RenderMain(){
	 $this ->RenderLayout('RemitenteDestinatario.tpl');
   }
