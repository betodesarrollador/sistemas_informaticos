<?php
	...
	final class CorreoMasivoClientesLayout extends View{
		...
		public function setIncludes(){
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/bases/js/CorreoMasivoClientes.js");
		...
		public function SetTarifas($dataEnvio){
		...
		public function RenderMain(){
			$this -> RenderLayout('CorreoMasivoClientes.tpl');
		}
	}
?>