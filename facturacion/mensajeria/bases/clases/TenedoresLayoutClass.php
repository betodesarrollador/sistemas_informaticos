...
final class TenedoresLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/bases/js/tenedores.js");
     ...
     $this -> assign("NUMEROCUENTA",		$this -> objectsHtml -> GetobjectHtml($this -> fields[numero_cuenta_tene]));
