...
final class Clientes extends Controler{
  ...
  protected function sendRemitenteDestinatarioMintransporte(){
	...
	$data = array(	  
		...
		nombre                    => $this -> requestData('primer_nombre').' '.$this -> requestData('segundo_nombre').' '.$this -> requestData('primer_apellido').' '.$this -> requestData('segundo_apellido').' '.$this -> requestData('razon_social'),		
