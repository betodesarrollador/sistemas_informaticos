<?php
	...
	final class UbicacionLayout extends View{
		...
		public function setCampos($campos){
			...
			$this -> TplInclude -> IncludeCss("/velotax/mensajeria/bases/css/ubicacion.css"); 
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/bases/js/Ubicacion.js");
			...
			$this -> assign("METROPOLITANA",		$this -> objectsHtml -> GetobjectHtml($this -> fields[metropolitana]));
			$this -> assign("METROPOLITANAID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[metropolitana_id]));
			$this -> assign("ESTADOMENSAJERIA",		$this -> objectsHtml -> GetobjectHtml($this -> fields[estado_mensajeria]));
