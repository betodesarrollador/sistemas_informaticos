<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
	...
	<body>
		<form>
			<table align="center" width="100%" border="1" id="tableTarifasCliente" name="tablaTarifasCliente">
				<tr>
					...
					<td rowspan="{$k}">
						NORMAL
						<input type="text" id="tipo_servicio_mensajeria_id" name="tipo_servicio_mensajeria_id" value="1" hidden>
