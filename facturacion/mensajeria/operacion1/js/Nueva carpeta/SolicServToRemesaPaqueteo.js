...
function setSolicitud(){
    ...
    $(document).find("input[type=checkbox]:checked").each(function(){
      ...
      if(orden_despacho == '' && orden_despacho_tmp == ''){
        ...
        orden_despacho = $.trim($(this.parentNode.parentNode).find("td[aria-describedby=QUERYGRID_SolicServToRemesaPaqueteo_orden_despacho]").text());      		
	
	    orden_despacho_tmp = orden_despacho;
		
      }else{
	
       orden_despacho_tmp=$.trim($(this.parentNode.parentNode).find("td[aria-describedby=QUERYGRID_SolicServToRemesaPaqueteo_orden_despacho]").text());      		
	    if($.trim(orden_despacho_tmp) != $.trim(orden_despacho)){
    ...
    $(document).find("input[type=checkbox]:checked").each(function(){
      ...
      if(solicitud_id == '' && solicitud_id_tmp == ''){
        ...
        solicitud_id = parseInt($(this.parentNode.parentNode).find("td[aria-describedby=QUERYGRID_SolicServToRemesaPaqueteo_solicitud]").text());      			
       ...
       solicitud_id_tmp = parseInt($(this.parentNode.parentNode).find("td[aria-describedby=QUERYGRID_SolicServToRemesaPaqueteo_solicitud]").text());      			
	...
	$.ajax({
	  ...
	  url     : "SolicServToRemesaPaqueteoClass.php?rand="+Math.random(),
	  data    : QueryString,
