...
function onclickUpdate(formulario){
	...
	if(!isNaN(reexpedido_id)){
		var QueryString = "ACTIONCONTROLER=onclickUpdate&reexpedido_id="+reexpedido_id+"&obser_rxp="+obser_rxp+"&fecha_rxp="+fecha_rxp+"&destino_id="+destino_id+"&proveedor_id="+proveedor_id;
