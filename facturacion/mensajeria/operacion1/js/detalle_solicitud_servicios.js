...
function autocompleteUbicacion(){
	...
	$("input[name=origen],input[name=destino]").autocomplete("/velotax/framework/clases/ListaInteligente.php?consulta=ciudad", {
		width: 260,
		selectFirst: true
	});
...
function autocompleteRemitente(){
	...
	$("input[name=remitente]").autocomplete("/velotax/framework/clases/ListaInteligente.php?consulta=remitente", {
		width      : 260,
		selectFirst: true
	});
...
function autocompleteDestinatario(){
	...
	$("input[name=destinatario]").autocomplete("/velotax/framework/clases/ListaInteligente.php?consulta=destinatario", {
		width: 260,
		selectFirst: true
	});
