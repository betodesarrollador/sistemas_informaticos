...
final class GuiaInterconexion extends Controler{
  ...
  public function Main(){
    ...
    require_once("GuiaInterconexionLayoutClass.php");
    require_once("GuiaInterconexionModelClass.php");
	
    $Layout   = new GuiaInterconexionLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new GuiaInterconexionModel();
  ...
  protected function uploadFileAutomatically(){
    ...
    $nombreArchivo = "guias_interconexion_".rand();    
	...
	for($i = 0; $i < count($arrayInsert) - 1; $i++){
		...
		$errorLogTmp = $Model -> setInsertDetalleSolicitud($arrayInsert[$i],$this -> getOficinaId(),$this -> getConex());      
...
$GuiaInterconexion = new GuiaInterconexion();
