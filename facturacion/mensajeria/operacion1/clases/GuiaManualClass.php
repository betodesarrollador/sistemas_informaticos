...
final class GuiaManual extends Controler{
  ...
  public function Main(){
    ...
    require_once("GuiaManualLayoutClass.php");
    require_once("GuiaManualModelClass.php");
	
    $Layout   = new GuiaManualLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new GuiaManualModel();
