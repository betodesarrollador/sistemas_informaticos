...
final class DetalleUnidadesVolumenClienteLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/velotax/transporte/operacion/css/DetalleUnidadesVolumenCliente.css");     
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/DetalleUnidadesVolumenCliente.js");
