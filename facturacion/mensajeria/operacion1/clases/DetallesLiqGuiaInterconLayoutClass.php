...
final class DetallesLiqGuiaInterconLayout extends View{
	...
	public function setIncludes(){
		...
		$this	->	TplInclude	->	IncludeJs("/velotax/framework/js/funciones.js");
		$this	->	TplInclude	->	IncludeJs("/velotax/mensajeria/operacion/js/DetallesLiqGuiaIntercon.js");

		$this -> assign("CSSSYSTEM",  $this -> TplInclude -> GetCssInclude());
		$this -> assign("JAVASCRIPT", $this -> TplInclude -> GetJsInclude());
		$this -> assign("CLIENTEID",$_REQUEST['cliente_id']);
		$this -> assign("GUIASID",$_REQUEST['guias_interconexion_id']);
	...
	public function RenderMain(){
		$this -> RenderLayout('DetallesLiqGuiaIntercon.tpl');
	}
}
?>