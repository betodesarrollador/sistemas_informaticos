...
final class Imp_GuiaEncomienda{
  ...
  public function printOut($usuario,$empresa_id,$oficina_id,$nit_empresa){
      ...
      //require_once("Imp_GuiaEncomiendaLayoutClass.php");
      require_once("Imp_GuiaEncomiendaModelClass.php");
      require_once("../../../framework/clases/fpdf/fpdf.php");	  	  
      require_once("../../../framework/clases/barcode.php");	  
		
      //$Layout  = new Imp_GuiaEncomiendaLayout();
	  
		  
      $Model   = new Imp_GuiaEncomiendaModel();		
	  $barcode = new barcode();		
      ...
      //$Layout -> RenderMain();
		if ($_REQUEST['formato']=='SI'){
			...
			for($i = 0; $i < count($guia); $i++){	
			 ...
			 $pdf->Image('../media/images/forms/supertrans.png',140,8,21,9); 
			 $pdf->Image($guia[$i]['codbar'],165,8,40,7); 	 
			 $pdf->Cell(40,3,null,0,0,'R');		 	 
			 $pdf->SetFont('Arial','B',6);	 
			 $pdf->Cell(89,3,'Ppal. Carerra 6 No 21-34 B/el Carmen. Ibagué NIT. '.$nit_empresa.' Web: '.strtolower($guia[$i]['pagina_web']).'',0,0,'R');		 
			 ...
			 $pdf->SetFont('Arial','B',6);	
			 //$pdf->Cell(13,9,'Resol. MINTIC No. '.$guia[$i]['resolucion_ministerio'].' de '.$guia[$i]['fecha_resolucion'].'. Régimen Común  Rpostal 404                     ',0,0,'R');		
			 $pdf->Ln(3);	 
			 ...
			 $pdf->Cell(65, 3, substr(utf8_decode($guia[$i]['remitente']),0,50), 0);
			 $pdf->Cell(20, 3, "Destinatario:", 0);
			 $pdf->Cell(62, 3, substr(utf8_decode($guia[$i]['destinatario']),0,60), 0);	 
 			 $pdf->Cell(30,3,$guia[$i]['fecha_guia'].' '.$guia[$i]['hora_guia'],0,0,'C');

			 
			 // Fila 3 Cuadro 1
			 $pdf->SetX(40);
			 $pdf->SetY(28);
			 $pdf->Cell(18, 3, "Dirección:", 0);
			 $pdf->Cell(65, 3, substr(utf8_decode($guia[$i]['direccion_remitente']),0,50), 0);
			 $pdf->Cell(20, 3, "Dirección:", 0);
			 ...
			 $pdf->SetX(40);
			 $pdf->SetY(32);
			 $pdf->Cell(18, 3, "DI/NIT:", 0);
			 $pdf->Cell(20, 3, substr(utf8_decode($guia[$i]['doc_remitente']),0,34), 0);
			 $pdf->Cell(15, 3, "Teléfono:", 0);
			 $pdf->Cell(30, 3, substr(utf8_decode($guia[$i]['telefono_remitente']),0,34), 0);
			 $pdf->Cell(20, 3, "DI/NIT:", 0);
			 $pdf->Cell(20, 3, substr(utf8_decode($guia[$i]['doc_destinatario']),0,34), 0);
			 $pdf->Cell(15, 3, "Teléfono:", 0);
			 $pdf->Cell(30, 3, substr(utf8_decode($guia[$i]['telefono_destinatario']),0,26), 0);
			 $pdf->Cell(25,3,$guia[$i]['tipo_servicio'],0,0,'C');
			 ...
			 $pdf->SetX(40);
			 $pdf->SetY(43);	 
			 $pdf->Cell(140, 8,"", 1,0,'C');	 	 	
			 $pdf->SetX(40);
			 $pdf->SetY(43);	 
 			 $pdf->Cell(140, 3,"El usuario declara tener conocimiento del contrato que regula el servicio acordado entre las partes, el cual se encuentra publicado en la página www.velotax.com.co", 0,0,'L');	 	 	
			 $pdf->Cell(55, 8, "", 1,0,'C');	 	 	
			 $pdf->SetX(150);
			 
 			 $pdf->Cell(55, 3,"VELOTAX entidad cooperativa del régimen tributario especial.", 0,0,'L');
			 $pdf->SetY(45);
 			 $pdf->Cell(140, 3,"sección mensajería y en los centros de recepción, aceptando las clausulas con la suscripción de la guía. También declara tener conocimiento de nuestro aviso de ", 0,0,'L');	 	 	
  			 $pdf->Cell(55, 3,"Nuestros ingresos NO están sujetos a retención en la fuente.", 0,0,'L');
			 $pdf->SetY(47);
 			 $pdf->Cell(140, 3,"privacidad y aceptar la política de protección de datos personales los cuales están en el portal web. Para P.Q.R  diríjase al sitio web o a la línea 018000934380.", 0,0,'L');	 	 	
  			 $pdf->Cell(55, 3,"(Art. 19-4 Par.1del E.T); (Art.14 D.R 4400 de 2004).", 0,0,'L');
			 $pdf->SetY(49);
			 ...
			 $pdf->SetX(40);
			 $pdf->SetY(66);	 	
			 $pdf->Cell(40,3,"Impresión Software Si & Si NIT. 900608466-4",0,0,'L');	
			 $pdf->Cell(115,3,"PRUEBA ENTREGA",0,0,'C');	 
			 // fin copia 1
			 ...
			 $pdf->Image('../media/images/forms/supertrans.png',140,74,21,9); 
			 $pdf->Image($guia[$i]['codbar'],165,140,40,7); 	 
			 $pdf->Cell(40,3,null,0,0,'R');		 	 
			 $pdf->SetFont('Arial','B',6);	 
			 $pdf->Cell(89,3,'Ppal. Carrera 6 No 21-34 B/el Carmen. Ibagué NIT. '.$nit_empresa.' Web: '.strtolower($guia[$i]['pagina_web']).'',0,0,'R');		 
			...
			/*$pdf->SetX(40);
			 ...
			 $pdf->SetY(132);	 	
			 $pdf->Cell(40,3,"Impresión Software Si & Si NIT. 900608466-4",0,0,'L');	
			 $pdf->Cell(115,3,"DESTINATARIO",0,0,'C');	 
			 // fin copia 2
			 ...
			 $pdf->Image('../media/images/forms/supertrans.png',140,140,21,9); 			 
			 ...
			 //$pdf->Cell(22,3,$guia[$i]['solicitud_id'],0,0,'R');			 
			 $pdf->Cell(41,3,"",0,0,'L');
			 $pdf->Cell(30,3,'FACTURA No '.$guia[$i]['numero_guia_bar'],0,0,'C');		 	 	 
			 $pdf->Ln(3.5);	 
			 ...
			 $pdf->SetY(179);
 			 $pdf->Cell(140, 3,"privacidad y aceptar la política de protección de datos personales los cuales están en el portal web. Para P.Q.R  diríjase al sitio web o a la línea 018000934380.", 0,0,'L');	 	 	
  			 $pdf->Cell(554, 3,"(Art. 19-4 Par.1del E.T); (Art.14 D.R 4400 de 2004).", 0,0,'L');
			 $pdf->SetY(181);
 			 $pdf->Cell(140, 3,"", 0,0,'L');	 	 	
  			 $pdf->Cell(55, 3,"", 0,0,'L');
			...
			/*$pdf->SetX(40);
			 ...
			 $pdf->SetY(198);
		  	 $pdf->Cell(40,3,"Impresión Software Si & Si NIT. 900608466-4",0,0,'L');	
			 $pdf->Cell(115,3,"REMITENTE",0,0,'C');	 
			 // fin copia 3	 
			...
			//copia 4
			 ...
			 $pdf->Image('../media/images/forms/supertrans.png',140,205,21,9); 			 
			 ...
			 $pdf->SetY(217);
			 $pdf->Cell(18, 3, "Origen :", 0);
			 $pdf->Cell(65, 3, substr(utf8_decode($guia[$i]['origen']),0,34).' - '.$guia[$i]['pais_origen'].'- CP '.$guia[$i]['postal_origen'],0);
			 $pdf->Cell(20, 3, "Destino :", 0);
			 $pdf->Cell(62, 3, substr(utf8_decode($guia[$i]['destino']),0,34).' - '.$guia[$i]['pais_destino'].'- CP '.$guia[$i]['postal_destino'],0); 	 	 
			 $pdf->Cell(30,3,"Fecha y Hora Aforo",0,0,'C');	
			...
			/* $pdf->SetX(40);
			 ...
			 $pdf->SetY(247);	 	
			 $pdf->Cell(65,5,"Observaciones :",0,0,'L');
			 $pdf->Cell(50,5,"Remitente acepta a conformidad",0,0,'L');
			 $pdf->Cell(60,5,"DESCONOCIDO   __    __    __ Fecha: __ __ __ Hora: __ __",0,0,'L');
			 $pdf->Cell(12,5,"V/R Flete:",0,0,'L');
			 $pdf->Cell(10,5,number_format($guia[$i]['valor_flete'],0,',','.')."",0,0,'L');	 
			 ...
			 $pdf->Cell(65,5,$guia[$i]['oficina_responsable'],0,0,'L');	 
			 $pdf->SetFont('Arial','B',6);
			 $pdf->Cell(75,5,"Nombre legible, C.C, Sello",0,0,'L');	 
			 
			 $pdf->SetFont('Arial','B',6);		 
			 $pdf->SetX(40);
			 $pdf->SetY(263);	
 			 $pdf->Cell(40,3,"Impresión Software Si & Si NIT. 900608466-4",0,0,'L');				 
			 $pdf->Cell(115,3,"ARCHIVO",0,0,'C');	 
			// fin copia 4
			 }	 	
