...
final class UbicacionesClienteTarifasLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("UbicacionesClienteTarifasClass.php","UbicacionesClienteTarifasForm","UbicacionesClienteTarifasForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/operacion/js/UbicacionesClienteTarifas.js");
...
//LISTA MENU
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('UbicacionesClienteTarifas.tpl');
