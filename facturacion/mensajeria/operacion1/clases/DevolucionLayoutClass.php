...
final class DevolucionLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("DevolucionClass.php","DevolucionForm","DevolucionForm"); 	 
     ...
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Devoluciona.css");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Devolucion.js");
