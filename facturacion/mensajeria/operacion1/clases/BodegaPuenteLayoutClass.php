<?php
	...
	final class BodegaPuenteLayout extends View{
		...
		public function setCampos($campos){
			...
			$Form1 = new Form("BodegaPuenteClass.php","BodegaPuenteForm","BodegaPuenteForm");
			...
			$this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/BodegaPuente.js");
			...
			$this -> assign("ENTREGAID",		$this -> objectsHtml -> GetobjectHtml($this -> fields[entrega_parcial_id]));
		...
		public function RenderMain(){
			$this ->RenderLayout('BodegaPuente.tpl');
		}
	}
?>