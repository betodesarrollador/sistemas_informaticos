      ...
      //$Layout -> RenderMain();
		if ($_REQUEST['formato']=='SI'){
			...
			for($i = 0; $i < count($guia); $i++){	
			 ...
			 $pdf->Image('../media/images/forms/super.jpg',140,8,18,6); 
			 ...
			 $pdf->Cell(45,3,"CREDITO",0,0,'R');
			 $pdf->Cell(30,3,'REMESA No '.$guia[$i]['numero_guia_bar'],0,0,'C');		 	 	 
			 $pdf->Ln(3.5);	 
			 ...
			 $pdf->Image('../media/images/forms/super.jpg',140,74,18,6); 
			...
			/*$pdf->SetX(40);
			 ...
			 $pdf->Image('../media/images/forms/super.jpg',140,140,18,6); 			 
			...
			//copia 4
			 ...
			 $pdf->Image('../media/images/forms/super.jpg',140,205,18,6); 			 
