...
final class ManifiestoLayout extends View{
   ...
   public function setImprimir($Permiso){
    ...
    public function setImprimir1($Permiso){
     $this -> Imprimir1 = $Permiso;
   }
   
   public function setCampos($campos){

     require_once("../../../framework/clases/FormClass.php");	 
	 $Form1 = new Form("ManifiestoClass.php","ManifiestoForm","ManifiestoForm"); 	 
     ...
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/Entregas.css");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/Manifiestos.js");
     ...
     $this -> assign("HORASALIDA",		$this -> objectsHtml -> GetobjectHtml($this -> fields[hora_salida]));
     ...
     $this -> assign("NGUIAS",    		$this -> objectsHtml -> GetobjectHtml($this -> fields[n_guias]));
	 $this -> assign("INTERNO",    		$this -> objectsHtml -> GetobjectHtml($this -> fields[interno]));
...
//// GRID ////
   public function SetGridManifiesto($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
	 $TableGrid = new JqGrid();
 	 $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDMANIFIESTO",$TableGrid -> RenderJqGrid());
