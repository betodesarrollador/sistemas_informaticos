...
final class SolicitudServiciosLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/SolicitudServicios.js");
...
//LISTA MENU
   ...
   public function SetTipoServicioMen($TipoServicioMen){
	 $this -> fields[tipo_servicio_mensajeria_id]['options'] = $TipoServicioMen;
	 $this -> assign("TIPOSERVICIOID",$this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_servicio_mensajeria_id]));
   }
