...
final class ReenvioInterLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("ReenvioInterClass.php","ReenvioInterForm","ReenvioInterForm"); 	 
     ...
     $this -> TplInclude -> IncludeCss("/velotax/mensajeria/operacion/css/ReenvioInter.css");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/mensajeria/operacion/js/ReenvioInter.js");
     ...
     $this -> assign("REENVIOID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[reenvio_id]));
	 
	 
     $this -> assign("FECHA",			$this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_ree]));
     $this -> assign("ESTADO",		$this -> objectsHtml -> GetobjectHtml($this -> fields[estado]));	 
     
     $this -> assign("OBSERVACIONES",	$this -> objectsHtml -> GetobjectHtml($this -> fields[obser_ree]));
...
//// GRID ////
   public function SetGridReenvioInter($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
	 $TableGrid = new JqGrid();
 	 $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDREENVIO",$TableGrid -> RenderJqGrid());
     $this -> assign("TABLEGRIDCSS",$TableGrid -> GetJqGridCss());
     $this -> assign("TABLEGRIDJS",$TableGrid -> GetJqGridJs());
   }

   public function RenderMain(){   
        $this ->RenderLayout('ReenvioInter.tpl');	 
   }
}
