          ...
          <td><table  border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
             <td width="843" align="left">
			    <img src="{$DATOSMANIFIESTO.logo}" width="150" height="40" />&nbsp;		  				 
		         			   </td>
...
{$DATOSMANIFIESTO.lugar_pago_saldo|substr:38:68}</td>
            ...
            <tr>
              ...
              <td width="793" rowspan="5" align="center" valign="top" class="cellRight">FIRMA AUTORIZADA POR LA EMPRESA</td>
            ...
            <tr>
              <td width="759"  align="center" valign="middle" class="cellRight" >{$DATOSMANIFIESTO.observaciones}<br>ID MOBILE : {$DATOSMANIFIESTO.id_mobile}&nbsp;</td>
            </tr>
          ...
          <br class="saltopagina" />	
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr>
				<td><table  border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td width="843" align="left">{$DATOSMANIFIESTO.logo}&nbsp;  </td>
