   ...
   <thead>
    ...
    <tr>
     <td>
       ...
       <input type="hidden" name="detalle_ss_id" id="detalle_ss_id" vaue="{$d.detalle_ss_id}" >      	   
	 </td>          
	 <td>
     ...
     <td>
      <input type="text" autocomplete="off" name="descripcion_producto" id="descripcion_producto" value="{$d.descripcion_producto}" class="required saltoscrolldetalle" />
      </td>     
    ...
    <tr>
     ...
     <td>
       <input type="text" autocomplete="off" name="direccion_remitente" id="direccion_remitente" value="" class="required" />
     </td>  
     <td>
     ...
     <td>
      <input type="text" autocomplete="off" name="telefono_remitente" id="telefono_remitente" value="" class="required integer saltoscrolldetalle"/>
     </td>          
     <td>
     ...
     <td>
      <input type="text" autocomplete="off" name="direccion_destinatario" id="direccion_destinatario" value="" class="required saltoscrolldetalle"/>
     </td> 
     <td>
     ...
     <td>
      <input type="text" autocomplete="off" name="telefono_destinatario" id="telefono_destinatario" value="" class="required integer saltoscrolldetalle" />
     </td>     
     <td>
       <input type="text" autocomplete="off" name="referencia_producto" id="referencia_producto" value="" class="required saltoscrolldetalle" />
     </td>     
     <td>
      <input type="text" autocomplete="off" name="descripcion_producto" id="descripcion_producto" value="" class="required saltoscrolldetalle" />
      </td>     
     ...
     <td><input type="text" autocomplete="off" name="peso_volumen" id="peso_volumen" value="" class="required numeric" /></td>               
     <td>
       <select name="unidad_volumen_id" id="unidad_volumen_id" class="required saltoscrolldetalle">
         <option value="NULL">(....)</option>
         {foreach name=unidades from=$UNIDADESVOLUMEN item=u}
