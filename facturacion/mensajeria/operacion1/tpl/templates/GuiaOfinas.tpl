			  ...
			  <table  id="tableRemesas">
			   <thead>
				...
				<tr>
				 ...
				 <td><a name="saveDetalleRemesa" href="javascript:void(0)"><img name="add" src="/velotax/framework/media/images/grid/add.png" /></a></td>
				</tr>   
				</tbody>
			  </table>
			  <table>
		...
		<fieldset class="section">
		 ...
		 <table width="85%" align="center" id="dataProducto" >
           <tr>
			 ...
			 <img id="reloadListProductos" src="/velotax/framework/media/images/grid/load.png" style="cursor:pointer" /></td>
           </tr>
           <tr>
