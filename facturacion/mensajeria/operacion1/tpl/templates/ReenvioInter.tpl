...
<table>
  <tbody>
    <tr>
      ...
      <td>{$BUSQUEDA}</td>
	  <td align="center"><h3><font color="#FF0000"><b>REENVIO MENSAJERIA</b></font></h3></td>	  
    </tr>
  </tbody>
</table>
</div>
...
<table align="center" width="95%">
  <tbody>
    <tr>
	  ...
	  <legend>REENVIO MENSAJERIA</legend>
    ...
    <tr>
    	<td>
            <fieldset class="section">
             <legend>GUIAS A REENVIAR</legend>
