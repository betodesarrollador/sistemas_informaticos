   ...
   {$OFICINAIDSTATIC}{$FECHA}{$FORM1}{$DETALLESSID}{$TIMPRE}	{$OFICINAID}
    ...
    <legend>Informacion general</legend>
        <table align="center" width="95%">
          ...
          <tr> 
            <!-- <td><label>Planilla:</label></td> <td>{$PLANILLA}</td> -->
            <td><label>Solicitud Servicio:</label></td> <td>{$SOLICITUDID}</td>        
          ...
          <tr>
            ...
            <td>{$FORMAPAGOID}</td>
            <td><label>Cartaporte :</label></td>
            <td>{$CARTAPORTE}</td>
          </tr>
          <tr >
            <td><label>Foto Guia:</label></td>
            <td>{$FOTO_GUIA}</td>
			...
			<div >
				<table id="tableGuia" width="98%">
					<tr>
						...
						<td><input type="hidden" name="item" id="item" value="1" /><input type="hidden" name="detalle_guia_id" id="detalle_guia_id" value=""/><input type="hidden" name="detalle_ss_id" id="detalle_ss_id" value=""/>{$PRODUCTO}</td>
        ...
        <table align="center" width="100%">
		  <tr>
              ...
              <table align="center" width="97%">
                <tbody>
                    <tr>
                        <td align="left"><label>CLIENTE: </label></td><td colspan="3" align="left">{$CLIENTEID}</td>
                    </tr>		
                </tbody>
              </table>    
            </td>
      ...
      <div align="center">
	    <p align="center">
		  ...
		  <table id="tableGuia">
		    <tr>
		    	<td>
		    		<b>Formato:</b>{$FORMATO}&nbsp;&nbsp;&nbsp;<b>Guias:</b>&nbsp;&nbsp;&nbsp;{$GUIASIMP}<br><br>
...
<div id="divAnulacion">
  <form onSubmit="return false">
	<table>              
	  ...
	  <tr>
		<td colspan="2" align="center">{$ANULA}</td>
	  </tr>                    
	</table>
  </form>
