        			...
        			<tr>
          				<td>
                        	<table  border="0" cellpadding="0" cellspacing="0" width="100%">
            					<tr>
             						<td width="220" align="left" valign="top"><img src="{$DATOSENCABEZADO.logo}" width="150" height="42" /></td>
                                    	...
                                    	<table cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
      										...
      										<tr>
                                                ...
                                                <td class="cellRight"><span class="content">{$DATOSENCABEZADO.numero_soporte}</span></td>
      		...
      		<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>    
                        ...
                        <td class="cellRight">{$i.descripcion}</td>
