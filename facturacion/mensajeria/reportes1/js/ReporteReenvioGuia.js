...
function sologuia(){
	...
	if ($('#allguia').val()=='S'){
		...
		$("#allreexpedido").val('N');
		$('#desde,#hasta,#estado_id,#all_estado,#all_oficina,#si_mensajero,#oficina_id,#mensajero,#origen,#destino,#allreexpedido,#reexpedido,#consolidado').attr('disabled','true');
		$('#desde,#hasta,#estado_id,#si_mensajero,#oficina_id,#allreexpedido,#reexpedido,#consolidado').removeClass('obligatorio');
	...
	if ($('#allguia').val()=='N'){
		...
		$("#allreexpedido").val('S');
		$('#allreexpedido,#reexpedido,#consolidado').attr('disabled','');
...
function soloreexpedido(){
	...
	if ($('#allreexpedido').val()=='S'){
		...
		$('#desde,#hasta,#estado_id,#all_estado,#all_oficina,#si_mensajero,#oficina_id,#mensajero,#origen,#destino,#guia_id').attr('disabled','true');
		$('#desde,#hasta,#estado_id,#si_mensajero,#oficina_id,#allguia,#guia_id').removeClass('obligatorio');
	...
	if ($('#allreexpedido').val()=='N'){
		...
		$('#desde,#hasta,#estado_id,#all_estado,#all_oficina,#si_mensajero,#oficina_id,#origen,#destino').attr('disabled','');
...
function OnclickGenerar(formulario){
	...
	if(ValidaRequeridos(formulario)){
		 var QueryString = "ReporteReenvioGuiaClass.php?ACTIONCONTROLER=generateReport&"+FormSerialize(formulario);
...
function OnclickGenerarExcel(formulario){
     if(ValidaRequeridos(formulario)){
       var QueryString = "ReporteReenvioGuiaClass.php?ACTIONCONTROLER=generateReport&download=true&"+FormSerialize(formulario);
