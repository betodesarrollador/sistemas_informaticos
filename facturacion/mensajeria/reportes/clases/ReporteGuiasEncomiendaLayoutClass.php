...
final class ReporteGuiasEncomiendaLayout extends View
{
    ...
    public function setCampos($campos)
    {
        ...
        $Form1 = new Form("ReporteGuiasEncomiendaClass.php", "ReporteGuiasEncomiendaForm", "ReporteGuiasEncomiendaForm");
        ...
        $this->TplInclude->IncludeJs("/velotax/mensajeria/reportes/js/ReporteGuiasEncomienda.js");
        ...
        $this->assign("ALLFORMA", $this->objectsHtml->GetobjectHtml($this->fields[all_forma]));
...
//LISTA MENU
    ...
    {
        $this->fields[forma_pago_mensajeria_id]['options'] = $forma_pago;
        $this->assign("FORMA_PAGO", $this->objectsHtml->GetobjectHtml($this->fields[forma_pago_mensajeria_id]));
    }

    public function RenderMain()
    {
        $this->RenderLayout('ReporteGuiasEncomienda.tpl');
    }
}
