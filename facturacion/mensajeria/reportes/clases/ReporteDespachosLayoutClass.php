...
final class reporteDespachosLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reporteDespachosClass.php","reporteDespachosForm","reporteDespachosForm");
     ...
     $this -> TplInclude -> IncludeJs("/velotax/transporte/reportes/js/reporteDespachos.js"); 
...
//LISTA MENU
   ...
   public function RenderMain(){   
     $this -> RenderLayout('ReporteDespachos.tpl');	 
   }
