...
final class reporteMINTICClass extends Controler{
	...
	public function generarTipoReporte(){
		...
		switch ($tiporeporte) {
			...
			case 7:
				...
				$this -> generarReporteFormatoIngresosEnviosMensajeria($download,$desde,$hasta,$origen,$origen_id,$destino,$destino_id,$cliente_id,$si_cliente,$oficina_id,$all_oficina,$tiporeporte);
	...
	public function generarReporteFormatoIngresosEnviosMensajeria($download,$desde,$hasta,$origen,$origen_id,$destino,$destino_id,$cliente_id,$si_cliente,$oficina_id,$all_oficina,$tiporeporte){
		...
		$entregas = $Model -> getReporteIngresosEnviosMensajeria($desde,$hasta,$consulta_origen,$consulta_destino,$consulta_cliente,$consulta_oficina,$this -> getConex());
