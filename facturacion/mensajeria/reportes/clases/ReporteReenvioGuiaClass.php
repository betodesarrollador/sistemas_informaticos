<?php
	...
	final class ReporteReenvioGuia extends Controler{
		...
		public function Main(){
			...
			$this -> noCache();
			require_once("ReporteReenvioGuiaLayoutClass.php");
			require_once("ReporteReenvioGuiaModelClass.php");

			$Layout   = new ReporteReenvioGuiaLayout($this -> getTitleTab(),$this -> getTitleForm());
			$Model    = new ReporteReenvioGuiaModel();
		...
		protected function generateReport(){
			...
			$Layout -> setJsInclude("/velotax/mensajeria/reportes/js/ReporteReenvioGuia.js");
			...
			if($download == 'true'){
				$Layout -> exportToExcel('DetallesReporteReenvioGuia.tpl');
			}else{
				$Layout -> RenderLayout('DetallesReporteReenvioGuia.tpl');
			}
		}
	...
	$ReporteReenvioGuia = new ReporteReenvioGuia();
?>