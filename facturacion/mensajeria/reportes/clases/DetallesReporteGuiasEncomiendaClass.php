...
final class DetallesReporteGuiasEncomienda extends Controler{
	...
	public function Main(){
		...
		require_once("DetallesReporteGuiasEncomiendaLayoutClass.php");
		require_once("DetallesReporteGuiasEncomiendaModelClass.php");
		
		$Layout                 		= new DetallesReporteGuiasEncomiendaLayout();
		$Model                  		= new DetallesReporteGuiasEncomiendaModel();	
		...
		$consul_forma_pago = " AND g.forma_pago_mensajeria_id IN (".$forma_pago_mensajeria_id.") ";

		$Layout -> setReporte1($Model -> getReporte1($consul_forma_pago,$desde,$hasta,$consulta_origen,$consulta_destino,$estado_id,$tipo_servicio_mensajeria_id,$consulta_usuario,$consulta_remitente,$consulta_destinatario,$consulta_oficina,$this -> getConex()));
		$Layout -> RenderMain();    
	}
	...
	protected function generateFile(){
		...
		$data  = $Model -> getReporte1($consul_forma_pago,$desde,$hasta,$consulta_origen,$consulta_destino,$estado_id,$tipo_servicio_mensajeria_id,$consulta_usuario,$consulta_remitente,$consulta_destinatario,$consulta_oficina,$this -> getConex());
	...
	protected function generateFileFormato(){
		...
		if($_REQUEST['download'] == 'true'){
			$Layout -> exportToExcel('DetallesReporteGuiasEncomienda.tpl');
		}
	}
	...
	protected function generateFileFormato1(){
		...
		if($_REQUEST['download'] == 'true'){
			$Layout -> exportToExcel('DetallesReporteGuiasEncomiendaFiltro.tpl');
		}
	}
...
$DetallesReporteGuiasEncomienda = new DetallesReporteGuiasEncomienda();
