...
<body>
    ...
    <table align="center"  width="90%">
        <thead>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">TIPO GUIA </th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">PROCESO</th>
            <th class="borderTop borderRight borderLeft borderBottom">PEDIDO</th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">IDENTIFICACION MENSAJERO RECIBE</th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">IDENTIFICACION MENSAJERO DEVUELVE</th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">IDENTIFICACION MENSAJERO REENVIO</th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">IDENTIFICACION MENSAJERO ENTREGA</th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">PESO VOLUMEN (KG)</th>
            ...
            <th class="borderTop borderRight borderLeft borderBottom">PLACA</th>
    ...
    <table align="left"  width="90%" id="transito_display">
        ...
        <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
            ...
            <td class="borderTop borderRight borderLeft borderBottom">{$i.tipo_guia}</td>
            ...
            <td class="borderTop borderRight borderLeft borderBottom">{$i.proceso}</td>
            <td class="borderTop borderRight borderLeft borderBottom">{$i.pedido}</td>
            <td class="borderTop borderRight borderLeft borderBottom">{$i.unidad}</td>
            ...
            <td class="borderTop borderRight borderLeft borderBottom">{if $i.mensajero_devuelve_doc eq ''}N/A {else}{$i.mensajero_devuelve_doc}{/if}</td>
            ...
            <td class="borderTop borderRight borderLeft borderBottom">{if $i.mensajero_reenvio_doc eq ''}N/A {else}{$i.mensajero_reenvio_doc}{/if}</td>
            ...
            <td class="borderTop borderRight borderLeft borderBottom">{if $i.mensajero_entrega_doc eq ''}N/A {else}{$i.mensajero_entrega_doc}{/if}</td>
            ...
            <td class="borderTop borderRight borderLeft borderBottom" align="center">{$i.peso_volumen}</td>

            <td class="borderTop borderRight borderLeft borderBottom">{$i.cantidad}</td>
            <td class="borderTop borderRight borderLeft borderBottom" align="right">{$i.valor_flete|number_format:0:",":"."}</td>  
            <td class="borderTop borderRight borderLeft borderBottom" align="right">{$i.valor_seguro|number_format:0:",":"."}</td>  
            <td class="borderTop borderRight borderLeft borderBottom" align="right">{$i.valor_otros|number_format:0:",":"."}</td>  
            <td class="borderTop borderRight borderLeft borderBottom" align="right">{$i.valor_descuento|number_format:0:",":"."}</td>  
            <td class="borderTop borderRight borderLeft borderBottom" align="right">{$i.valor_total|number_format:0:",":"."}</td>  
            ...
            <td class="borderTop borderRight borderLeft borderBottom">{$i.placa}</td>
            <td class="borderTop borderRight borderLeft borderBottom">{$i.interno}</td>
