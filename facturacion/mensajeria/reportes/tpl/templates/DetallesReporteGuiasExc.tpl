...
<table align="center" id="encabezado"  width="90%">
  <tr>
    ...
    <th class="borderTop borderRight">HORA AFORO</th>
    ...
    <th class="borderTop borderRight">FECHA CARGUE 1</th>            
    <th class="borderTop borderRight">NO. MANIFIESTO 1</th>
    <th class="borderTop borderRight">FECHA CARGUE 2</th>            
    <th class="borderTop borderRight">NO. MANIFIESTO 2</th>
    <th class="borderTop borderRight">FECHA CARGUE 3</th>            
    <th class="borderTop borderRight">NO. MANIFIESTO 3</th>            
    ...
    <th class="borderTop borderRight">COD. POSTAL</th>            
    <th class="borderTop borderRight">FECHA OFICINA</th>
    <th class="borderTop borderRight">HORA OFICINA</th>            
    <th class="borderTop borderRight">FECHA DE ENTREGA</th>
    <th class="borderTop borderRight">HORA DE ENTREGA</th>            
...
<tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
    ...
    <td class="borderTop borderRight">{$i.hora_guia}</td> 
    ...
    <td class="borderTop borderRight">{$i.manifiesto1}</td>
    <td class="borderTop borderRight">{$i.fecha_rxp2}</td>            
    <td class="borderTop borderRight">{$i.manifiesto2}</td>
    <td class="borderTop borderRight">{$i.fecha_rxp2}</td>            
    <td class="borderTop borderRight">{$i.manifiesto2}</td>            
    ...
    <td class="borderTop borderRight">{$i.codigo_postal}</td>   

    <td class="borderTop borderRight">{$i.fecha_entrega_oficina}</td>   
    <td class="borderTop borderRight">{$i.hora_entrega_oficina}</td>   
    <td class="borderTop borderRight">{$i.fecha_entrega}</td>
    <td class="borderTop borderRight">{$i.hora_entrega}</td>
    ...
    <td class="borderTop borderRight">{$i.valor_descuento}</td> 
