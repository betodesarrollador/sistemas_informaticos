  ...
  <body>
	<fieldset>
        ...
        <table>
		  ...
		  <tr>
            <td width="229" ><label>Documento Contable Descuentos:</label></td>
            <td width="264" colspan="3">{$DOCUMENTOCONTABLEDESCU}</td>
          </tr>  
          <tr>
            <td width="229" ><label>Documento Contable Sobrefletes:</label></td>
            <td width="264" colspan="3">{$DOCUMENTOCONTABLESOBRE}</td>
          </tr> 
         </table>		 
		 </fieldset>		 		 		  
