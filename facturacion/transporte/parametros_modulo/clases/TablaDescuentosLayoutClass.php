...
final class TablaDescuentosLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $this -> TplInclude -> IncludeCss("../../../transporte/parametros_modulo/css/TablaDescuentos.css");	 
	 
//     $this -> TplInclude -> IncludeCss("../../../seguimiento/parametros_modulo/css/TablaDescuentos.css");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/parametros_modulo/js/TablaDescuentos.js");
...
//     $this -> assign("TIPO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_descuento]));
     ...
     $this -> assign("DESCUENTOANTICIPOS",			$this -> objectsHtml -> GetobjectHtml($this -> fields[descuento_anticipos]));
