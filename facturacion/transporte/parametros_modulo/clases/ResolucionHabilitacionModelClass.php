...
final class ResolucionHabilitacionModel extends Db{
  ...
  public function Save($Campos,$Conex){
    $this -> DbInsertTable("resolucion_habilitacion",$Campos,$Conex,true,false);
  }

  public function Update($Campos,$Conex){
    $this -> DbUpdateTable("resolucion_habilitacion",$Campos,$Conex,true,false);

  }

  public function Delete($Campos,$Conex){
  	$this -> DbDeleteTable("resolucion_habilitacion",$Campos,$Conex,true,false);
  }
  ...
  public function selectResolucionHabilitacionModel($Conex){
	  ...
	  $select          = "SELECT * FROM resolucion_habilitacion WHERE habilitacion_id =   
	                      $habilitacion_id";
...
//// GRID ////
  public function getQueryResolucionHabilitacionGrid(){
     ...
     $Query = "SELECT 
				...
				AS regional,
				codigo_empresa
	 			FROM resolucion_habilitacion r";
