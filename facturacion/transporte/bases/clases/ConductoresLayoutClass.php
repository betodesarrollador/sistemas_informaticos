...
final class ConductoresLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $this -> TplInclude -> IncludeCss("../../../transporte/bases/css/Conductores.css");
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/bases/js/Conductores.js");
	 ...
	 $this -> assign("ANIOSEXPERIENCIA",	        $this -> getObjectHtml($this -> fields[anios_experiencia]));
	 $this -> assign("DEUDACOMPARENDOS",	        $this -> getObjectHtml($this -> fields[deuda_comparendos]));
	 $this -> assign("ACUERDOPAGO",	              $this -> getObjectHtml($this -> fields[acuerdo_pago]));
     ...
     $this -> assign("EXPEDICIONLICENCIA",	    $this -> getObjectHtml($this -> fields[fecha_expedicion_licencia]));
     ...
     $this -> assign("FECHAINGRESO",		        $this -> getObjectHtml($this -> fields[fecha_ingreso]));
	   ...
	   $this -> assign("CARNETMANIPULACIONALIMENTOS",	$this -> objectsHtml -> GetobjectHtml($this -> fields[carnet_manipulacion_alimentos]));	
