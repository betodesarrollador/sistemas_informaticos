  ...
  protected function onclickValidateRow(){
	...
	protected function onclickSave(){
		...
		if(strlen($telefono) < 7 ){
			...
			if($Model -> remitenteExiste($nombre,$cliente_id,$ubicacion_id,$numero_identificacion,$this -> getConex())){
				exit("Ya existe un remitente con esta ciudad para el cliente !!");
			}else{
