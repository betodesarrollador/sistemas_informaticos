...
final class Conductores extends Controler{
  ...
  protected function setCampos(){
	...
	$this -> Campos[anios_experiencia]  = array(
	...
	$this -> Campos[deuda_comparendos] = array(
		name	=>'deuda_comparendos',
		id	=>'deuda_comparendos',
		type	=>'text',
		required=>'yes',
		datatype=>array(
			type  	  =>'numeric',
	...
	$this -> Campos[acuerdo_pago] = array(
		name	 =>'acuerdo_pago',
		id		 =>'acuerdo_pago',
		type	 =>'select',
		required =>'yes',
		options	 =>array(array(value => 'SI',text => 'SI'),array(value => 'NO', text => 'NO')),
        selected => 'SI',		
	...
	$this -> Campos[fecha_expedicion_licencia]  = array(
...
// 	
	...
	$this -> Campos[seguridad_social] = array(
		...
		type	=>'file',
		value	=>'',
		path	=>'../../../imagenes/transporte/conductores/seguridad_social/',
		size	=>'70',	
		datatype=>array(
			type	=>'file'),
	 	transaction=>array(
	...
	$this -> Campos[venc_seguridad_social] = array(
 	...
 	$this -> Campos[foto] = array(
		...
		type	=>'file',
		value	=>'',
		path	=>'../../../imagenes/transporte/conductores/',
		size	=>'70',
//		required=>'yes',		
		datatype=>array(
			type	=>'file'),
...
//		required=>'yes',			
	...
	$this -> Campos[carnet_manipulacion_alimentos] = array(
		name	=>'carnet_manipulacion_alimentos',
		id		=>'carnet_manipulacion_alimentos',
		type	=>'text',
		value	=>'',
		//required=>'yes',
		datatype=>array(
