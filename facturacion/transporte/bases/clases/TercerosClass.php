...
final class Tercero extends Controler{
  ...
  public function Main(){
	...
	$Cols = array(
	  ...
	  array(name=>'sigla',					index=>'sigla',					sorttype=>'text',	width=>'150',	align=>'center'),
  	  ...
  	  array(name=>'regimen',				index=>'regimen',				sorttype=>'text',	width=>'150',	align=>'center'),
   	  array(name=>'aprobacion_ministerio',	index=>'aprobacion_ministerio',	sorttype=>'text',	width=>'150',	align=>'center'),
	...
	$Layout -> SetGridTerceros($Attributes,$Titles,$Cols,$Model -> getQueryTercerosGrid());
	$Layout -> RenderMain();
  ...
  protected function sendPropietarioMintransporte(){
    ...
    $webService -> sendPropietarioMintransporte($data);	  
...
//BUSQUEDA
  ...
  protected function setCampos(){
	...
	$this -> Campos[propietario_vehiculo] = array(
