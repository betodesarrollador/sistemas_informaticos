...
final class ConductoresModel extends Db{
  ...
  public function Save($usuario_id,$oficina_id,$Campos,$Conex){
	...
	$insert = "INSERT INTO tercero (tercero_id,ubicacion_id,tipo_persona_id,tipo_identificacion_id,numero_identificacion,digito_verificacion,primer_apellido,segundo_apellido, primer_nombre,segundo_nombre,razon_social,sigla,telefono,movil,direccion,tipo_cta_id,numcuenta_proveedor,banco_id) 
	  ...
	  $primer_nombre,$segundo_nombre,$razon_social,$sigla,$telefono,$movil,$direccion,$tipo_cta_id,$numcuenta_proveedor,$banco_id)"; 
  ...
  public function GetTipoCuenta($Conex){
	return $this -> DbFetchAll("SELECT tipo_cta_id AS value,nombre_tipo_cuenta AS text FROM tipo_cuenta ORDER BY nombre_tipo_cuenta ASC",$Conex,
	$ErrDb = false);
   }
...
//BUSQUEDA
  public function selectConductoresporId($Id,$Conex){
   ...
   $select = "SELECT 
					...
					c.deuda_comparendos,
					c.acuerdo_pago,
					c.carnet_manipulacion_alimentos,
					c.fecha_expedicion_licencia,
