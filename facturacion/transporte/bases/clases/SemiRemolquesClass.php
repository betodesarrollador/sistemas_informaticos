  ...
  protected function onclickSave(){
    ...
    if($unidad_capacidad_carga == 1){
      ...
      if($peso_maximo > 0 && $peso_capacidad > $peso_maximo){	
	   exit("<div align='center'>El Peso Vac�o + la Capacidad de carga de un cami�n rigido, no puede sobrepasar el l�mite permitido<br>Limite para la configuracion seleccionada : $peso_maximo</div>");	
	  }
	  
	}else{
	
        if($galones_minimo > 0 && $peso_capacidad < $galones_minimo){	
	     exit("<div align='center'>El Peso Vac�o + la Capacidad de carga de un cami�n rigido, no puede ser inferior al l�mite permitido<br><br>Galones Minimo : $galones_minimo</div>");	
	    }	   
		
        if($galones_maximo > 0 && $peso_capacidad > $galones_maximo){	
	     exit("<div align='center'>El Peso Vac�o + la Capacidad de carga de un cami�n rigido, no puede ser sobrepasar al l�mite permitido<br><br>Galones Maximo : $galones_maximo</div>");	
	    }	   		
  ...
  protected function setCampos(){
	...
	$this -> Campos[unidad_capacidad_carga] = array(
 	...
 	$this -> Campos[archivo_imagen_lateral] = array(
		...
		type	=>'file',
		value	=>'',
		path	=>'../../../imagenes/transporte/semiremolques/',
		size	=>'70',
		datatype=>array(
			type	=>'file'),
	 	transaction=>array(
