...
function setDataFormWithResponse() {
	...
	FindRow(parametros, forma, controlador, null, function (resp) {
		...
		var url = "RutasEspecialesClass.php?tercero_id=" + tercero_id + "&rand=" + Math.random();
		$("#rutasespeciales").attr("src", url);
		...
		$("#codigo_ciiu").addClass("obligatorio");
...
function ClienteOnUpdate(formulario, resp) {
	...
	if (resp == 'true' || resp === true || !isNaN(resp)) {
		...
		$("#legal,#tributaria,#operativas,#financiera,#tarifas,#comercial").css("display", "");
		$("#comercial_hidden,#comercial,#codigo_ciiu").addClass("obligatorio");
...
function ClienteonDelete(formulario, resp) {
	...
	$("#comercial_hidden,#comercial,#codigo_ciiu").removeClass("obligatorio");
...
function buscarClinton() {
	...
	var formulario = document.getElementById('ClientesForm');
	var cliente_id = $("#cliente_id").val();
	var QueryString = "ACTIONCONTROLER=validarClinton&documento=" + documento + "&cliente_id=" + cliente_id;
