...
function OnclickGenerar(formulario){
	...
	if(ValidaRequeridos(formulario)){
		 var QueryString = "DetallesEdadesClass.php?"+FormSerialize(formulario);
...
function descargarexcel(formulario){
	...
	if(ValidaRequeridos(formulario)){
		 var QueryString = "DetallesEdadesClass.php?download=true&"+FormSerialize(formulario);
		 $("#frameReporte").attr("src",QueryString);
...
/* $("#generar_excel").click(function(){
     ...
     if(ValidaRequeridos(formulario)){
	   ...
	   var vehiculo_id   = $("#vehiculo_id").val();	
	    var all_documento   = $("#all_documento").val();	
		 var estado   = $("#estado").val();	
	   
       var QueryString = "reporteEdadesClass.php?ACTIONCONTROLER=generateFileexcel&desde="+desde+"&hasta="+hasta+"&oficina_id="+oficina_id+
	                     "&si_tenedor="+si_tenedor+"&all_oficina="+all_oficina+"&tenedor_id="+tenedor_id+"&tipo="+tipo+"&all_documento="+all_documento+"&estado="+estado+
