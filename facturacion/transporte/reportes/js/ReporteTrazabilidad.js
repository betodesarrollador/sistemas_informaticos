...
function all_traza(){
	...
	function OnclickGenerar(formulario){
		if(ValidaRequeridos(formulario)){
			var QueryString = "reporteTrazabilidadClass.php?ACTIONCONTROLER=OnclickGenerar&"+FormSerialize(formulario);
	...
	function descargarexcel(formulario){
		if(ValidaRequeridos(formulario)){
			var QueryString = "reporteTrazabilidadClass.php?ACTIONCONTROLER=onclickGenerar&download=true&"+FormSerialize(formulario);
			$("#frameReporte").attr("src",QueryString);
		}
	}
