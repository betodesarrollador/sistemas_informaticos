        ...
        <table align="center" width="90%">
            ...
            <tr>
                <td valign="top">
                    ...
                    <br/><br/>
                    <label>Con corte</label><br/>
					{$CONCORTE} 
                </td>
                <td valign="top">
                	{$SI_VEH}<br />{$VEHICULO}{$VEHICULOID}
				</td>
                <td valign="top">
                	{$SI_TEN}<br />{$TENEDOR}{$TENEDORID}<br/><br/>
                    <label>Tipo Reporte</label><br/>{$ESTADO}
                </td>
                <td valign="top"><label>Todos</label>{$ALLOFFICE}<br/>{$OFICINA}</td>
                <td valign="top"><label>Todos</label>{$ALLDOCUMENTO}<br/>{$TIPO}</td>
            </tr>
			<tr>
            	<td colspan="5">&nbsp;</td>
            </tr>
                ...
                <td colspan="5" align="center">
                    <table width="100%">
                        <tr>
                            ...
                            <td width="50%" align="center">{$GENERAR}{$DESCARGAR}{$IMPRIMIR} <input type="button" name="generar_excel" id="generar_excel" value="Generar Archivo Excel>>" /></td>
                            <td width="20%"></td>
                        </tr>
                    </table>
                </td>
