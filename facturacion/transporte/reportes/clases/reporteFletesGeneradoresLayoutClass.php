...
final class reporteFletesGeneradoresLayout extends View{
  ...
  $this -> Imprimir = $Permiso;
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reporteFletesGeneradoresClass.php","reporteFletesGeneradores","reporteFletesGeneradores");
     $Form2 = new Form("reporteFletesGeneradoresClass.php","reporteFletesGeneradoresResultado","reporteFletesGeneradoresResultado");
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/reportes/js/reporteFletesGeneradores.js"); 
...
//LISTA MENU
   ...
   //  }
    ...
    public function RenderMain(){   
     $this -> RenderLayout('reporteFletesGeneradores.tpl');	 
    }   
}
