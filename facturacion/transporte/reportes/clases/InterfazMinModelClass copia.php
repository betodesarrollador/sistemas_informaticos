...
final class InterfazMinModel extends Db{
  ...
  public function selectAnticiposRangoFecha($desde,$hasta,$tipo,$Conex){
		...
		IF(t.telefono!='',t.telefono,'8233977') AS pertelefono, 
		IF(t.direccion!='',t.direccion,'Km. 5.2 vis Siberia – Funza. Vereda El Cacique') AS perdireccion, 
		...
		IF(t.telefono!='',t.telefono,'8233977') AS emptelefono, 
		IF(t.direccion!='',t.direccion,'Km. 5.2 vis Siberia – Funza. Vereda El Cacique') AS empdireccion, 
		...
		m.manifiesto AS mannumero, 
		m.fecha_mc AS manfechexped,
		m.origen_id	 AS manciud_origen, 
		m.destino_id AS manciud_destin, 
		m.placa AS manplaca, 
		(SELECT codigo_ministerio FROM tipo_identificacion WHERE codigo = m.tipo_identificacion_conductor_codigo OR codigo_ministerio = m.tipo_identificacion_conductor_codigo) AS mantipidconduc,
		...
		FROM  tercero t, manifiesto m, oficina o, empresa e, ubicacion u, tipo_manifiesto tm, causal_anulacion ca
		...
		IF((SELECT fecha_llegada_lugar_cargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT fecha_llegada_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT fecha_llegada_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT hora_llegada_lugar_cargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT hora_llegada_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT hora_llegada_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT fecha_salida_lugar_cargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT fecha_salida_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT fecha_salida_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT hora_salida_lugar_cargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT hora_salida_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT hora_salida_cargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT fecha_llegada_lugar_descargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT fecha_llegada_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT fecha_llegada_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT hora_llegada_lugar_descargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT hora_llegada_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT hora_llegada_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT fecha_salida_lugar_descargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT fecha_salida_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT fecha_salida_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
		...
		IF((SELECT hora_salida_lugar_descargue  FROM hoja_de_tiempos WHERE remesa_id=r.remesa_id) IS NOT NULL,
			...
			IF((SELECT hora_salida_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id) !='',
				(SELECT hora_salida_descargue FROM tiempos_clientes_remesas WHERE manifiesto_id=m.manifiesto_id), 
				TIME(ADDTIME(CONCAT_WS(' ',m.fecha_entrega_mcia_mc,m.hora_entrega),'02:00:00'))    )) AS Remhorafindescargue 
		
		FROM  manifiesto m, detalle_despacho dd, remesa r
