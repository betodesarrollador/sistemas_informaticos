...
final class reporteAnticipos extends Controler{
  ...
  protected function setCampos(){    
	...
	$this -> Campos[estado] = array(
		...
		id		=>'estado',
		type	=>'select',
		options	=>array(0=>array('value'=>'P','text'=>'Anticipos Pendientes'),1=>array('value'=>'ALL','text'=>'Relacion Anticipos'),2=>array('value'=>'CE','text'=>'Anticipos Por Edades')),
		selected=>0,
		required=>'yes'
	);
