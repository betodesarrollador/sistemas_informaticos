...
final class reporteEdadesLayout extends View{
   ...
   public function setCampos($campos){
     ...
     $Form1 = new Form("reporteEdadesClass.php","reporteAnticiposForm","reporteAnticiposForm");
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/reportes/js/ReporteEdades.js"); 
	 ...
	 $this -> assign("ALLDOCUMENTO",	 $this -> objectsHtml -> GetobjectHtml($this -> fields[all_documento]));
	  ...
	  $this -> assign("EXCEL",		 	 $this -> objectsHtml -> GetobjectHtml($this -> fields[descargar]));	
...
//LISTA MENU
   ...
   public function RenderMain(){   
     $this -> RenderLayout('ReporteEdades.tpl');	 
   }
}
