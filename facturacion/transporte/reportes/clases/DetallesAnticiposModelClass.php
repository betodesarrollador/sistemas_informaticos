...
final class DetallesAnticiposModel extends Db{
  ...
  public function getReporteMCE1DUE1APE1($tipo,$oficina_id,$desde,$hasta,$estadomc,$estadodu,$estadoap,$cons_vehm,$cons_vehd,$cons_veha,$cons_tenm,$cons_tend,$cons_tena,$cons_cor,$cons_cor1,$Conex){ 
	...
	$select_mc = "SELECT 'MC' AS tipo_documento,m.manifiesto AS numero_documento, m.tenedor_id,		
		...
		am.tenedor AS tenedor, am.conductor AS conductor, (SELECT t.numero_identificacion FROM tercero t, tenedor te WHERE t.tercero_id = te.tercero_id AND te.tenedor_id = am.tenedor_id) AS numero_identificacion_tenedor, am.valor AS valor,
		...
		(SELECT IF(SUM(dl.valor)IS NOT NULL,SUM(dl.valor),0) FROM detalle_liquidacion_despacho dl, liquidacion_despacho l WHERE dl.detalle_liquidacion_despacho_id=am.detalle_liquidacion_despacho_id AND l.liquidacion_despacho_id=dl.liquidacion_despacho_id AND l.estado_liquidacion='C' $cons_cor) AS abono,		
		(SELECT IF(SUM(ra.rel_valor_abono_anticipo)IS NOT NULL,SUM(ra.rel_valor_abono_anticipo),0) FROM relacion_anticipos_abono ra, abono_factura_proveedor af WHERE ra.anticipos_manifiesto_id=am.anticipos_manifiesto_id AND af.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND af.estado_abono_factura='C' $cons_cor1) AS abono1,
		
		(am.valor-((SELECT IF(dl.valor >0,dl.valor,0) FROM detalle_liquidacion_despacho dl, liquidacion_despacho l WHERE dl.detalle_liquidacion_despacho_id=am.detalle_liquidacion_despacho_id AND l.liquidacion_despacho_id=dl.liquidacion_despacho_id AND l.estado_liquidacion='C'))) as condi		
		...
		AND (SELECT estado FROM encabezado_de_registro WHERE encabezado_registro_id=am.encabezado_registro_id)='C' AND m.manifiesto_id = am.manifiesto_id 
...
//echo $select_mc;
	  ...
	  $select_du = "SELECT 'DU' AS tipo_documento,du.despacho AS numero_documento, du.tenedor_id,
		...
		(SELECT IF(SUM(dl.valor)IS NOT NULL,SUM(dl.valor),0) FROM detalle_liquidacion_despacho dl, liquidacion_despacho l WHERE dl.detalle_liquidacion_despacho_id=adu.detalle_liquidacion_despacho_id AND l.liquidacion_despacho_id=dl.liquidacion_despacho_id AND l.estado_liquidacion='C' $cons_cor) AS abono,		
		
		
		(SELECT IF(SUM(ra.rel_valor_abono_anticipo) IS NOT NULL,SUM(ra.rel_valor_abono_anticipo),0) FROM relacion_anticipos_abono ra, abono_factura_proveedor af WHERE ra.anticipos_despacho_id=adu.anticipos_despacho_id AND af.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND af.estado_abono_factura='C' $cons_cor1) AS abono1	,
	    ...
	    AND adu.fecha_egreso BETWEEN '$desde' AND '$hasta' $cons_vehd $cons_tend ORDER BY du.tenedor_id ASC, adu.fecha_egreso ASC";
/*AND (adu.valor-((SELECT IF(SUM(dl.valor)IS NOT NULL,SUM(dl.valor),0) FROM detalle_liquidacion_despacho dl, liquidacion_despacho l WHERE dl.detalle_liquidacion_despacho_id=adu.detalle_liquidacion_despacho_id AND l.liquidacion_despacho_id=dl.liquidacion_despacho_id AND l.estado_liquidacion='C') + (SELECT IF(SUM(anm.valor)IS NOT NULL , SUM(anm.valor),0) FROM anticipos_despacho anm WHERE anm.sub_anticipos_despacho_id=adu.anticipos_despacho_id AND anm.devolucion=1 AND anm.encabezado_registro_id IS NOT NULL AND anm.estado!='A' ) + (SELECT IF(SUM(ra.rel_valor_abono_anticipo)>0,SUM(ra.rel_valor_abono_anticipo),0) FROM relacion_anticipos_abono ra, abono_factura_proveedor af WHERE ra.anticipos_despacho_id=adu.anticipos_despacho_id AND af.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND af.estado_abono_factura='C')))>0
 	 ...
 	 $select_ap = "SELECT 'AP' AS tipo_documento, ap.consecutivo AS numero_documento, ap.tenedor_id,
		...
		((SELECT IF(SUM(ra.rel_valor_abono_anticipo)IS NOT NULL,SUM(ra.rel_valor_abono_anticipo),0)as valor FROM relacion_anticipos_abono ra, abono_factura_proveedor af WHERE ra.anticipos_placa_id=ap.anticipos_placa_id AND af.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND af.estado_abono_factura='C' $cons_cor1)) AS abono,
  ...
  public function getReporteTOTAL($tipo,$oficina_id,$desde,$hasta,$estadomc,$estadodu,$estadoap,$cons_vehm,$cons_vehd,$cons_veha,$cons_tenm,$cons_tend,$cons_tena,$cons_cor,$cons_cor1,$Conex){ 
	...
	$select_mc = "SELECT 'MC' AS tipo_documento,m.manifiesto AS numero_documento, m.tenedor_id,		
		...
		FROM anticipos_manifiesto am ,manifiesto m WHERE am.estado!='L' AND  am.devolucion=0 AND (am.valor-(SELECT SUM(valor) FROM anticipos_manifiesto WHERE sub_anticipos_manifiesto_id = am.anticipos_manifiesto_id))>0 AND am.oficina_id IN ($oficina_id) AND m.manifiesto_id = am.manifiesto_id 
 	 ...
 	 $select_ap = "SELECT 'AP' AS tipo_documento, ap.consecutivo AS numero_documento, ap.tenedor_id,
		...
		(SELECT SUM(ra.rel_valor_abono_anticipo) FROM relacion_anticipos_abono ra, abono_factura_proveedor af WHERE ra.anticipos_placa_id=ap.anticipos_placa_id AND af.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND af.estado_abono_factura='C' $cons_cor1) AS abono,		
		(SELECT SUM(ra.rel_valor_abono_anticipo) FROM relacion_anticipos_abono ra, abono_factura_proveedor af WHERE ra.anticipos_placa_id=ap.anticipos_placa_id AND af.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND af.estado_abono_factura='C' $cons_cor1) AS abono1		
