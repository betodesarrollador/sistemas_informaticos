...
$(document).ready(function(){
  ...
  setValorLiquidacionDescu();
	...
	$("input[id=fecha_llegada_descargue],input[id=fecha_entrada_descargue],input[id=fecha_salida_descargue]" ).datepicker({
		dateFormat : "yy-mm-dd",
			showOn: "button",
			buttonImage: "/rotterdan_test/framework/media/images/calendar/calendar.gif",
...
function setDataFormWithResponse(liquidacion_despacho_descu_id){
	...
	$.ajax({
	  url        : "LiquidacionDescuClass.php?rand="+Math.random(),
	  data       : QueryString,
	  beforeSend : function(){
		  showDivLoading();
	  },
      success    : function(resp){
		...
		try{
		 ...
		 var Tabla           = document.getElementById('tableLiquidacionDescu');
...
function LiquidacionDescuManifiestoOnSaveOnUpdateonDelete(formulario,resp){

   LiquidacionDescuManifiestoOnReset(formulario);
...
function LiquidacionDescuManifiestoOnReset(formulario){
			 ...
			 success    : function(resp){
			   ...
			   try{
				 ...
				 removeDivLoading();
				  ...
				  QueryString  = "ACTIONCONTROLER=getLiquidacionDescuManifiesto&manifiesto_id="+manifiesto_id;
					...
					success    : function(resp){
					  ...
					  try{
						 ...
						 if($.trim(resp).length == 0 || resp == 'null'){
							...
							alertJquery("<p align='center'>Este manifiesto no tiene anticipos !! <br> No se puede legalizar</p>","Validacion LiquidacionDescu"); 
							Reset(formulario);
							return true;
...
function onclickSave(objId,formulario){
	  ...
	  var QueryString       = '';	
	  var tableLiquidacionDescu  = document.getElementById('tableLiquidacionDescu');
	  ...
	  QueryString = 'manifiesto_id='+manifiesto_id+'&manifiesto='+manifiesto+'&liquidacion_despacho_descu_id='+liquidacion_despacho_descu_id+'&encabezado_registro_id='+encabezado_registro_id
		  ...
		  $.ajax({
			  ...
			  beforeSend : function(){
				...
				success  : function(resp){				
					...
					if(!isNaN(liquidacion_despacho_descu_id)){
						//alert("LIQUIDACION IF");  
						
						$("#refresh_QUERYGRID_LiquidacionDescuManifiestos").click();	
						
						var url = "LiquidacionDescuClass.php?ACTIONCONTROLER=onclickPrint&liquidacion_despacho_descu_id="+liquidacion_despacho_descu_id+"&rand="+Math.random();
						...
						alertJquery("Liquidacion",resp);
				  }		 
				 removeDivLoading();	
                 LiquidacionDescuManifiestoOnSaveOnUpdateonDelete(formulario);				 
		     }
...
function onclickUpdate(objId,formulario){
	  ...
	  +'&diferencia='+diferencia+'&usuario_id='+usuario_id+'&elaboro='+elaboro+'&concepto='+concepto+'&valor_descuentos='+valor_descuentos+'&observaciones='+observaciones
	  +'&cantidad_galon='+cantidad_galon+'&cantidad_peso='+cantidad_peso+'&cantidad_volu='+cantidad_volu+'&valor_galon='+valor_galon+'&oficina_id='+oficina_id
  	  +'&detalle_liquidacion_valor_flete_id='+detalle_liquidacion_valor_flete_id+'&detalle_liquidacion_valor_sobre_flete_id='+detalle_liquidacion_valor_sobre_flete_id
	  +'&detalle_liquidacion_saldo_por_pagar_id='+detalle_liquidacion_saldo_por_pagar_id;	  
