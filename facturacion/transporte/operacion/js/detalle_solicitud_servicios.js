...
function saveDetalleSolicitud(obj){
	...
	if(validaRequeridosDetalle(obj,row)){
	  ...
	  var  valores_complementarios  = $(Fila).find("input[name=valores_complementarios]").val();	  	
	  var  descrip_val_comp        = $(Fila).find("input[name=descrip_val_comp]").val();	  	
...
function autocompleteProducto(){
	...
	$("input[name=descripcion_producto]").autocomplete("../../../framework/clases/ListaInteligente.php?consulta=producto", {
		width: 260,
		selectFirst: true
	});
	
	$("input[name=descripcion_producto]").result(function(event, data, formatted) {
...
function autocompleteRemitente(){
	...
	$("input[name=remitente]").autocomplete("../../../framework/clases/ListaInteligente.php?consulta=remitente", {
		width      : 260,
		selectFirst: true
	});
	...
	$("input[name=remitente]").result(function(event, data, formatted) {
       ...
       if (data){
           ...
           $.ajax({
			 url        : "DetalleSolicitudServiciosClass.php?rand="+Math.random(),
			 data       : QueryString,
			 beforeSend : function(){
				 showDivLoading();
			 },
...
function autocompleteDestinatario(){
	...
	$("input[name=destinatario]").autocomplete("../../../framework/clases/ListaInteligente.php?consulta=destinatario", {
		width: 260,
		selectFirst: true
	});
