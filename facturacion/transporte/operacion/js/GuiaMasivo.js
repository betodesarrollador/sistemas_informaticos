...
function setDetalleGuiaMasivo(){
  ...
  var solicitud_id = document.getElementById('solicitud_hidden').value;
  var form = this.form;
  

      
    var QueryString = "ACTIONCONTROLER=setDetalleGuiaMasivo&cliente_id="+cliente_id+"&solicitud_id="+solicitud_id;
    ...
    $.ajax({
      ...
      success    : function(resp){
		...
		alertJquery(resp,"Remesa por lotes");  
