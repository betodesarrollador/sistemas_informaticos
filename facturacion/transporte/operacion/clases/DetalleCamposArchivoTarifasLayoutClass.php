...
final class DetalleCamposArchivoTarifasLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("../../../transporte/operacion/css/DetalleCamposArchivoTarifas.css");     
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/DetalleCamposArchivoTarifas.js");
