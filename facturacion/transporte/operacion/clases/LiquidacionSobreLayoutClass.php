...
final class LiquidacionSobreLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("LiquidacionSobreClass.php","LiquidacionSobreForm","LiquidacionSobreForm");
	 ...
	 $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/liquidacionSobre.js");
   ...
   public function RenderMain(){
	 $this ->RenderLayout('liquidacionSobre.tpl');
   }
