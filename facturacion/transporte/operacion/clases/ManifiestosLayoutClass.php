...
final class ManifiestosLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("ManifiestosClass.php","ManifiestosForm","ManifiestosForm");
	 $Form2 = new Form("ManifiestosClass.php","ManifiestosLiquidacionForm","ManifiestosLiquidacionForm");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/Manifiestos.js");
     ...
     $this -> assign("FECHAMANIFIESTO",	$this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_mc]));
	 ...
	 $this -> assign("REPORTADOMIN",	$this -> objectsHtml -> GetobjectHtml($this -> fields[aprobacion_ministerio2]));
	 $this -> assign("REPORTADOCUMMIN",	$this -> objectsHtml -> GetobjectHtml($this -> fields[aprobacion_ministerio3]));
     ...
     $this -> assign("CONTENEDOR",		$this -> objectsHtml -> GetobjectHtml($this -> fields[numero_contenedor]));	 	 	 	 	 	 	 	 
     ...
     $this -> assign("TITULARID",$this -> objectsHtml -> GetobjectHtml($this -> fields[titular_manifiesto_id]));	 
     $this -> assign("TITULAR",	$this -> objectsHtml -> GetobjectHtml($this -> fields[titular_manifiesto]));	 
     $this -> assign("NUMEROIDENTIFICACIONTITULAR",$this->objectsHtml->GetobjectHtml($this-> fields[numero_identificacion_titular_manifiesto])); 
     $this -> assign("DIRECCIONTITULAR",$this -> objectsHtml -> GetobjectHtml($this -> fields[direccion_titular_manifiesto]));	 
     $this -> assign("TELEFONOTITULAR",$this -> objectsHtml -> GetobjectHtml($this -> fields[telefono_titular_manifiesto]));	      
     $this -> assign("CIUDADTITULAR",	$this -> objectsHtml -> GetobjectHtml($this -> fields[ciudad_titular_manifiesto]));	      
     $this -> assign("CIUDADTITULARDIVIPOLA",$this -> objectsHtml -> GetobjectHtml($this -> fields[ciudad_titular_manifiesto_divipola]));     
     ...
     $this -> assign("NUMEROIDENTIFICACIONCONDUCTORCODIGO",$this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_identificacion_conductor_codigo]));	 	 	 
     ...
     $this -> assign("STIKER",		                  $this -> objectsHtml -> GetobjectHtml($this -> fields[stiker]));	     	 
     ...
     $this -> assign("FOTOPRECINTONORMAL",		      $this -> objectsHtml -> GetobjectHtml($this -> fields[foto_precinto_normal]));	 	 	 	 	     
	 $this -> assign("FOTOAMARRES",		              $this -> objectsHtml -> GetobjectHtml($this -> fields[foto_amarres]));	 	 	 	 	 	 	 	 	 	 	 	 	 			
     $this -> assign("CLIENTE",		                  $this -> objectsHtml -> GetobjectHtml($this -> fields[cliente]));	 	 	 	 	 	 		
	 ...
	 $this -> assign("FECHAPAGOSALDO",		          $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_pago_saldo]));	 	 	 	 	 	 	 
	 $this -> assign("LUGARPAGOSALDO",		          $this -> objectsHtml -> GetobjectHtml($this -> fields[lugar_pago_saldo]));	 	 	 	 	 		 	 
...
//LISTA MENU
   ...
   public function SetTiposManifiesto($TiposManifiesto){
     $this -> fields[tipo_manifiesto_id][options] = $TiposManifiesto;
	 $this -> assign("TIPOMANIFIESTO",$this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_manifiesto_id]));
   }
...
//// GRID ////
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('Manifiestos.tpl');
