...
final class Imp_Documento{
  ...
  public function printOut(){
	  ...
	  $pdf->Cell(90,5,utf8_decode($encabezado[0]['razon_social'].' '.$encabezado[0]['primer_nombre'].' '.$encabezado[0]['segundo_nombre'].' '.$encabezado[0]['primer_apellido'].' '.$encabezado[0]['segundo_apellido']),1,0,'L');	
	  ...
	  $pdf->Cell(60,5,$encabezado[0]['observaciones'],1,0,'L');		  
