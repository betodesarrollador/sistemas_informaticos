...
final class LegalizacionLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("LegalizacionClass.php","LegalizacionForm","LegalizacionForm");
	 ...
	 $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/legalizacion.js");
	 ...
	 $this -> assign("LEGALIZACIONID",$this -> objectsHtml -> GetobjectHtml($this -> fields[legalizacion_manifiesto_id]));		 	 
   ...
   public function RenderMain(){
	 $this ->RenderLayout('legalizacion.tpl');
   }
