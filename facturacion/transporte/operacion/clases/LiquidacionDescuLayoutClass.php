...
final class LiquidacionDescuLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("LiquidacionDescuClass.php","LiquidacionDescuForm","LiquidacionDescuForm");
	 ...
	 $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/liquidacionDescu.js");
   ...
   public function RenderMain(){
	 $this ->RenderLayout('liquidacionDescu.tpl');
   }
