...
final class RemesasMasivoLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("RemesasMasivoClass.php","RemesasMasivoForm","RemesasMasivoForm");
     ...
     $this -> TplInclude -> IncludeCss("../../../transporte/operacion/css/RemesasMasivo.css");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/RemesasMasivo.js");	 
     ...
     $this -> assign("DETALLESSID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[detalle_ss_id]));	 	 
	 ...
	 $this -> assign("REMESASIMP",        $this -> objectsHtml -> GetobjectHtml($this -> fields[remesas]));
	 ...
	 $this -> assign("FECHAREMESACREA",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_remesa_crea]));
...
/*     $this -> assign("HOJATIEMPOSID",	        $this -> objectsHtml -> GetobjectHtml($this -> fields[hoja_de_tiempos_id]));
	...
	*/ 
	$this -> assign("APROBACIONMANIFIESTO",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[aprobacion_ministerio_man2]));
	$this -> assign("MANIFIESTOID",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[manifiesto_id]));
	$this -> assign("FORMATO",	                $this -> objectsHtml -> GetobjectHtml($this -> fields[formato]));
     $this -> assign("ESTADO",	                $this -> objectsHtml -> GetobjectHtml($this -> fields[estado]));	 	 	  
     $this -> assign("IMPORTARORDENCARGUE",     $this -> objectsHtml -> GetobjectHtml($this -> fields[importOrdenCargue]));	 
...
//// GRID ////
  public function SetGridRemesasMasivo($Attributes,$Titles,$Cols,$Query,
   ...
   public function RenderMain(){
        $this -> RenderLayout('RemesasMasivo.tpl');
   }
...
final class RemesasMasivoMasivoLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1 = new Form("RemesasMasivoMasivoClass.php","RemesasMasivoForm","RemesasMasivoForm");
     ...
     $this -> TplInclude -> IncludeCss("../../../framework/css/general.css");
     $this -> TplInclude -> IncludeCss("../../../framework/css/DatosBasicos.css");
     $this -> TplInclude -> IncludeCss("../../../transporte/operacion/css/RemesasMasivoMasivo.css");
     $this -> TplInclude -> IncludeCss("../../../framework/css/jquery.alerts.css");
     $this -> TplInclude -> IncludeJs("../../../framework/js/jquery.js");
     $this -> TplInclude -> IncludeJs("../../../framework/js/jqcalendar/jquery.ui.datepicker.js");
     $this -> TplInclude -> IncludeJs("../../../framework/js/jqcalendar/jquery.ui.datepicker-es.js");
     ...
     $this -> TplInclude -> IncludeJs("../../../framework/js/ajax-list.js");
     $this -> TplInclude -> IncludeJs("../../../framework/js/ajax-dynamic-list.js");
     $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/RemesasMasivoMasivo.js");
     $this -> TplInclude -> IncludeJs("../../../framework/js/jquery.alerts.js");	 
     $this -> assign("CSSSYSTEM",	$this -> TplInclude -> GetCssInclude());
     $this -> assign("JAVASCRIPT",	$this -> TplInclude -> GetJsInclude());
     $this -> assign("FORM1",		$Form1 -> FormBegin());
     ...
     $this -> assign("OFICINAID",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[oficina_id]));	 
     $this -> assign("OFICINAIDSTATIC",	$this -> objectsHtml -> GetobjectHtml($this -> fields[oficina_id_static]));	 	 
     $this -> assign("DETALLEREMESAID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[detalle_remesa_id]));
     $this -> assign("NUMEROREMESA",	$this -> objectsHtml -> GetobjectHtml($this -> fields[numero_remesa]));
     $this -> assign("TIPOREMESA",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_remesa_id]));
     $this -> assign("FECHA",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha]));
     $this -> assign("FECHAREMESA",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_remesa]));
     ...
     $this -> assign("REFERENCIA",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[referencia_producto]));	 	 
     $this -> assign("NATURALEZA",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[naturaleza_id]));
     $this -> assign("UNIDADEMPAQUE",	$this -> objectsHtml -> GetobjectHtml($this -> fields[empaque_id]));
     $this -> assign("UNIDADMEDIDA",	$this -> objectsHtml -> GetobjectHtml($this -> fields[medida_id]));
     $this -> assign("CANTIDAD",	    $this -> objectsHtml -> GetobjectHtml($this -> fields[cantidad]));
...
//// GRID ////
  public function SetGridRemesasMasivoMasivo($Attributes,$Titles,$Cols,$Query,
								$SubAttributes,$SubTitles,$SubCols,$SubQuery){  	
	require_once("../../../framework/clases/grid/JqGridClass.php");
	$TableGrid = new JqGrid();
	$TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query, 
							 $SubAttributes,$SubTitles,$SubCols,$SubQuery);
	$this -> assign("GRIDRemesasMasivo",	$TableGrid -> RenderJqGrid());
	$this -> assign("TABLEGRIDCSS",	$TableGrid -> GetJqGridCss());
	$this -> assign("TABLEGRIDJS",	$TableGrid -> GetJqGridJs());   
  }

   public function RenderMain(){
        $this -> RenderLayout('RemesasMasivoMasivo.tpl');
   }
