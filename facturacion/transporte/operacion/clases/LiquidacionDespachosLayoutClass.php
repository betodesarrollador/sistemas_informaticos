...
final class LiquidacionDespachosLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("LiquidacionDespachosClass.php","LiquidacionDespachosForm","LiquidacionDespachosForm");
	 ...
	 $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/LiquidacionDespachos.js");
   ...
   public function RenderMain(){
	 $this ->RenderLayout('LiquidacionDespachos.tpl');
   }
