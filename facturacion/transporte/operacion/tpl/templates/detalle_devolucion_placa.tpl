     		...
     		<table align="center" width="100%">
                ...
                <tr class="rowAnticipo" align="center">
                    <td>
                     ...
                     <td>
                       <select name="sub_anticipos_placa_id" id="sub_anticipos_placa_id" class="required"  >
                         <option value="NULL">(... Seleccione ...)</option>
                         {foreach name=tipo_doc from=$ANTICIPOSCRUCE item=f}
                         <option value="{$f.anticipos_placa_id}" >{$f.consecutivo}</option>
                         {/foreach}
                       </select>			 
                     </td>
                     ...
                     <td>
                       <select name="tipo_doc" id="tipo_doc" class="required" >
                         <option value="NULL">(... Seleccione ...)</option>
	   			...
	   			{if count($ANTICIPOS) > 0}
		 			{foreach name=anticipos from=$ANTICIPOS item=a}
		   				<tr class="rowAnticipo" align="center">
                             ...
                             <td>
                               <select name="sub_anticipos_placa_id" id="sub_anticipos_placa_id" {if is_numeric($a.encabezado_registro_id) }disabled{/if}  >
                                 <option value="NULL">(... Seleccione ...)</option>
                                 {foreach name=tipo_doc from=$ANTICIPOSCRUCE item=f}
                                 <option value="{$f.anticipos_placa_id}" {if $f.anticipos_placa_id eq $a.sub_anticipos_placa_id}selected{/if}>{$f.consecutivo}</option>
                                 {/foreach}
                               </select>			 
                             </td>
