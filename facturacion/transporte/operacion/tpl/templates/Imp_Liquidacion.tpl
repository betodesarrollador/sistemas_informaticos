...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="100%" border="0">
	  <tr><td colspan="2" align="center">DOCUMENTO EQUIVALENTE<BR />LIQUIDACION</td></tr>
      <tr>
        <td >Numero : </td>
  ...
  <tr>
	...
	<table width="90%" border="0">
      <tr>
        ...
        <td width="36%">{$DATOSENCABEZADO.numero_identificacion} {if $DATOSENCABEZADO.digito_verificacion neq ''}-{/if} &nbsp;{$DATOSENCABEZADO.digito_verificacion}</td>
        
        </tr>
      <tr>
        <td>Direcci&oacute;n: </td>
        <td>{$DATOSENCABEZADO.direccion}</td>
        <td>Tel&eacute;fono: </td>
        <td>{$DATOSENCABEZADO.telefono}</td>
        </tr>
      <tr>
        <td>Ciudad: </td>
        <td>{$DATOSENCABEZADO.ciudadten}</td>
        <td>Correo: </td>
        <td>{$DATOSENCABEZADO.email}</td>
        </tr>
        
        
      <tr>
        <td width="12%">Planilla : </td>
        <td width="40%">{$DATOSENCABEZADO.consecutivo}</td>
  ...
  <tr>
    <td colspan="2" style="border-bottom:1px solid; border-left:1px solid; border-right:1px solid; padding:5px">Observaciones : {$DATOSENCABEZADO.observaciones}</td>
  </tr>
  <tr>
