...
<page orientation="portrait" >
	...
	<table style="margin-left:15px; margin-top:30px;"  cellpadding="0" cellspacing="0">
    	...
    	<tr>
      		<td>
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        <td rowspan="6" class="cellTitleLeft"><span class="contec_center"><img src="{$DATOSORDENCARGUE.foto_vehiculo}" width="169"  height="121" /></span></td>
				...
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        <td  rowspan="7" class="cellTitleLeft">
						  <img src="{$DATOSORDENCARGUE.foto_conductor}" width="160"  height="126" /></td>
                    ...
                    <tr >
                      <td class="cellRight"><span class="contec_center">{$DATOSORDENCARGUE.telefono_conductor} - {$DATOSORDENCARGUE.movil_conductor}</span></td>
                      <td  width="487" class="cellRight"><span class="contec_center">{$DATOSORDENCARGUE.numero_licencia_cond}</span></td>
                    </tr>
                    <tr >
		  ...
		  <td>
		    <table width="100%">
			 <tr>
			   ...
			   <td class="cellRight" style="border-top:1px solid" width="80%">&nbsp;{$DATOSORDENCARGUE.observaciones}<br />LA EMPRESA DE TRANSPORTES LP LOGISTIC, NO AUTORIZA EXCEDER LA CAPACIDAD DEL VEHÍCULO</td>
			 </tr>
			 </table>
		  </td>
		</tr>
        <tr>
        	<td>
            	<table cellspacing="0" class="table_firmas" cellpadding="0" width="100%" border="0" style="margin-top:0px">
                	<tr>
                    	<td width="240"><img  width="100%" height="100%" src="{$DATOSORDENCARGUE.firma_desp}"></td>
                        <td width="240">&nbsp;</td>
                        <td width="240" valign="bottom">_____________________________________</td>
                    </tr>
                	<tr>
