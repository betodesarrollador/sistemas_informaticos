...
final class Imp_FacturaPDFLayout extends View{

  private $fields;

   
   public function setIncludes(){   
	 $this -> TplInclude -> IncludeCss("/talpa/framework/css/reset.css");	 
   ...
   public function RenderMain(){
	  ...
	  if($view == 'window'){
         $this -> renderLayout('Imp_FacturaPDFPDF.tpl','Documento');	  	  
	  }else{
            $this -> exportToPdf('Imp_FacturaPDFPDF.tpl','Documento');	  
	    }
