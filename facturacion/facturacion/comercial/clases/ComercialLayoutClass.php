...
final class ComercialLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("ComercialClass.php","ComercialesForm","ComercialesForm");
     ...
     $this -> TplInclude -> IncludeJs("../../../facturacion/comercial/js/Comercial.js");
   ...
   $this -> TplInclude -> IncludeJs("../../../framework/js/jqgrid/jquery-ui-1.8.2.custom.min.js");
	 ...
	 $this -> assign("URL",			    	$this -> objectsHtml -> GetobjectHtml($this -> fields[url_comercial]));	 
	 $this -> assign("CONTACT",			    $this -> objectsHtml -> GetobjectHtml($this -> fields[contac_comercial]));	 	 
	 ...
	 $this -> assign("AUTORET_SI",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[autoret_comercial_si]));	 	 
	 $this -> assign("AUTORET_NO",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[autoret_comercial_no]));	 	 
	 $this -> assign("AGENTE_SI",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[agente_comercial_si]));	 	 
	 $this -> assign("AGENTE_NO",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[agente_comercial_no]));	 	 
	 
	 $this -> assign("RENTA_SI",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[renta_comercial_si]));	 	 
	 $this -> assign("RENTA_NO",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[renta_comercial_no]));	 	 

	 $this -> assign("NUM_CUENTA",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[numcuenta_comercial]));
	 ...
	 //$this -> assign("TIPO",            $this -> objectsHtml -> GetobjectHtml($this -> fields[tipo_comision]));	
	 $this -> assign("REC_RANGO1",            $this -> objectsHtml -> GetobjectHtml($this -> fields[rec_rango1]));	
	 $this -> assign("REC_RANGO2",            $this -> objectsHtml -> GetobjectHtml($this -> fields[rec_rango2]));	
	 $this -> assign("REC_RANGO3",            $this -> objectsHtml -> GetobjectHtml($this -> fields[rec_rango3]));	
	 $this -> assign("REC_RANGO4",            $this -> objectsHtml -> GetobjectHtml($this -> fields[rec_rango4]));	
	 
	 $this -> assign("FAC_RANGO1",            $this -> objectsHtml -> GetobjectHtml($this -> fields[fac_rango1]));	
	 $this -> assign("FAC_RANGO2",            $this -> objectsHtml -> GetobjectHtml($this -> fields[fac_rango2]));	
	 $this -> assign("FAC_RANGO3",            $this -> objectsHtml -> GetobjectHtml($this -> fields[fac_rango3]));	
	 $this -> assign("FAC_RANGO4",            $this -> objectsHtml -> GetobjectHtml($this -> fields[fac_rango4]));	
    ...
    public function SetGridComerciales($Attributes,$Titles,$Cols,$Query){
    ...
    public function RenderMain(){
      $this ->RenderLayout('Comercial.tpl');
    }
