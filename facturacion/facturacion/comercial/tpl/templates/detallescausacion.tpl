  ...
  <table align="center" id="tableDetalles" width="98%">
    ...
    {if $TIPO eq '0'}
      ...
      <tr>
        ...
        <td><input type="text" name="desc_factura_proveedor" id="desc_factura_proveedor" value="{$i.desc_factura_proveedor}" class="text" /></td>		        
        <td {if $i.requiere_base_ofi eq '0' and $i.requiere_base_emp eq '0'} class="no_requerido" {/if}>
          <input type="text" name="base_factura_proveedor"   value="{$i.base_factura_proveedor}" maxlength="12"  size="15" {if $i.requiere_base_ofi eq '0' and $i.requiere_base_emp eq '0'} class="numeric no_requerido" readonly {else} class="numeric required" {/if}  /></td>
        <td><input type="text" name="deb_item_factura_proveedor" class="numeric" value="{$i.deb_item_factura_proveedor}" maxlength="15" size="12" /></td>        
        <td><input type="text" name="cre_item_factura_proveedor" class="numeric" value="{$i.cre_item_factura_proveedor}" maxlength="15" size="12" /></td>
        <td>{if $i.estado neq 'C' and $i.estado neq 'I'}<a name="saveDetalle"><img src="/spm/framework/media/images/grid/save.png" /></a>{/if}</td>		
    ...
    {else}
      ...
      <tr>
        ...
        <td {if $i.requiere_base_ofi eq '0' and $i.requiere_base_emp eq '0'} class="no_requerido" {/if}>
          <input type="text" name="base_factura_proveedor"   value="{$i.base_factura_proveedor}" maxlength="12"  size="15" {if $i.requiere_base_ofi eq '0' and $i.requiere_base_emp eq '0'} class="numeric no_requerido" readonly {else} class="numeric required" {/if}  /></td>
        <td><input type="text" name="deb_item_factura_proveedor" class="numeric required" value="{$i.deb_item_factura_proveedor}" maxlength="15" size="12" /></td>        
        <td><input type="text" name="cre_item_factura_proveedor" class="numeric required" value="{$i.cre_item_factura_proveedor}" maxlength="15" size="12" /></td>
        <td>
        	<input type="radio" name="contra_factura_proveedor" value="1" {if $i.contra_factura_proveedor eq '1'}checked{/if} />
        </td>
        <td>{if $i.estado neq 'C' and $i.estado neq 'I'}<a name="saveAgregar"><img src="/spm/framework/media/images/grid/save.png" /></a>{/if}</td>		
        <td><input type="checkbox" name="procesar" /></td>
      </tr> 
	  {/foreach}	
      ...
      <tr>
        ...
        <td><input type="text" name="desc_factura_proveedor" id="desc_factura_proveedor" value="" class="text" /></td>		        
        <td>
          <input type="text" name="base_factura_proveedor"   value="" maxlength="12"  size="15"  class="numeric no_requerido" readonly   /></td>
        <td><input type="text" name="deb_item_factura_proveedor" class="numeric required" value="" maxlength="15" size="12" /></td>        
        <td><input type="text" name="cre_item_factura_proveedor" class="numeric required" value="" maxlength="15" size="12" /></td>
        <td>
        	<input type="radio" name="contra_factura_proveedor" value="1" />
        </td>
        
        <td>{if $i.estado neq 'C' and $i.estado neq 'I'}<a name="saveAgregar"><img src="/spm/framework/media/images/grid/add.png" /></a>{/if}</td>		
        <td><input type="checkbox" name="procesar" /></td>
      </tr> 
	</tbody>
  </table>
