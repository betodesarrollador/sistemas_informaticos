...
final class SolicFacturas extends Controler
{
    ...
    public function Main()
    {
        ...
        $Layout->SetSolicNotasDebito($Model->getSolicNotasDebito($cliente_id, $this->getConex()));
    ...
    public function buscarImpuesto()
    {
        ...
        for ($i = 1; $i <= $num_descu; $i++) {
            $puc_id[$i] = $Model->selectImpuesto($_REQUEST['puc_id' . $i], $base, $periodo_contable_id, $factura_id, $this->getConex());
        }
