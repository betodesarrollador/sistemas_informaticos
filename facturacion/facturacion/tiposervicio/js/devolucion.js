...
function saveDetalle(obj) {
    ...
    if (validaRequeridosDetalle(obj, row)) {
        ...
        var devpuc_bien_servicio_factura_id = $(Fila).find("input[name=devpuc_bien_servicio_factura_id]").val();
        var tipo_bien_servicio_factura_id = $("#tipo_bien_servicio_factura_id").val();
        console.log("tipo_bien_servicio_factura_id" + tipo_bien_servicio_factura_id);
        ...
        if (!devpuc_bien_servicio_factura_id.length > 0) {

            devpuc_bien_servicio_factura_id = 'NULL';

            var QueryString = "ACTIONCONTROLER=onclickSave&tipo_bien_servicio_factura_id=" + tipo_bien_servicio_factura_id + "&devpuc_bien_servicio_factura_id=" +
                devpuc_bien_servicio_factura_id + "&puc_id=" + puc_id + "&natu_bien_servicio_factura=" + natu_bien_servicio_factura + "&contra_bien_servicio_factura=" + contra_bien_servicio_factura + "&despuc_bien_servicio_factura=" + despuc_bien_servicio_factura + "&tercero_bien_servicio_factura=" + tercero_bien_servicio_factura +
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (!isNaN(response)) {
                        ...
                        $(Fila).find("input[name=devpuc_bien_servicio_factura_id]").val(response);
            ...
            var QueryString = "ACTIONCONTROLER=onclickUpdate&tipo_bien_servicio_factura_id=" + tipo_bien_servicio_factura_id + "&devpuc_bien_servicio_factura_id=" +
                devpuc_bien_servicio_factura_id + "&puc_id=" + puc_id + "&natu_bien_servicio_factura=" + natu_bien_servicio_factura + "&contra_bien_servicio_factura=" + contra_bien_servicio_factura + "&despuc_bien_servicio_factura=" + despuc_bien_servicio_factura + "&tercero_bien_servicio_factura=" + tercero_bien_servicio_factura +
                "&ret_tercero_bien_servicio_factura=" + ret_tercero_bien_servicio_factura + "&reteica_bien_servicio_factura=" + reteica_bien_servicio_factura + "&aplica_ingreso=" + aplica_ingreso + "&aplica_tenedor=" + aplica_tenedor;
...
function deleteDetalle(obj) {
    ...
    var Fila = obj.parentNode.parentNode;
    var devpuc_bien_servicio_factura_id = $(Fila).find("input[name=devpuc_bien_servicio_factura_id]").val();
    var QueryString = "ACTIONCONTROLER=onclickDelete&devpuc_bien_servicio_factura_id=" + devpuc_bien_servicio_factura_id;
...
function ActivarDetalle(obj) {
    ...
    var Fila = obj.parentNode.parentNode;
    var devpuc_bien_servicio_factura_id = $(Fila).find("input[name=devpuc_bien_servicio_factura_id]").val();
    var QueryString = "ACTIONCONTROLER=onclickActivar&&devpuc_bien_servicio_factura_id=" + devpuc_bien_servicio_factura_id;
