...
final class ClientesLayout extends View
{
    ...
    public function SetCampos($campos)
    {
        ...
        $this->TplInclude->IncludeCss("../../../facturacion/cliente/css/clientes.css");
        ...
        $this->TplInclude->IncludeJs("../js/Clientes.js");
        ...
        $this->assign("CODIGOCIIUID", $this->objectsHtml->GetobjectHtml($this->fields[codigo_ciiu_id]));
        $this->assign("EMAIL", $this->objectsHtml->GetobjectHtml($this->fields[email]));
        $this->assign("EMAILCLIENTE", $this->objectsHtml->GetobjectHtml($this->fields[email_cliente]));
        ...
        $this->assign("OBSFACTURA", $this->objectsHtml->GetobjectHtml($this->fields[observacion_factura]));

        $this->assign("URL_SISTEMA", $this->objectsHtml->GetobjectHtml($this->fields[url_sistema]));
        ...
        $this -> assign("COMISION",            $this -> objectsHtml -> GetobjectHtml($this -> fields[comision]));
         */
        $this->assign("EJECUTIVO", $this->objectsHtml->GetobjectHtml($this->fields[ejecutivo]));
