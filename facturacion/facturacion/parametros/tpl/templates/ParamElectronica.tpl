<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
  ...
  <body>
	<fieldset>
        ...
        <table align="center">
          <tr>
            <td><label>No.: </label></td><td colspan="2">{$PARAMEID}</td>
          </tr>
          <tr>
          ...
          <tr>
            <td><label>Correo Empresarial: </label></td><td>{$CORREO}</td>
            <td><label>Correo Empresarial Adicional: </label></td><td>{$CORREOANEXO}</td>
          </tr>
          <tr>
