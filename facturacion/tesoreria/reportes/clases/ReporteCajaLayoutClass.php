...
final class ReporteCajaLayout extends View{
  ...
  public function setLimpiar($Permiso){
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("ReporteCajaClass.php","ReporteCajaForm","ReporteCajaForm");
     ...
     $this -> TplInclude -> IncludeJs("../../../tesoreria/reportes/js/ReporteCaja.js");
   ...
   if($this->Limpiar)
    ...
    public function RenderMain(){
      $this ->RenderLayout('ReporteCaja.tpl');
    }
