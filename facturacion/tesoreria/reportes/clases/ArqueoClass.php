...
final class Arqueo extends Controler{
  ...
  public function Main(){
	...
	require_once("ArqueoLayoutClass.php");
	require_once("ArqueoModelClass.php");
	
	$Layout   = new ArqueoLayout($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new ArqueoModel();
