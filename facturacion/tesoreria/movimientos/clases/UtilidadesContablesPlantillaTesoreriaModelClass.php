<?php
  ...
  class UtilidadesContablesPlantillaTesoreriaModel extends Db{  
            ...
            if($consecutivo_por == 'E'){			
			  ...
			  if(count($result) > 0){	
			   ...
			   return $consecutivo;
			    ...
			    $select = "SELECT consecutivo FROM tipo_de_documento WHERE tipo_documento_id = $tipo_documento_id 
				AND empresa_id = (SELECT empresa_id FROM oficina WHERE oficina_id = $oficina_id)";							  
 		        $result = $this -> DbFetchAll($select,$Conex,true);							  
