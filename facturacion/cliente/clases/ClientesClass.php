  ...
  protected function showGrid(){
	...
	$Attributes = array(
	  ...
	  $Cols = array(
		...
		array(name=>'cliente_id',		index=>'cliente_id',	sorttype=>'text',	width=>'80',	align=>'center'),
		...
		array(name=>'banco',						index=>'banco',						sorttype=>'text',	width=>'150',	align=>'center'),
		 ...
		 array(name=>'ejecutivo',					index=>'ejecutivo',					sorttype=>'text',	width=>'150',	align=>'center'),	  	  	  
		array(name=>'estado',						index=>'estado',					sorttype=>'text',	width=>'100',	align=>'center')
				
	  
	  );
		
	  $Titles = array('CLIENTE ID',
					  'TIPO ID',
					  'IDENTIFICACION',
					  'DV',
					  'TIPO CONTRIBUYENTE',
	 ...
	 $html = $Layout -> SetGridClientes($Attributes,$Titles,$Cols,$Model -> GetQueryClientesGrid());
...
//BUSQUEDA
  ...
  protected function onclickPrint(){
   ...
   protected function comprobar_obligaciones(){
    ...
    $Layout -> setJsInclude("../../../facturacion/cliente/js/Clientes.js");	 	 	 		
  ...
  protected function SetCampos(){
	...
	********************/
	...
	$this -> Campos[codigo_ciiu_id] = array(
		name	=>'codigo_ciiu_id',
		id		=>'codigo_ciiu_id',
		type	=>'hidden',
	 	//tabindex=>'10',
...
/*	$this -> Campos[tipo_comision] = array(
	...
	$this -> Campos[comision] = array(
	 ...
	 $this -> Campos[observacion_factura]  = array(
