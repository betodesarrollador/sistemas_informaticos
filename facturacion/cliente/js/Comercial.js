...
function saveDetalle(obj) {
    ...
    if (validaRequeridosDetalle(obj, row)) {
        ...
        var porcentaje_fijo = $(Fila).find("input[name=porcentaje_fijo]").val();
        var tipo_variable = $(Fila).find("select[name=tipo_variable]").val();
        ...
        if (!comerciales_cliente_id.length > 0) {
            ...
            var QueryString = "ACTIONCONTROLER=onclickSave&tercero_id=" + tercero_id + "&comercial_id=" + comercial_id + "&oficina_id=" + oficina_id + "&tipo_recaudo=" + tipo_recaudo + "&porcentaje_fijo=" + porcentaje_fijo + "&tipo_variable=" + tipo_variable;
            ...
            var QueryString = "ACTIONCONTROLER=onclickUpdate&comerciales_cliente_id=" + comerciales_cliente_id + "&tercero_id=" + tercero_id + "&comercial_id=" + comercial_id + "&oficina_id=" + oficina_id + "&tipo_recaudo=" + tipo_recaudo + "&porcentaje_fijo=" + porcentaje_fijo + "&tipo_variable=" + tipo_variable;
...
//	
//	
//	$("input[name=nombre_comercial]").autocomplete("/spm/framework/clases/ListaInteligente.php?consulta=comercial", {
//		width: 400,
//		selectFirst: true,
//		minChars: 2,
//		scrollHeight: 220
