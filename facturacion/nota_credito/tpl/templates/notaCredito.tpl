    ...
    <fieldset class="section">
        <table align="center" width="90%">
            <tr>
                ...
                <td>{$ABONOFACTURAID}{$NUMSOPORTE}{$FACTURAID}</td>
            </tr>
            ...
            <tr>
                ...
                <td>{$CONCEPTO}{$REMESAS}{$ORDENES}</td>
            ...
            <tr>
                ...
                <td>{$TIPOBIENSERVICIO}</td>
                <td><label>Valor Nota Credito : </label></td>
                <td>{$VALORNOTA}</td>
            </tr>
            <tr>
                ...
                <td colspan="5" align="center">
                    <table width="100%">
                        <tr>
                            ...
                            <td width="100%" align="center">{$GUARDAR}&nbsp;{$ACTUALIZAR}&nbsp;{$LIMPIAR}&nbsp;{$IMPRIMIR}&nbsp;{$CONTABILIZAR}&nbsp;&nbsp;{*{$REPORTAR}*}&nbsp;{$ENVIOFACTURA}&nbsp;{$REPORTARVP}</td>
                        </tr>
                    </table>                
                </td>
            </tr>
