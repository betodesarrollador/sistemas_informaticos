...
final class DetallesModel extends Db{
  ...
  public function getDetalles($tipo_bien_servicio_factura_id,$Conex){
  ...
  public function Save($Campos,$Conex){
	  ...
	  $aplica_tenedor	= $this -> requestDataForQuery('aplica_tenedor','integer');
		...
		$insert = "INSERT INTO codpuc_bien_servicio_factura 
	            (codpuc_bien_servicio_factura_id ,tipo_bien_servicio_factura_id,puc_id,despuc_bien_servicio_factura,natu_bien_servicio_factura,contra_bien_servicio_factura,tercero_bien_servicio_factura,ret_tercero_bien_servicio_factura,reteica_bien_servicio_factura,aplica_ingreso,aplica_tenedor,activo) 
	            VALUES  
				($codpuc_bien_servicio_factura_id,$tipo_bien_servicio_factura_id,$puc_id,$despuc_bien_servicio_factura,$natu_bien_servicio_factura,$contra_bien_servicio_factura,$tercero_bien_servicio_factura,$ret_tercero_bien_servicio_factura,$reteica_bien_servicio_factura,$aplica_ingreso,$aplica_tenedor,1)";
