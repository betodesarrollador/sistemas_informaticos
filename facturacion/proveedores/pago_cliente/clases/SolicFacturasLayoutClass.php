...
final class SolicFacturasLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/rotterdan/facturacion/pago/css/detalles.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/rotterdan/proveedores/pago_cliente/js/SolicFacturas.js");
