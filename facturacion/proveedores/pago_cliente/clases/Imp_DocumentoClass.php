...
final class Imp_Documento{
  ...
  public function printOut(){
	  ...
	  $pdf->Ln(5);	
      $pdf->SetFont('Arial','B',10);	 	 	 	  
	  $pdf->Cell(35,5,'Doc: '.utf8_decode($encabezado[0]['texto_tercero']),1,0,'L');	
	  $pdf->Cell(80,5,substr(utf8_decode($encabezado[0]['razon_social'].' '.$encabezado[0]['primer_nombre'].' '.$encabezado[0]['segundo_nombre'].' '.$encabezado[0]['primer_apellido'].' '.$encabezado[0]['segundo_apellido']),0,35),1,0,'L');	
