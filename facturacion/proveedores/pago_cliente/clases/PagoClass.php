...
//BUSQUEDA
  ...
  protected function SetCampos(){
	...
	********************/
	...
	$this -> Campos[puc_menor_id] = array(
		name	=>'puc_menor_id',
		id		=>'puc_menor_hidden',
		type	=>'hidden',
		value	=>'',
	...
	$this -> Campos[puc_mayor_id] = array(
		name	=>'puc_mayor_id',
		id		=>'puc_mayor_hidden',
		type	=>'hidden',
		value	=>'',
