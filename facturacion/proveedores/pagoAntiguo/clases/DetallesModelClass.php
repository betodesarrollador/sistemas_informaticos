...
final class DetallesModel extends Db{
  ...
  public function Save($Campos,$oficina_id,$Conex){
	  ...
	  $insert = "INSERT INTO item_abono_factura (item_abono_factura_id,tercero_id,centro_de_costo_id,desc_abono_factura,base_abono_factura,deb_item_abono_factura,cre_item_abono_factura,relacion_abono_factura_id,abono_factura_proveedor_id,puc_id,sucursal_id) VALUES ($item_abono_factura_id,$tercero_id,$centro_de_costo_id,$desc_abono_factura,$base_abono_factura,$deb_item_abono_factura,$cre_item_abono_factura,$relacion_abono_factura_id,$abono_factura_proveedor_id,$puc_id,$oficina_id)";
  ...
  public function Update($Campos,$oficina_id,$Conex){
