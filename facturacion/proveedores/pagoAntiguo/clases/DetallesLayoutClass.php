...
final class DetallesLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("/rotterdan/proveedores/pago/css/detalles.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/rotterdan/proveedores/pago/js/detalles.js");
	 ...
	 $this -> assign("estado_abono_factura",  $_REQUEST['estado_abono_factura']);	 
