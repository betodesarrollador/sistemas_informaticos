...
final class Descuento extends Controler{
  ...
  public function Main(){
	...
	$Layout -> SetGridDescuento($Attributes,$Titles,$Cols,$Model -> GetQueryDescuentoGrid());
	$Layout -> RenderMain();
...
//BUSQUEDA
  protected function onclickFind(){
    ...
    $Data                  = array();
	$parametros_descuento_proveedor_id   = $_REQUEST['parametros_descuento_proveedor_id'];
	 
	if(is_numeric($parametros_descuento_proveedor_id)){
	  
	  $Data  = $Model -> selectDatosDescuentoId($parametros_descuento_proveedor_id,$this -> getConex());
  ...
  protected function SetCampos(){
	...
	********************/
	...
	$this -> Campos[parametros_descuento_proveedor_id] = array(
		name	=>'parametros_descuento_proveedor_id',
		id		=>'parametros_descuento_proveedor_id',
		type	=>'hidden',
		datatype=>array(
			type	=>'autoincrement'),
		transaction=>array(
			table	=>array('parametros_descuento_proveedor'),
 	...
 	$this -> Campos[actualizar] = array(
  	...
  	$this -> Campos[borrar] = array(
   	...
   	$this -> Campos[busqueda] = array(
		...
		//tabindex=>'1',
		suggest=>array(
			name	=>'parametros_descuento_proveedor',
			setId	=>'parametros_descuento_proveedor_id',
...
$descuento_proveedor_id = new Descuento();
