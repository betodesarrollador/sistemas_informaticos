                    ...
                    <td>
                     ...
                     <td>
                       <select name="sub_anticipos_proveedor_id" id="sub_anticipos_proveedor_id" class="required"  >
                         ...
                         <option value="{$f.anticipos_proveedor_id}" >{$f.consecutivo}</option>
                         {/foreach}
                       </select>			 
                     </td>
                     <td>
	   			...
	   			{if count($ANTICIPOS) > 0}
		 			{foreach name=anticipos from=$ANTICIPOS item=a}
		   				<tr class="rowAnticipo" align="center">
                             ...
                             <td>
                               <select name="sub_anticipos_proveedor_id" id="sub_anticipos_proveedor_id" {if is_numeric($a.encabezado_registro_id) }disabled{/if}  >
                                 <option value="NULL">(... Seleccione ...)</option>
                                 {foreach name=tipo_doc from=$ANTICIPOSCRUCE item=f}
                                 <option value="{$f.anticipos_proveedor_id}" {if $f.anticipos_proveedor_id eq $a.sub_anticipos_proveedor_id}selected{/if}>{$f.consecutivo}</option>
                                 {/foreach}
                               </select>			 
                             </td>
