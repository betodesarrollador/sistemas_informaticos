...
final class SolicitudLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $Form1      = new Form("SolicitudClass.php","SolicitudForm","SolicitudForm");
     ...
     $this -> TplInclude -> IncludeJs("../../../proveedores/ordencompra/js/Solicitud.js");
     ...
     $this -> assign("ORDENID",				$this -> objectsHtml -> GetobjectHtml($this -> fields[pre_orden_compra_id]));
     $this -> assign("CONSECUTIVO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[consecutivo]));
     $this -> assign("FECHA",				$this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_pre_orden_compra]));	 
     ...
     $this -> assign("OBSERVACION",			$this -> objectsHtml -> GetobjectHtml($this -> fields[observ_pre_orden_compra]));
     $this -> assign("PAGO",				$this -> objectsHtml -> GetobjectHtml($this -> fields[forma_compra_venta_id]));	 
	 $this -> assign("ESTADO",				$this -> objectsHtml -> GetobjectHtml($this -> fields[estado_pre_orden_compra]));	
	 $this -> assign("FECHAINGRESO",		$this -> objectsHtml -> GetobjectHtml($this -> fields[ingreso_pre_orden_compra]));		
...
*/
	 ...
	 ***********************/
	 ...
	 $this -> assign("FECHALOG",$this -> objectsHtml -> GetobjectHtml($this -> fields[anul_pre_orden_compra]));	   
	 $this -> assign("OBSERVACIONES",$this -> objectsHtml -> GetobjectHtml($this -> fields[desc_anul_pre_orden_compra]));	   	 
	 
 	 /***********************
	     Liquidar Registro
	 ***********************/
	 
	 $this -> assign("FECHALOG1",$this -> objectsHtml -> GetobjectHtml($this -> fields[fec_liq_pre_orden_compra]));	   
	 $this -> assign("OBSERVACIONES1",$this -> objectsHtml -> GetobjectHtml($this -> fields[descrip_liq_pre_orden_compra]));	   	 
 ...
 public function setOficina($Tiposoficina){
   ...
   public function setUsuarioId($usuario,$oficina){
    ...
    public function SetGridSolicitud($Attributes,$Titles,$Cols,$Query){
    ...
    public function RenderMain(){
      $this ->RenderLayout('Solicitud.tpl');
    }
