...
function setSolicitud(){
	...
	parent.document.forms[0]['causaciones_abono_factura_proveedor'].value = detalle_ss_id;
	parent.document.forms[0]['valores_abono_factura_proveedor'].value = detalle_valores;
	parent.document.forms[0]['descuentos_items'].value = detalle_descuentos;	
	parent.document.forms[0]['valor_abono_factura_proveedor'].value = setFormatCurrency(pago_saldo);
	parent.document.forms[0]['valor_descu_factura_proveedor'].value = setFormatCurrency(total_descu);
	parent.document.forms[0]['valor_neto_factura_proveedor'].value = setFormatCurrency(total_neto);	
	parent.cargardatos();
	parent.closeDialog();
}
