...
final class PagoLayout extends View{
   ...
   public function SetCampos($campos){
	 ...
	 $this -> assign("VALORDESCU",			$this -> objectsHtml -> GetobjectHtml($this -> fields[valor]));		 
	 ...
	 $this -> assign("FACTURAS",			$this -> objectsHtml -> GetobjectHtml($this -> fields[factura_proveedors]));	
