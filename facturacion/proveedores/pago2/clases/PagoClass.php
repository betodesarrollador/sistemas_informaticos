...
final class Pago extends Controler{
  ...
  public function Main(){
	...
	$Cols = array(
	  ...
	  array(name=>'ingreso_abono_factura_proveedor',		index=>'ingreso_abono_factura_proveedor',		sorttype=>'date',	width=>'120',	align=>'left'),
	  ...
	  array(name=>'concepto_abono_factura_proveedor',		index=>'concepto_abono_factura_proveedor',	sorttype=>'text',	width=>'200',	align=>'left'),
	  array(name=>'valor_abono_factura_proveedor',		index=>'valor_abono_factura_proveedor',		sorttype=>'text',	width=>'100',	align=>'center', format => 'currency'),
	  array(name=>'estado_abono_factura_proveedor',		index=>'estado_abono_factura_proveedor',		sorttype=>'text',	width=>'100',	align=>'left')	  
	);
  ...
  protected function OnclickReversar(){
	...
	$ingreso_abono_factura_proveedor 	= $_REQUEST['rever_abono_factura_proveedor'];

    $mesContable     = $Model -> mesContableEstaHabilitado($empresa_id,$oficina_id,$ingreso_abono_factura_proveedor,$this -> getConex());
...
//BUSQUEDA
  ...
  protected function getContabilizar(){
    ...
    $Model = new PagoModel();
	$abono_factura_proveedor_id	= $_REQUEST['abono_factura_proveedor_id'];
	$ingreso_abono_factura_proveedor 		= $_REQUEST['ingreso_abono_factura_proveedor'];
	$empresa_id = $this -> getEmpresaId();  
	$oficina_id = $this -> getOficinaId();	
	$usuario_id = $this -> getUsuarioId();
  ...
  protected function SetCampos(){
	...
	********************/
	...
	$this -> Campos[valor_abono_factura_proveedor] = array(
		name	=>'valor_abono_factura_proveedor',
		id		=>'valor_abono_factura_proveedor',
		type	=>'text',
		readonly=>'yes',
	 	datatype=>array(
			type	=>'numeric',
	...
	$this -> Campos[valor_descu_factura_proveedor] = array(
		name	=>'valor_descu_factura_proveedor',
		id		=>'valor_descu_factura_proveedor',
		type	=>'text',
		readonly=>'yes',
	 	datatype=>array(
			type	=>'numeric',
	...
	$this -> Campos[valor_neto_factura_proveedor] = array(
		name	=>'valor_neto_factura_proveedor',
		id		=>'valor_neto_factura_proveedor',
		type	=>'text',
		readonly=>'yes',
	 	datatype=>array(
			type	=>'numeric',
	...
	$this -> Campos[tipo_documento_id] = array(
		...
		type	=>'select',
		options	=>array(array(value => '16', text => 'NOTA CREDITO')),
		selected=>'16',
		required=>'yes',
	 	datatype=>array(
			type	=>'integer',
	...
	$this -> Campos[concepto_abono_factura_proveedor] = array(
		name	=>'concepto_abono_factura_proveedor',
		id		=>'concepto_abono_factura_proveedor',
		type	=>'text',
		readonly=>'yes',
		required=>'yes',
		size    => '48',
	...
	$this -> Campos[causaciones_abono_factura_proveedor] = array(
		name	=>'causaciones_abono_factura_proveedor',
		id		=>'causaciones_abono_factura_proveedor',
		type	=>'hidden',
		datatype=>array(
			type	=>'alphanum',
			length	=>'350'),
	...
	$this -> Campos[valores_abono_factura_proveedor] = array(
		name	=>'valores_abono_factura_proveedor',
		id		=>'valores_abono_factura_proveedor',
		type	=>'hidden',
		datatype=>array(
			type	=>'alphanum',
			length	=>'350'),
	...
	$this -> Campos[ingreso_abono_factura_proveedor] = array(
		name	=>'ingreso_abono_factura_proveedor',
		id		=>'ingreso_abono_factura_proveedor',
		type	=>'hidden',
	...
	$this -> Campos[estado_abono_factura_proveedor] = array(
		name	=>'estado_abono_factura_proveedor',
		id		=>'estado_abono_factura_proveedor',
		type	=>'select',
		disabled=>'yes',
	...
	*****************************************/
	...
	$this -> Campos[anul_abono_factura_proveedor] = array(
		name	=>'anul_abono_factura_proveedor',
		id		=>'anul_abono_factura_proveedor',
		type	=>'text',
		size    =>'17',
	...
	$this -> Campos[desc_anul_abono_factura_proveedor] = array(
		name	=>'desc_anul_abono_factura_proveedor',
		id		=>'desc_anul_abono_factura_proveedor',
		type	=>'textarea',
		value	=>'',
		required=>'yes',
    	datatype=>array(
	...
	*****************************************/
	...
	$this -> Campos[rever_abono_factura_proveedor] = array(
		name	=>'rever_abono_factura_proveedor',
		id		=>'rever_abono_factura_proveedor',
		type	=>'text',
		size    =>'17',
        value   =>date("Y-m-d H:m"),
		readonly=>'yes',
	...
	$this -> Campos[desc_rever_abono_factura_proveedor] = array(
		name	=>'desc_rever_abono_factura_proveedor',
		id		=>'desc_rever_abono_factura_proveedor',
		type	=>'textarea',
		value	=>'',
		required=>'yes',
    	datatype=>array(
