...
final class DetallesModel extends Db{
  ...
  public function getImputacionesContables($abono_factura_proveedor_id,$empresa_id,$oficina_id,$Conex){
	...
	if(is_numeric($abono_factura_proveedor_id)){
	  ...
	  (SELECT valor FROM factura_proveedor WHERE factura_proveedor_id=r.factura_proveedor_id) AS valor_total,
	  (SELECT SUM(ia.deb_item_abono) FROM item_abono ia, relacion_abono ra, abono_factura_proveedor ab 
	  WHERE ra.factura_proveedor_id=r.factura_proveedor_id AND ab.abono_factura_proveedor_id=ra.abono_factura_proveedor_id AND ab.estado_abono_factura_proveedor='C' AND ia.relacion_abono_id=ra.relacion_abono_id) AS abonos
	  FROM item_abono  i, relacion_abono r  WHERE i.abono_factura_proveedor_id = $abono_factura_proveedor_id AND r.relacion_abono_id=i.relacion_abono_id";
  ...
  public function selectImpuesto($puc_id,$base_abono,$abono_factura_proveedor_id,$Conex){
