...
final class PagoLayout extends View{
   ...
   public function SetCampos($campos){
	 ...
	 $this -> TplInclude -> IncludeCss("/rotterdan/proveedores/notas/css/pago.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/rotterdan/proveedores/notas/js/pago.js");
	 ...
	 $this -> assign("VALORPAGO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_abono_factura_proveedor]));		 
	 $this -> assign("VALORDESCU",			$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_descu_factura_proveedor]));		 
	 $this -> assign("VALORNETO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_neto_factura_proveedor]));		 
	 $this -> assign("OBSERVACIONES1",		$this -> objectsHtml -> GetobjectHtml($this -> fields[observaciones]));	
	 
	 $this -> assign("CONCEPTOFACTU",		$this -> objectsHtml -> GetobjectHtml($this -> fields[concepto_abono_factura_proveedor]));		 	 	 
	 $this -> assign("CAUSACIONFACTU",		$this -> objectsHtml -> GetobjectHtml($this -> fields[causaciones_abono_factura_proveedor]));	
	 $this -> assign("DESCUENTOITEMS",		$this -> objectsHtml -> GetobjectHtml($this -> fields[descuentos_items]));	
	 $this -> assign("VALORESCAUSACION",	$this -> objectsHtml -> GetobjectHtml($this -> fields[valores_abono_factura_proveedor]));		 
	 $this -> assign("FECHAINGRESO",		$this -> objectsHtml -> GetobjectHtml($this -> fields[ingreso_abono_factura_proveedor]));		 
	 $this -> assign("ESTADO",				$this -> objectsHtml -> GetobjectHtml($this -> fields[estado_abono_factura_proveedor]));		 	 
	 ...
	 ***********************/
	 ...
	 $this -> assign("FECHALOG",$this -> objectsHtml -> GetobjectHtml($this -> fields[anul_abono_factura_proveedor]));	   
	 $this -> assign("OBSERVACIONES",$this -> objectsHtml -> GetobjectHtml($this -> fields[desc_anul_abono_factura_proveedor]));	   	 
	 ...
	 ***********************/
	 ...
	 $this -> assign("FECHALOGREV",$this -> objectsHtml -> GetobjectHtml($this -> fields[rever_abono_factura_proveedor]));	   
	 $this -> assign("OBSERVACIONESREV",$this -> objectsHtml -> GetobjectHtml($this -> fields[desc_rever_abono_factura_proveedor]));	   	 
