...
final class MovimientosContablesContabilizados extends Controler{
  ...
  public function Main(){
	...
	require_once("MovimientosContablesContabilizadosLayoutClass.php");
    require_once("MovimientosContablesContabilizadosModelClass.php");
	...
	$Attributes = array(
	  ...
	  title		     =>'Registros Contables Contabilizados',
	  sortname	     =>'fecha',
	  sortorder      =>'desc',
	  width		     =>'auto',
	  height	     =>'auto',
	...
	$Cols = array(
	  ...
	  array(name=>'fecha',                 index=>'fecha',                 sorttype=>'text',	width=>'100',	align=>'center'),
  	  array(name=>'fecha_creacion',                 index=>'fecha_creacion',                 sorttype=>'text',	width=>'100',	align=>'center'),
	...
	$Layout -> SetGridMovimientosContablesContabilizados($Attributes,$Titles,$Cols,$Model -> getQueryMovimientosContablesContabilizadosGrid());
