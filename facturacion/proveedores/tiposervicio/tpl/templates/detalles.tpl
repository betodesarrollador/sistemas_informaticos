<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
  ...
  <table align="center" id="tableDetalles" width="98%">
	...
	<tbody>
      ...
      <tr>
        ...
        <input type="hidden" name="codpuc_bien_servicio_id" value="{$i.codpuc_bien_servicio_id}" />        </td>
        ...
        <td><a name="saveDetalles"><img src="/rotterdan/framework/media/images/grid/add.png" /></a></td>
      ...
      <tr>
        ...
        <input type="hidden" name="codpuc_bien_servicio_id" value="" />        </td>
  ...
  <table width="98%" align="center">
      ...
      <tr id="clon">
        ...
        <input type="hidden" name="codpuc_bien_servicio_id" value="" />
