...
final class TipoServicioLayout extends View{
   ...
   public function SetCampos($campos){
	 ...
	 $this -> TplInclude -> IncludeCss("../../../proveedores/tiposervicio/css/tiposervicio.css");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../proveedores/tiposervicio/js/tiposervicio.js");
	 ...
	 $this -> assign("CODIGOBIEN",			$this -> objectsHtml -> GetobjectHtml($this -> fields[codigo_tipo_servicio]));	

     $this -> assign("NOMBREBIEN",			$this -> objectsHtml -> GetobjectHtml($this -> fields[nombre_bien_servicio]));	
