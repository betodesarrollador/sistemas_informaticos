...
final class reporteRendimientoLayout extends View{
	...
	public function setCampos($campos){
		...
		$Form1 = new Form("reporteRendimientoClass.php","reporteRendimientoForm","reporteRendimientoForm");
		...
		$this -> TplInclude -> IncludeJs("../js/reporteRendimiento.js"); 
...
//LISTA MENU
	...
	public function RenderMain(){   
		...
		$this -> RenderLayout('reporteRendimiento.tpl');	 
