...
<html>
<head>
    <meta http-equiv="content-type" content="text/html; charset=utf-8"><title>Reporte x Producto - SI&amp;SI™</title>
    {$JAVASCRIPT}
    {$TABLEGRIDJS}
    {$CSSSYSTEM}
    {$TABLEGRIDCSS}     
                    ...
                    <td>
                        <table width="100%">
                            <tr>
                                 ...
                                 <td width="5%"><label>DB&emsp;</label></td> 
                                 <td width="5%">{$DB}{$CLIENTEID}</td>   
                                 <!--<td width="10%"><label>Estado&emsp;</label></td> 
