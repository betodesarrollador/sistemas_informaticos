...
final class DetalleActaLayout extends View{
   private $fields;
   ...
   public function setDetallesActa($DetallesActa){   
     $this -> assign("DETALLES",$DetallesActa);   
   }
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("../js/DetalleActa.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('DetalleActa.tpl');
