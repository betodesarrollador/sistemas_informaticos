...
<body>
    <form id="form_crear_linea">
        <div class="form-row">
            ...
            <div class="col">
                <input type="text" class="form-control" placeholder="codigo_linea" name="codigo_linea" id="codigo_linea" />
            </div>
            <div class="col">
                 <button type="button" class="btn btn-primary" onclick="setCamposCrearLinea()">Crear SQL</button>
            </div>
        </div>
