...
<body>
    <form id="form_borrar_trafico">
        <div class="form-row">
            <div class="col">
                <input type="text" class="form-control" placeholder="trafico_id" name="trafico_id" id="trafico_id" />
            </div>
           
            <div class="col">
                 <button type="button" class="btn btn-primary" onclick="setCamposDeleteTrafico()">Crear SQL</button>
            </div>
        </div>
