...
<body>
    <form id="form_delete_factura">
        <div class="form-row">

            <div class="col">
                <input type="text" class="form-control" placeholder="factura_id" name="factura_id" id="factura_id" />
            </div>
         
            <div class="col">
                 <button type="button" class="btn btn-primary" onclick="setCamposDeleteFactura()">Crear SQL</button>
            </div>
        </div>
