...
<body>
    <form id="form_eliminar_nc">
        <div class="form-row">
            <div class="col">
                <input type="text" class="form-control" placeholder="consecutivo de la tabla 'encabezado_de_registro'" name="consecutivo" id="consecutivo" />
            </div>
            <div class="col">
                 <button type="button" class="btn btn-primary" onclick="setCamposEliminarNc()">Crear SQL</button>
            </div>
        </div>
