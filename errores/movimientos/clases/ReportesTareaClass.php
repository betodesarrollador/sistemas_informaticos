...
final class Factura extends Controler{
  ...
  public function Main(){
	...
	require_once("Imp_ReportesTareasaModelClass.php");
	
	$Layout   = new ReportesTareasLayoutClass($this -> getTitleTab(),$this -> getTitleForm());
    $Model    = new ReportesTareasaModel();
...
//BUSQUEDA
  ...
  protected function onclickPrint(){
    ...
    require_once("Imp_ReportesTareasClass.php");
		$print = new Imp_FreportesTareas();
		$print -> printOut($fecha_inicial,$fecha_final,$this -> getConex());
