  ...
  <body>
	<fieldset>
	  ...
	  <table width="80%" align="center">
	    <tr>
	      <td><label>N Despacho :</label></td><td>{$DESPACHO}{$DESPACHOID}</td>
	    ...
	    <tr>
				   ...
				   <thead>
					...
					<tbody>
					 <tr id="rowAnticipos" class="rowAnticipos">
					     ...
					     <input type="text" name="anticipos" id="numero" value="" size="2" readonly />					   </td>	 
					   <td align="center" class="content">
		 ...
		 <table align="center">
		   <tr><td colspan="4">{$GUARDAR}&nbsp;{$IMPRIMIR}&nbsp;{$ACTUALIZAR}&nbsp;{$CONTABILIZAR}&nbsp;{$LIMPIAR}</td>
		   </tr>
		 </table>
