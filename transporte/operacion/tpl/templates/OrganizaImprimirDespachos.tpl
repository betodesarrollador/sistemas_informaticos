...
<html>
	...
	<body>
		...
		<fieldset>
			<iframe src="DespachosUrbanosClass.php?ACTIONCONTROLER=onclickPrint&despachos_urbanos_id={$DESPACHO}" width="100%" height="300"></iframe>
			<input type="submit" onClick="window.frames[{$x}].print()" value="Imprimir Despacho Urbano">
