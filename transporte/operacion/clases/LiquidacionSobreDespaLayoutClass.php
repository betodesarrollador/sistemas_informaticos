...
final class LiquidacionSobreDespaLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("LiquidacionSobreDespaClass.php","LiquidacionSobreDespaForm","LiquidacionSobreDespaForm");
	 ...
	 $this -> TplInclude -> IncludeJs("../../../transporte/operacion/js/liquidacionSobreDespa.js");
	 ...
	 $this -> assign("LIQUIDACIONID",$this -> objectsHtml -> GetobjectHtml($this -> fields[liquidacion_despacho_sobre_id]));	
	 ...
	 $this -> assign("DESPACHOID",$this -> objectsHtml -> GetobjectHtml($this -> fields[despachos_urbanos_id]));		
 	 $this -> assign("DESPACHO",$this -> objectsHtml -> GetobjectHtml($this -> fields[despachos_urbanos]));			
   ...
   public function RenderMain(){
	 $this ->RenderLayout('liquidacionSobreDespa.tpl');
   }
