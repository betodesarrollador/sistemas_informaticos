...
final class DetalleSolicitudLotesLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("../../../transporte/parametros_modulo/css/DetalleSolicitudLotes.css");
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/parametros_modulo/js/DetalleSolicitudLotes.js");
