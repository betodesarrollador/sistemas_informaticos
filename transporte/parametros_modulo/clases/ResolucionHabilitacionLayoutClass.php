...
//     $this -> TplInclude -> IncludeCss("../../../seguimiento/parametros_modulo/css/ResolucionHabilitacion.css");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../transporte/parametros_modulo/js/ResolucionHabilitacion.js");
     ...
     $this -> assign("INICIALREMESA",		$this -> objectsHtml -> GetobjectHtml($this -> fields[rango_remesa_ini]));

     $this -> assign("FINALREMESA",		$this -> objectsHtml -> GetobjectHtml($this -> fields[rango_remesa_fin]));
