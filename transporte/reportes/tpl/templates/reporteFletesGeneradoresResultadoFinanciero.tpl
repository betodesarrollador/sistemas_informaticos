			...
			<tbody>
				...
				{section name=rows loop=$DETALLESTRAZABILIDAD|count}
					<tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
						...
						<td style="border: 1px solid">{$DETALLESTRAZABILIDAD[$k].valfactura|number_format:0:',':'.'}</td>
					</tr>
				...
				<tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
					...
					<td style="border: 1px solid">{assign var=tot_util value=$total_facturas-$tot_costo}{$tot_util|number_format:0:',':'.'}</td>
				</tr>
			</tbody>
		</table>
	</body>
