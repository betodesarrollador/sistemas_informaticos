...
TRANSPORTADORA transAlejandria / Elaborado por
SQHSE transAlejandria /Bajo LA Norma BASC
Versión 4 de 2012 / Funza 2012</span></td>
          ...
          <td width="30%" rowspan="4" align="center" class="cellRight" style="border-top:1px solid"><img src="{$LOGO}" width="180" height="80" /></td>
          <td width="15%" class="cellRight" style="border-top:1px solid">Código: F-OPS-001</td>
        </tr>
        <tr>
    ...
    <tr>
      ...
      <table  border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td width="25%" class="cellLeft" >CIUDAD : {$CIUDAD}</td>
            <td width="25%" colspan="1" rowspan="1" class="cellRight" >&nbsp;&nbsp;FECHA : {$FECHA}</td>
            <td width="50%" class="cellRight"><label>USUARIO : </label>{$NOMBRE_USUARIO}</td>
          </tr>
        </tbody>
      </table>      </td>
    </tr>
    ...
    <tr>
      ...
      <table  border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          ...
          <tr>
            <td class="cellLeft" ><label>DOCUMENTO No:</label><div>{$NUMEROID}</div></td>
          ...
          <tr>
            ...
            <td class="cellRight" ><label>TIPO RESIDENCIA :</label><div>{if $TIPOVIV eq 'P'}<div>PROPIA</div>{/if}{if $TIPOVIV eq 'A'}<div>ARRIENDO</div>{/if}</td>
          </tr>
          <tr>
            <td colspan="2" rowspan="1" class="cellLeft" ><label>DIRECCION - BARRIO :</label><div>{$DIRECCION}</div></td>
...
EMPRESAS POR LAS CUALES A HA CARGADO      </td>
    ...
    <tr>
	  ...
	  <table width="100%" border="0"  cellpadding="0" cellspacing="0">
        <tr>
                   <td width="41%" class="cellLeft" ><label>1.EMPRESA.</label><div>{$EMPRESACARGO1}</div></td>
 <td width="27%" class="cellRight" ><label>CIUDAD:</label><div>{$CIUDADEMPRESACARGO1}</div></td>
        ...
        <tr>
          ...
          <td class="cellRight" ><label>CUANTOS VIAJES A REALIZADO </label><div>{$VIAJESREALIZADOSCARGO1}</div></td>
		        ...
		        <tr>
         <td width="41%" class="cellLeft" ><label>2.EMPRESA. </label><div>{$EMPRESACARGO2}</div></td>
        ...
        <tr>
          ...
          <td class="cellRight" ><label>CUANTOS VIAJES A REALIZADO </label><div>{$VIAJESREALIZADOSCARGO2}</div></td>
		        ...
		        <tr>
          <td width="41%" class="cellLeft" ><label>3.EMPRESA.</label> <div>{$EMPRESACARGO3}</div></td>
