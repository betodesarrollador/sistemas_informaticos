...
final class Tenedores extends Controler{
	...
	$Cols = array(
	  ...
	  array(name=>'estado',					index=>'estado',				sorttype=>'text',	width=>'100',	align=>'center')
    	...
    	$Titles = array('TIPO IDN',			'TIPO PERSONA',			'IDENTIFICACION',			'D. VERIF',				'PRIMER APELLIDO',
						...
						'TIPO CUENTA',		'NUMERO CUENTA',		'FECHA CONSULTA DCTO',		'CALIFICACION',			'APROBACION MIN.',
						'ESTADO');
  ...
  protected function sendTenedorMintransporte(){
	...
	$data = array(	  
		...
		nombre_sede               => $this -> requestData('primer_nombre').' '.$this -> requestData('segundo_nombre').' '.$this -> requestData('razon_social'),		
  ...
  protected function setCampos(){
	...
	$this -> Campos[tipo_cta_id] = array(
		...
		datatype=>array(
			...
			length	=>'3'),
		transaction=>array(
			table	=>array('tenedor','tercero','proveedor'),
	...
	$this -> Campos[numcuenta_proveedor] = array(
		...
		datatype=>array(
			...
			length	=>'60'),
		transaction=>array(
			table	=>array('proveedor','tercero','tenedor'),
	...
	$this -> Campos[estado] = array(
 	...
 	$this -> Campos[documentos] = array(
		...
		type	=>'file',
		value	=>'',
		path	=>'../../../imagenes/transporte/tenedores/',
		size	=>'70',	
		datatype=>array(
			type	=>'file'),
	 	transaction=>array(
