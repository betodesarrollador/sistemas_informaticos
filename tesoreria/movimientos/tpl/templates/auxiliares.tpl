      ...
      <table align="center" class="tableFilter">
	   <thead>
	    <tr align="center">
	      ...
	      <td align="center" valign="top">TERCERO</td>
	      <td align="center" valign="top">RANGO CUENTAS </td>
	      <td align="center" valign="top">FECHA</td>
	      <td align="center" valign="top">AGRUPAR </td>
	    </tr>
	   </thead>
	   <tbody>
	    <tr>
