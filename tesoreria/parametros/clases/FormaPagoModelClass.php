...
final class FormaPagoModel extends Db{
  ...
  public function Delete($Campos,$Conex){  
   ...
   public function getQueryFormaPagoGrid(){
	 ...
	 WHERE puc_id = c.puc_id) AS puc,IF(c.cuenta_tipo_pago_natu = 'D','DEBITO','CREDITO') AS naturaleza,
	 (SELECT nombre_banco FROM banco WHERE banco_id = c.banco_id) banco,IF(estado = 1,'ACTIVA','INACTIVA') AS estado 
	 FROM forma_pago f, cuenta_tipo_pago c WHERE f.forma_pago_id = c.forma_pago_id ORDER BY nombre ASC";
