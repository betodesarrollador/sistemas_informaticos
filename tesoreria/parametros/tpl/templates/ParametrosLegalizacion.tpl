  ...
  <body>
	<fieldset>
        ...
        <table>
		 ...
		 <fieldset class="section">
		 <legend>Costos de Legalizacion</legend>
		   <table width="100%">
		     <tr>
			   <td>		 
				 <div id="divProductos" align="center">
				  <table  id="tableRemesas" width="90%">
				   <thead>
					...
					<tr>
					 <td>
					   <input type="hidden" name="detalle_parametros_legalizacion_caja_id" id="detalle_parametros_legalizacion_caja_id" value="" />            
					 ...
					 <td><a name="saveDetalleRemesa" href="javascript:void(0)"><img name="add" src="/envipack/framework/media/images/grid/add.png" /></a></td>
					</tr>   
					</tbody>
				  </table>
				  <table>
