...
final class ReporteElectronicaLayout extends View{
   ...
   //// GRID ////
   public function SetGridNominaElectronica($Attributes,$Titles,$Cols,$Query=null,$SubAttributes=null,$SubTitles=null,$SubCols=null,$SubQuery=null){
    ...
    $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query,$SubAttributes,$SubTitles,$SubCols,$SubQuery);
     ...
     $head = "'<head>
     <script language='javascript' type='text/javascript' src='../../../framework/js/jquery.js'></script>
     <script language='javascript' type='text/javascript' src='../js/ReporteElectronica.js?random=15695'></script>".
