...
<body>
    ...
    <fieldset class="section">
        ...
        <fieldset class="section">
            <legend>Documento Contable</legend>
            <table align="center">
                <tr>
                    <td><label>Genera Documento Contable? </label></td>
                    <td>{$CONTABILIZA}</td>
                    <td><label>Tipo novedad documento: </label></td>
                    <td>{$TIPONOVEDADDOC}</td>
                </tr>
                <tr>
        ...
        <button type="button" class="btn btn-warning btn-sm" id="mostrar_grid" onclick="showTable()"
            style="float:right;">Mostrar tabla</button>
        {$FORM1END}
    </fieldset>
