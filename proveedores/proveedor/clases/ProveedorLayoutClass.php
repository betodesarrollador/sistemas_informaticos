...
final class ProveedorLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $this -> TplInclude -> IncludeJs("../../../proveedores/proveedor/js/proveedores.js");
	 ...
	 $this -> assign("SALDO_MEN",		    $this -> objectsHtml -> GetobjectHtml($this -> fields[saldo_men]));
	 $this -> assign("VENCIMIENTOS",		$this -> objectsHtml -> GetobjectHtml($this -> fields[vencimientos]));	 
	 ...
	 $this -> assign("CERTIFICACIONBANC",  	$this -> objectsHtml -> GetobjectHtml($this -> fields[certificacion]));	 
	 $this -> assign("FECHAINGRESO",			    $this -> objectsHtml -> GetobjectHtml($this -> fields[fecha_ingreso]));	 	
	 $this -> assign("ESTADO",            $this -> objectsHtml -> GetobjectHtml($this -> fields[estado_proveedor]));		 
