  ...
  public function Main(){
	...
	$Cols = array(
	  ...
	  array(name=>'sigla',					index=>'sigla',					sorttype=>'text',	width=>'100',	align=>'center'),
  	  array(name=>'fecha_ingreso',			index=>'fecha_ingreso',			sorttype=>'text',	width=>'150',	align=>'center'),
...
//BUSQUEDA
  ...
  protected function SetCampos(){
	...
	********************/
	...
	$this -> Campos[vencimientos] = array(
		name	=>'vencimientos',
		id		=>'vencimientos',
		type	=>'text',
		Boostrap=>'si',
	...
	$this -> Campos[certificacion] = array(
		name	=>'certificacion',
		id		=>'certificacion',
		type	=>'file',
		value	=>'',
		path	=>'/rotterdan/imagenes/proveedores/certificaciones/',
		size	=>'70',
		datatype=>array(
			type	=>'file'),
	 	transaction=>array(
	...
	$this -> Campos[estado_proveedor] = array(
