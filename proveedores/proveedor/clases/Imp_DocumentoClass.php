...
final class Imp_Documento{
  ...
  public function printOut(){
	  ...
	  $pdf->Cell(80,5,utf8_decode(substr($encabezado[0]['razon_social_emp'],0,24)),0,0,'C');
	  $pdf->SetFont('Arial','',8);
	  $pdf->Cell(55,5,utf8_decode($encabezado[0]['tipo_documento']),1,0,'C');	
      $pdf->SetFont('Arial','',10);	 
	  ...
	  $pdf->Cell(80,5,substr(utf8_decode($encabezado[0]['primer_nombre'].' '.$encabezado[0]['segundo_nombre'].' '.$encabezado[0]['primer_apellido'].' '.$encabezado[0]['segundo_apellido'].' '.$encabezado[0]['razon_social']),0,35),1,0,'L');	
	  ...
	  $pdf->Cell(80,5,$encabezado[0]['numero_soporte'],1,0,'L');	 
	  $pdf->Cell(35,5,'Tipo Doc :',1,0,'L');	
	  $pdf->Cell(50,5,$encabezado[0]['codigo_documento'],1,0,'L');	
