  ...
  <table align="center" id="tableImputaciones" width="120%">
    <thead>
      <tr>
        ...
        <th width="10%" >CREDITO</th>  		{if $ESTADO eq 'E'}  
	...
	<tbody>
      ...
      <tr>
       ...
       <td class="no_requerido">
        ...
        <td class="no_requerido" align="right">
          <input type="text" name="base" class="numeric no_requerido"  value="{$i.base}" maxlength="12"  size="15" align="right" />        </td>
        <td align="right"> <input type="text" name="debito" {if $i.debito<0 } class="numeric_negative" {else} class="numeric" {/if} value="{$i.debito}" maxlength="15" size="12" align="right" ></td>        
        <td align="right"> <input type="text" name="credito" {if $i.credito<0 } class="numeric_negative" {else} class="numeric" {/if} value="{$i.credito}" maxlength="15" size="12" align="right" ></td>
      ...
      <tr>
       ...
       <td class="no_requerido">
        ...
        <td class="no_requerido" align="right"><input type="text" name="base" class="numeric no_requerido"  maxlength="12" readonly size="15" /></td>
        <td align="right"><input type="text" name="debito" class="numeric" maxlength="15" size="12" value="0.00" /></td>        
        <td align="right"><input type="text" name="credito" class="numeric" maxlength="15" size="12" value="0.00" /></td>
