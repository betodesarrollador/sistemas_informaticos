<?php /* Smarty version 2.6.30, created on 2022-02-17 09:40:58
         compiled from detalle_devolucion_proveedor.tpl */ ?>
...
" /><?php echo $this->_tpl_vars['REGIS']; ?>
                     ...
                     <td>
                       <select name="sub_anticipos_proveedor_id" id="sub_anticipos_proveedor_id" class="required"  >
                         <option value="NULL">(... Seleccione ...)</option>
                         <?php $_from = $this->_tpl_vars['ANTICIPOSCRUCE']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['tipo_doc'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['tipo_doc']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['f']):
        $this->_foreach['tipo_doc']['iteration']++;
?>
                         <option value="<?php echo $this->_tpl_vars['f']['anticipos_proveedor_id']; ?>
" ><?php echo $this->_tpl_vars['f']['consecutivo']; ?>
</option>
                     ...
                     <td><input type="text" name="fecha_egreso" id="fecha_egreso" value="" class="required date" size="14" /></td>
                     <td>
...
" /><?php echo $this->_tpl_vars['a']['numero']; ?>
                             ...
                             <td>
                               <select name="sub_anticipos_proveedor_id" id="sub_anticipos_proveedor_id" <?php if (is_numeric ( $this->_tpl_vars['a']['encabezado_registro_id'] )): ?>disabled<?php endif; ?>  >
                                 <option value="NULL">(... Seleccione ...)</option>
                                 <?php $_from = $this->_tpl_vars['ANTICIPOSCRUCE']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['tipo_doc'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['tipo_doc']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['f']):
...
?>
                                 <option value="<?php echo $this->_tpl_vars['f']['anticipos_proveedor_id']; ?>
" <?php if ($this->_tpl_vars['f']['anticipos_proveedor_id'] == $this->_tpl_vars['a']['sub_anticipos_proveedor_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['f']['consecutivo']; ?>
</option>
                                 <?php endforeach; endif; unset($_from); ?>
                               </select>			 
                             </td>
