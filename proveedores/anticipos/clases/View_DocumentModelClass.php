...
final class View_DocumentModel extends Db{
  ...
  public function getEncabezado($encabezado_registro_id,$Conex){
	...
	if(is_numeric($encabezado_registro_id)){
		...
		(SELECT observaciones FROM anticipos_manifiesto WHERE encabezado_registro_id=e.encabezado_registro_id) AS observaciones,
		(SELECT observaciones FROM anticipos_proveedor WHERE encabezado_registro_id=e.encabezado_registro_id) AS observaciones1,
