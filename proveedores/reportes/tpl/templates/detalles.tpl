  ...
  <table align="center" width="100%" class="table table-striped">
      {if $tipo eq 'FP'}
		  ...
		  {if $prov eq '' or $prov neq $i.proveedor_nombre}
              ...
              {if $prov neq '' and $prov neq $i.proveedor_nombre}
                  ...
                  <tr class="subtitulo">
                   ...
                   <td  align="right">&nbsp;{$acumula_total|number_format:0:',':'.'}</td>
                   <td  align="right">&nbsp;{$acumula_saldos|number_format:0:',':'.'}</td>								
                  </tr>  
                  {assign var="acumula_total" value="0"}
                  {assign var="acumula_saldos" value="0"}
                  <tr>
          ...
          <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
            ...
            <td >{if $i.codfactura_proveedor neq ''}Fact. {$i.codfactura_proveedor}{/if} {if $i.manifiesto neq ''}Planilla: {$i.manifiesto}{/if} {if $i.orden_no neq ''}Orden Ser No: {$i.orden_no}{/if}</td> 
            <td >{$i.oficina}</td>  
            <td >{$i.fecha_factura_proveedor}</td>  
            <td >{$i.vence_factura_proveedor}</td>  
            <td >{$i.dias}</td>  
          ...
          <tr class="subtitulo">
           <td  colspan="7" align="right">TOTAL TODOS LOS TERCEROS</td>
           <td  align="right">&nbsp;{$acumula_totales|number_format:0:',':'.'}</td>
           <td  align="right">&nbsp;{$acumula_saldos_total|number_format:0:',':'.'}</td>								
          </tr>  
      ...
      {elseif $tipo eq 'RS'}    
           ...
           {foreach name=detalles from=$DETALLES item=i}
            <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
                ...
                <td>{$i.oficina} </td> 
                <td>{$i.estado} </td> 
                <td>{$i.fecha_orden_compra}</td> 
                <td>{$i.proveedor_nombre}</td>  
                <td>{$i.solicitud}</td>  
                <td>{$i.descrip_orden_compra}</td>  
      ...
      {elseif $tipo eq 'RF'}
		  ...
		  {if $prov eq '' or $prov neq $i.proveedor_nombre}
              ...
              {if $prov neq '' and $prov neq $i.proveedor_nombre}
                  ...
                  <tr class="subtitulo">
                   ...
                   <td  align="right">&nbsp;{$acumula_total|number_format:0:',':'.'}</td>
                    <td  align="right">&nbsp;{$acumula_pagos|number_format:0:',':'.'}</td>
                   <td  align="right">&nbsp;{$acumula_saldos|number_format:0:',':'.'}</td>								
                  </tr>  
                  {assign var="acumula_total" value="0"}
                  {assign var="acumula_pagos" value="0"}
          ...
          <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
            ...
            <td>{$i.fecha_factura_proveedor}</td>  
            <td>{$i.vence_factura_proveedor}</td>
            <td>{$i.relacion_pago} {$i.relacion_anticipos}</td>  
            <td align="right">{if $i.estado eq 'ANULADA'}0{else}{$i.valor_neto|number_format:0:',':'.'}{/if}</td>
            <td align="right">{if $i.estado eq 'ANULADA'}0{else}{$i.abonos|number_format:0:',':'.'}{/if}</td>  
            <td align="right">{if $i.estado eq 'ANULADA'}0{else}{$i.saldo|number_format:0:',':'.'}{/if}</td>  
          </tr> 
      ...
      {elseif $tipo eq 'RC'}
          ...
          <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
          	<td>{$i.consecutivo_id}</td>                     
            <td>{if $i.manifiesto neq ''}Planilla: {$i.manifiesto}{elseif $i.codfactura_proveedor neq ''}Fact. {$i.codfactura_proveedor}{/if}  {if $i.orden_no neq ''}Orden Ser No: {$i.orden_no}{/if} {$i.tipo} </td> 
            <td>{$i.proveedor_nombre}</td> 
            <td>{$i.centro}</td>  
            <td>{$i.oficina}</td>  
            <td>{$i.estado}</td>  
      ...
      {elseif  $tipo eq 'EC'}
        ...
        {elseif  $tipo eq 'PE'}
		  ...
		  {if $prov eq '' or $prov neq $i.proveedor_nombre}
              ...
              {if $prov neq '' and $prov neq $i.proveedor_nombre}
                  ...
                  <tr class="subtitulo">
                   ...
                   <td align="right">&nbsp;{$acumula_30|number_format:0:',':'.'}</td>
                   <td align="right">&nbsp;</td>								
                   <td align="right">&nbsp;{$acumula_60|number_format:0:',':'.'}</td>
                   <td align="right">&nbsp;</td>								
                   <td align="right">&nbsp;{$acumula_90|number_format:0:',':'.'}</td>
                   <td align="right">&nbsp;</td>								
                   <td align="right">&nbsp;{$acumula_180|number_format:0:',':'.'}</td>
                   <td align="right">&nbsp;</td>								
                   <td align="right">&nbsp;{$acumula_360|number_format:0:',':'.'}</td>
                   <td align="right">&nbsp;</td>								
                   <td align="right">&nbsp;{$acumula_360mas|number_format:0:',':'.'}</td>
                   <td align="right">&nbsp;</td>								
                  </tr>  
                  {assign var="acumula_0" value="0"}
                  {assign var="acumula_30" value="0"}
          ...
          <tr bgcolor="{cycle values="#eeeeee,#d0d0d0"}">
            ...
            <td align="right">{if $i.dias lt 0 or  $i.dias eq 0}{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias lt 0 or  $i.dias eq 0}{$i.dias}{/if}</td>  
            
            <td align="right">{if $i.dias gt 0 and $i.dias lt 31 }{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias gt 0 and $i.dias lt 31 }{$i.dias}{/if}</td>  

            <td align="right">{if $i.dias gt 30 and $i.dias lt 61 }{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias gt 30 and $i.dias lt 61 }{$i.dias}{/if}</td>  

            <td align="right">{if $i.dias gt 60 and $i.dias lt 91 }{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias gt 60 and $i.dias lt 91 }{$i.dias}{/if}</td>  

            <td align="right">{if $i.dias gt 90 and $i.dias lt 181 }{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias gt 90 and $i.dias lt 181 }{$i.dias}{/if}</td>  
            
            <td align="right">{if $i.dias gt 180 and $i.dias lt 361 }{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias gt 180 and $i.dias lt 361 }{$i.dias}{/if}</td>  

            <td align="right">{if $i.dias gt 360}{$i.saldo|number_format:0:',':'.'}{/if}</td>  
            <td>{if $i.dias gt 360}{$i.dias}{/if}</td>  
          ...
          <tr class="subtitulo">
           <td colspan="3" align="right">TOTAL PENDIENTE</td>
           <td align="right" colspan="10">&nbsp;{$acumula_total|number_format:0:',':'.'}</td>
          </tr>  
          ...
          <tr class="subtitulo">
           <td colspan="3" align="right">TOTALES POR EDADES</td>
           <td align="right">&nbsp;{$acumulat_0|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
           
           <td align="right">&nbsp;{$acumulat_30|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
           <td align="right">&nbsp;{$acumulat_60|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
           <td align="right">&nbsp;{$acumulat_90|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
           <td align="right">&nbsp;{$acumulat_180|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
           <td align="right">&nbsp;{$acumulat_360|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
           <td align="right">&nbsp;{$acumulat_360mas|number_format:0:',':'.'}</td>
           <td align="right">&nbsp;</td>								
          </tr>  
