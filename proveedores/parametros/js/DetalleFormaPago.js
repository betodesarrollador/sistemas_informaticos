...
function saveDetalle(obj){
	...
	if(validaRequeridosDetalle(obj,row)){
	  ...
	  if(!cuenta_tipo_pago_id.length > 0){
		  ...
		  puc_id+"&banco_id="+banco_id+"&cuenta_tipo_pago_natu="+cuenta_tipo_pago_natu+'&forma_pago_id='+forma_pago_id;
...
function autocompletePuc(){
	...
	$("input[name=puc]").autocomplete("/rotterdan/framework/clases/ListaInteligente.php?consulta=cuentas_movimiento_activas", {
		width: 355,
		selectFirst: true
	});
