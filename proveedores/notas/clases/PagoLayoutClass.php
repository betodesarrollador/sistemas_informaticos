...
final class PagoLayout extends View{
   ...
   public function SetCampos($campos){
	 ...
	 $this -> TplInclude -> IncludeCss("../../../proveedores/notas/css/pago.css");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../proveedores/notas/js/pago.js");
	 ...
	 $this -> assign("CLIENTEID",			$this -> objectsHtml -> GetobjectHtml($this -> fields[proveedor_id]));	 
	 $this -> assign("CLIENTE",				$this -> objectsHtml -> GetobjectHtml($this -> fields[proveedor]));
	 $this -> assign("CLIENTENIT",			$this -> objectsHtml -> GetobjectHtml($this -> fields[proveedor_nit]));	
