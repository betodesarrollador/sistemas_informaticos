...
final class Pago extends Controler{
  ...
  protected function onclickSave(){
	...
	$return     = $Model -> Save($empresa_id,$oficina_id,$usuario_id,$this -> Campos,$this -> getConex());
  ...
  protected function SetCampos(){
	...
	********************/
	...
	$this -> Campos[encabezado_registro_id] = array(
		...
		type	=>'hidden',
		transaction=>array(
			table	=>array('encabezado_registro'),
			type	=>array('column'))
	...
	$this -> Campos[valor] = array(
		...
		readonly=>'yes',
	 	datatype=>array(
			...
			length	=>'20'),
		transaction=>array(
			table	=>array('encabezado_resgitro'),
			type	=>array('column'))
	);
...
$this -> Campos[factura_proveedors] = array(
		name	=>'factura_proveedors',
		id		=>'factura_proveedors',
		type	=>'hidden',
		datatype=>array(
			type	=>'alphanum',
			length	=>'350')
