...
final class DevolucionLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeCss("../../../proveedores/tiposervicio/css/devolucion.css");	 
     ...
     $this -> TplInclude -> IncludeJs("../../../proveedores/tiposervicio/js/devolucion.js");
     $this -> TplInclude -> IncludeJs("../../../framework/js/jquery.alerts.js");	 		   	 
     $this -> TplInclude -> IncludeJs("../../../framework/js/jquery.hotkeys.js");	 
	  	  
	 $this -> assign("CSSSYSTEM",	          $this -> TplInclude -> GetCssInclude());
     $this -> assign("JAVASCRIPT",	          $this -> TplInclude -> GetJsInclude());
     $this -> assign("tipo_bien_servicio_id",$_REQUEST['tipo_bien_servicio_id']);	 
