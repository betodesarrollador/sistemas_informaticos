...
final class PagoLayout extends View{
   ...
   public function SetCampos($campos){
	 ...
	 $this -> TplInclude -> IncludeCss("/rotterdan/facturacion/pago/css/pago.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/rotterdan/proveedores/pago_cliente/js/pago.js");
	 ...
	 $this -> assign("PUCMAYORID",			$this -> objectsHtml -> GetobjectHtml($this -> fields[puc_mayor_id]));	 
	 $this -> assign("PUCMENORID",			$this -> objectsHtml -> GetobjectHtml($this -> fields[puc_menor_id]));	 
	  $this -> assign("PUCMAYOR",			$this -> objectsHtml -> GetobjectHtml($this -> fields[puc_mayor]));	 
	 $this -> assign("PUCMENOR",			$this -> objectsHtml -> GetobjectHtml($this -> fields[puc_menor]));	 
	 
	 
	 $this -> assign("VALORPAGO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_abono_factura]));		
	 
	 //$this -> assign("MAYORVALORPAGO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[mayor_valor_abono_factura]));		 
	 //$this -> assign("MENORVALORPAGO",			$this -> objectsHtml -> GetobjectHtml($this -> fields[menor_valor_abono_factura]));		 
	 $this -> assign("VALORADIC",			$this -> objectsHtml -> GetobjectHtml($this -> fields[valor_mayor_factura]));		
