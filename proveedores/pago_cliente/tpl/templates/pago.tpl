                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td width="15%" align="right" >
                                ...
                                <img src="../../../framework/media/images/grid/no.gif" id="deleteDetallePuc" title="Borrar Seleccionados"/>
                            </td>
                        </tr>
                    </table>
                </td>
		...
		<table width="100%">
			<tr><td colspan="8"><iframe id="detalles" frameborder="0" marginheight="0" marginwidth="0"></iframe></td></tr>
          	<tr>
                ...
                <td width="10%"><span id="totalDiferencia">0</span></td> 
