...
final class ClientesLayout extends View{
   ...
   public function SetCampos($campos){
     ...
     $this -> TplInclude -> IncludeCss("/roa/seguimiento/bases/css/cliente.css");	 
	 ...
	 $this -> TplInclude -> IncludeJs("/roa/framework/js/generalterceros.js");
     ...
     $this -> TplInclude -> IncludeJs("/roa/seguimiento/bases/js/clientes.js");
