...
final class AlertasPanicoLayout extends View{
   ...
   public function setCampos($campos){
	 ...
	 $Form1      = new Form("AlertasPanicoClass.php","AlertasPanicoForm","AlertasPanicoForm");	 
...
//     $this -> TplInclude -> IncludeCss("/roa/seguimiento/parametros_modulo/css/alertaspanico.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/roa/framework/js/iColorPicker.js");	
     $this -> TplInclude -> IncludeJs("/roa/framework/js/jquery.alerts.js");	 		   
     $this -> TplInclude -> IncludeJs("/roa/seguimiento/parametros_modulo/js/AlertasPanico.js");
     ...
     $this -> assign("ALERTAID",	$this -> objectsHtml -> GetobjectHtml($this -> fields[alerta_id]));
     $this -> assign("ALERTAPANICO",$this -> objectsHtml -> GetobjectHtml($this -> fields[alerta_panico]));
     $this -> assign("COLORALERTA",	$this -> objectsHtml -> GetobjectHtml($this -> fields[color_alerta_panico]));
...
//// GRID ////
   public function SetGridAlertasPanico($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
	 $TableGrid = new JqGrid();
 	 $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDALERTASPANICO",	$TableGrid -> RenderJqGrid());
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('AlertasPanico.tpl');
