...
final class ReportesLayout extends View{
   ...
   private $fields;
     ...
     $this -> TplInclude -> IncludeCss("/roa/seguimiento/reportes/css/Reportes.css");	 
     ...
     $this -> TplInclude -> IncludeJs("/roa/framework/js/ajax-dynamic-list.js");
  	 $this -> TplInclude -> IncludeJs("/roa/seguimiento/reportes/js/Reportes.js");
...
//// GRID ////  
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('Reportes.tpl');
