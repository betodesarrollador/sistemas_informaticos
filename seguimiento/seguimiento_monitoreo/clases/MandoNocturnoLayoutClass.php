...
final class MandoNocturnoLayout extends View{
   ...
   private $fields;
     ...
     $this -> TplInclude -> IncludeCss("/roa/seguimiento/seguimiento_monitoreo/css/MandoNocturno.css");	 
	 ...
	 $this -> TplInclude -> IncludeJs("/roa/seguimiento/seguimiento_monitoreo/js/MandoNocturno.js");
...
//// GRID ////  
   public function SetGridMandoNocturno($Attributes,$Titles,$Cols,$Query){
     require_once("../../../framework/clases/grid/JqGridClass.php");
	 $TableGrid = new JqGrid();
 	 $TableGrid -> SetJqGrid($Attributes,$Titles,$Cols,$Query);
     $this -> assign("GRIDMandoNocturno",	$TableGrid -> RenderJqGrid());
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('MandoNocturno.tpl');
