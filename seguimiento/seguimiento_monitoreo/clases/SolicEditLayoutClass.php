...
final class SolicEditLayout extends View{
   ...
   public function setIncludes(){
     ...
     $this -> TplInclude -> IncludeJs("/roa/seguimiento/seguimiento_monitoreo/js/SolicEdit.js");
   ...
   public function RenderMain(){
        ...
        $this -> RenderLayout('SolicEdit.tpl');
